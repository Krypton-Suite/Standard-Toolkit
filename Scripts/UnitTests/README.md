...
| `UnitTest-PaletteBinary.ps1` | #2117 custom palette `.kpalx` / `.kpal` round-trip, `Convert`, `UpgradeXmlToKpalx` / `ConvertFile` (file and `KryptonCustomPaletteBase`), packs, directory packs, and Utilities `FromDirectory` | `include` |

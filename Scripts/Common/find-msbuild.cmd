...
REM
REM PURPOSE
REM   Shared helper for orchestration scripts under Scripts\Build\,
REM   Scripts\VS2022\, and Scripts\Current\. Sets the caller's msbuildpath variable
REM   to the directory containing MSBuild.exe.
REM
REM USAGE (must be CALLed)
REM   call "%~dp0find-msbuild.cmd" <profile>
REM
REM PROFILES
REM   2019           Visual Studio 2019 (Scripts\Build\ legacy toolset)
REM   2022           Visual Studio 2022 (Scripts\VS2022\)
...
REM
REM DISCOVERY ORDER
REM   1. MSBUILDPATH or MSBUILD_PATH (MSBuild\Current\Bin directory)
REM   2. vswhere.exe (%ProgramFiles(x86)%\Microsoft Visual Studio\Installer\)
REM   3. Standard folders under %ProgramFiles% / %ProgramFiles(x86)%
REM

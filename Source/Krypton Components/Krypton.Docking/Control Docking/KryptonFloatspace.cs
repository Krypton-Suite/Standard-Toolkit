...
/// <summary>
/// Workspace hosted inside a floating window with docking pin actions disabled.
/// </summary>
[ToolboxItem(false)]
...
public class KryptonFloatspace : KryptonSpace
{
    #region Identity
    /// <summary>
    /// Initializes a floating workspace space with store name "Floating".
    /// </summary>
    ...
    /// </summary>
    /// <returns>Label identifying this floatspace instance.</returns>

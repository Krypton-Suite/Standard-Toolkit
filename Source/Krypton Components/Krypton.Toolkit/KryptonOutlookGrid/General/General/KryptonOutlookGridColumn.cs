...
/// </summary>
public class KryptonOutlookGridColumn : IEquatable<KryptonOutlookGridColumn>
{
    #region Identity
    ...
    public KryptonOutlookGridColumn(DataGridViewColumn col, IKryptonOutlookGridGroup group, SortOrder sortDirection, int groupIndex, int sortIndex, IComparer? comparer, KryptonOutlookGridAggregationType aggregationType = KryptonOutlookGridAggregationType.None)
    {
    ...
    /// <param name="comparer">The comparer if needed</param>
    /// <param name="aggregationType">The type of aggregation to apply to the column.</param>
    public KryptonOutlookGridColumn(string? columnName, DataGridViewColumn? col, IKryptonOutlookGridGroup? group, SortOrder sortDirection, int groupIndex, int sortIndex, IComparer? comparer, KryptonOutlookGridAggregationType aggregationType = KryptonOutlookGridAggregationType.None)
    {
        DataGridViewColumn = col!;
        Name = columnName;
        GroupingType = group;
    ...
    /// <param name="sortIndex">the column's position among sorted columns.</param>
    /// <param name="aggregationType">The type of aggregation to apply to the column.</param>
    public KryptonOutlookGridColumn(string columnName, DataGridViewColumn col, IKryptonOutlookGridGroup group, SortOrder sortDirection, int groupIndex, int sortIndex, KryptonOutlookGridAggregationType aggregationType = KryptonOutlookGridAggregationType.None)
    {
        DataGridViewColumn = col;
        Name = columnName;
        GroupingType = group;
    ...
    /// <summary>Initializes a new instance of the <see cref="KryptonOutlookGridColumn" /> class.</summary>
    ...
    /// <param name="aggregationType">The type of aggregation to apply to the column.</param>
    public KryptonOutlookGridColumn(DataGridViewColumn col, IKryptonOutlookGridGroup? group, SortOrder sortOrder, int groupIndex, int sortIndex, KryptonOutlookGridAggregationType aggregationType = KryptonOutlookGridAggregationType.None)
    {
        DataGridViewColumn = col;
        Name = col?.Name;
        GroupingType = group;
    ...
    /// </summary>
    public IKryptonOutlookGridGroup? GroupingType { get; set; }
    ...
    /// <param name="other">The KryptonOutlookGridColumn to compare with</param>
    /// <returns></returns>
    public bool Equals(KryptonOutlookGridColumn? other)

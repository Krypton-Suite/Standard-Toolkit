...
/// </summary>
public class KryptonOutlookGridGroupBoxColumn : IEquatable<KryptonOutlookGridGroupBoxColumn>
{
    #region Identity
    /// <summary>
    /// Constructor
    ...
    public KryptonOutlookGridGroupBoxColumn(string? columnName, string? columnText, SortOrder sort, string groupingType)
    {
        Text = columnText;
    ...
    /// </summary>
    /// <param name="other">The KryptonOutlookGridGroupBoxColumn to compare with.</param>
    /// <returns>True or False.</returns>
    public bool Equals(KryptonOutlookGridGroupBoxColumn? other) => ColumnName!.Equals(other!.ColumnName);

...
/// <summary>
/// KryptonOutlookGridRow - subclasses the DataGridView's DataGridViewRow class
/// In order to support grouping with the same look and feel as Outlook, the behavior
/// of the DataGridViewRow is overridden by the KryptonOutlookGridRow.
/// The KryptonOutlookGridRow has 2 main additional properties: the Group it belongs to and
/// a the IsRowGroup flag that indicates whether the KryptonOutlookGridRow object behaves like
/// a regular row (with data) or should behave like a Group row.
/// </summary>
public class KryptonOutlookGridRow : DataGridViewRow
{
    #region "Variables"

    private bool _isGroupRow;
    private bool _isSummaryRow;
    private IKryptonOutlookGridGroup? _group;
    private bool _collapsed; //For TreeNode
    private KryptonOutlookGridRowNodeCollection _nodeCollection; //For TreeNode
    private int _nodeLevel; //For TreeNode
    private KryptonOutlookGridRow? _parentNode; //for TreeNode
    #endregion
    ...
    public IKryptonOutlookGridGroup? Group
    {
        get => _group;
        set => _group = value;
    }
    ...
    /// <summary>
    /// Gets or sets a value indicating whether this <see cref="KryptonOutlookGridRow"/> is collapsed.
    /// </summary>
    /// <value>
    ...
    /// </value>
    [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
    public KryptonOutlookGridRowNodeCollection Nodes { get => _nodeCollection; set => _nodeCollection = value; }
    ...
    public bool IsLastSibling
    {
        get
        {
            KryptonOutlookGridRow? parent = _parentNode;
    ...
    [Browsable(false)]
    [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
    public KryptonOutlookGridRow? ParentNode { get => _parentNode; set => _parentNode = value; }
    ...
    /// Default Constructor
    /// </summary>
    public KryptonOutlookGridRow()
        : this(null, false)
    {
        //nodeCollection = new KryptonOutlookGridRowNodeCollection(this);
        //NodeLevel = 0;
        //Collapsed = true;
    }
    ...
    public KryptonOutlookGridRow(IKryptonOutlookGridGroup? group)
        : this(group, false)
    {
        //nodeCollection = new KryptonOutlookGridRowNodeCollection(this);
        //NodeLevel = 0;
    ...
    public KryptonOutlookGridRow(IKryptonOutlookGridGroup? group, bool isGroupRow)
    {
        _group = group;
    ...
    public bool IsAParentCollapsed(IKryptonOutlookGridGroup? gr, int i)
    {
        i++;
    ...
    /// <returns></returns>
    public bool IsAParentNodeOrGroupCollapsed(KryptonOutlookGridRow? row, int i)
    {
        i++;

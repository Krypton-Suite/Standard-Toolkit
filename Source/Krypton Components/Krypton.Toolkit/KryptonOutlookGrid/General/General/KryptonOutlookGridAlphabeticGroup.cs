...
/// </summary>
public sealed class KryptonOutlookGridAlphabeticGroup : KryptonOutlookGridDefaultGroup
{
    #region Identity

    /// <summary>
    /// Initializes a new instance of the <see cref="KryptonOutlookGridAlphabeticGroup"/> class.
    /// </summary>
    public KryptonOutlookGridAlphabeticGroup()
        : base()
    {
    ...
    public KryptonOutlookGridAlphabeticGroup(IKryptonOutlookGridGroup? parentGroup)
        : base(parentGroup)
    {
        AllowHiddenWhenGrouped = false;
    }
    ...
    /// </summary>
    /// <returns>KryptonOutlookGridAlphabeticGroup</returns>
    public override object Clone()
    {
        KryptonOutlookGridAlphabeticGroup gr = new(ParentGroup)
        {
            Column = Column,
            Value = Value,
            Collapsed = Collapsed,
    ...
    public override int CompareTo(object? obj)
    {
        ...
        if (obj is KryptonOutlookGridAlphabeticGroup)
        {
            return string.CompareOrdinal(Value?.ToString(), (obj as KryptonOutlookGridAlphabeticGroup)?.Value?.ToString()) *
                   orderModifier;
        }
        else
        {

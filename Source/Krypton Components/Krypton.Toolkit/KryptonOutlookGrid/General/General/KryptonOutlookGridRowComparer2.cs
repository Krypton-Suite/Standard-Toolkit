...
internal class KryptonOutlookGridRowComparer2 : IComparer<KryptonOutlookGridRow>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="KryptonOutlookGridRowComparer2"/> class.
    /// </summary>
    /// <param name="sortList">The sort list, tuple (column index, sortorder, Icomparer)</param>
    public KryptonOutlookGridRowComparer2(List<Tuple<int, SortOrder, IComparer>> sortList)
    {
    ...
    public int Compare(KryptonOutlookGridRow? x, KryptonOutlookGridRow? y)
    {

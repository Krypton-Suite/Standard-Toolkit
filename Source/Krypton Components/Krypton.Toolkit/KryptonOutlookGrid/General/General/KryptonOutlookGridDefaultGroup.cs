...
/// </summary>
public class KryptonOutlookGridDefaultGroup : IKryptonOutlookGridGroup
{
    ...
    /// </summary>
    private KryptonOutlookGridColumn? _column;
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="KryptonOutlookGridDefaultGroup"/> class.
    /// </summary>
    public KryptonOutlookGridDefaultGroup()
    {
        _val = null;
        _column = null;
        ...
        Rows = new List<KryptonOutlookGridRow>();
        Children = new KryptonOutlookGridGroupCollection();
        _formatStyle = "";
    ...
    public KryptonOutlookGridDefaultGroup(IKryptonOutlookGridGroup? parentGroup) : this()
    {
        if (parentGroup != null)
        {
    ...
    /// </summary>
    public List<KryptonOutlookGridRow> Rows { get; set; }

    /// <summary>
    /// Gets or sets the parent group.
    /// </summary>
    /// <value>The parent group.</value>
    public IKryptonOutlookGridGroup? ParentGroup { get; set; }
    ...
    public KryptonOutlookGridGroupCollection Children { get; set; }
    ...
    /// </summary>
    [DisallowNull]
    public virtual KryptonOutlookGridColumn Column
    {
        get => _column!;
    ...
    /// <summary>
    /// Gets or sets the <see cref="KryptonOutlookGridRow"/> that represents the summary row for this group or the grand total.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    public KryptonOutlookGridRow? SummaryRow { get; set; }
    ...
    {
        var gr = new KryptonOutlookGridDefaultGroup(ParentGroup)
        {
            _column = _column,
            _val = _val,
    ...
    public virtual int CompareTo(object? obj)
    {
        ...
        object? o2 = (obj as KryptonOutlookGridDefaultGroup)?.Value;

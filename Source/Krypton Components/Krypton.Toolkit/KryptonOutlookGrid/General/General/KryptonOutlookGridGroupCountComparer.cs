...
internal class KryptonOutlookGridGroupCountComparer : IComparer<IKryptonOutlookGridGroup>
{
    public KryptonOutlookGridGroupCountComparer()
    {
    }

    #region IComparer Members

    public int Compare(IKryptonOutlookGridGroup? x,  IKryptonOutlookGridGroup? y)
    {
        /*
         * KryptonOutlookGridGroupCountComparer implements the IComparer<IOutlookGridGroup> interface.             
         ...
         * 'int KryptonOutlookGridGroupCountComparer.Compare(IOutlookGridGroup x, IOutlookGridGroup y) 
        ...
        {
            throw new($"KryptonOutlookGridGroupCountComparer: {this}", ex);
        }
    }
    #endregion
}
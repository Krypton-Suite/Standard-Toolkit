...
/// </summary>
public static class KryptonOutlookGridColorFormatting
{
    ...
    /// <returns></returns>
    public static Color ConvertTwoRange(double value, double min, double max, KryptonOutlookGridTwoColorsParams par)
    {
        KryptonOutlookGridColorHelper.HSVColor a = ColorToHSV(par.MinimumColor);
        KryptonOutlookGridColorHelper.HSVColor b = ColorToHSV(par.MaximumColor);
    ...
    /// <returns></returns>
    public static Color ConvertThreeRange(double value, double min, double max, KryptonOutlookGridThreeColorsParams? par)
    {
        KryptonOutlookGridColorHelper.HSVColor a = ColorToHSV(par!.MinimumColor);
        KryptonOutlookGridColorHelper.HSVColor b = ColorToHSV(par.MinimumColor);
        KryptonOutlookGridColorHelper.HSVColor c = ColorToHSV(par.MinimumColor);
    ...
    private static KryptonOutlookGridColorHelper.HSVColor ColorToHSV(Color color)
    {

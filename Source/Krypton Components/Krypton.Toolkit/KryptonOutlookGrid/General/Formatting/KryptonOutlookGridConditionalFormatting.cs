...
/// </summary>
public class KryptonOutlookGridConditionalFormatting
{
    #region Public
    ...
    /// </value>
    public IKryptonOutlookGridFormatParams? FormatParams { get; set; }
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="KryptonOutlookGridConditionalFormatting"/> class.
    /// </summary>
    public KryptonOutlookGridConditionalFormatting() { }

    /// <summary>
    /// Initializes a new instance of the <see cref="KryptonOutlookGridConditionalFormatting"/> class. (Only use for context menu !)
    /// </summary>
    ...
    public KryptonOutlookGridConditionalFormatting(EnumConditionalFormatType formatType, IKryptonOutlookGridFormatParams formatParams)
    {
    ...
    /// <param name="formatType">Type of the Conditional Formatting.</param>
    /// <param name="formatParams">The Conditional Formatting parameters.</param>
    public KryptonOutlookGridConditionalFormatting(string columnName, EnumConditionalFormatType formatType, IKryptonOutlookGridFormatParams? formatParams)
    {

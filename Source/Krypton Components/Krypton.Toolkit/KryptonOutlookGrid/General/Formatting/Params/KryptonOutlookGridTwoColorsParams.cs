...
namespace Krypton.Toolkit
{
    ...
    public class KryptonOutlookGridTwoColorsParams : IKryptonOutlookGridFormatParams
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="KryptonOutlookGridTwoColorsParams"/> class.
        /// </summary>
        /// <param name="minColor">The minimum color.</param>
        /// <param name="maxColor">The maximum color.</param>
        public KryptonOutlookGridTwoColorsParams(Color minColor, Color maxColor)
        {

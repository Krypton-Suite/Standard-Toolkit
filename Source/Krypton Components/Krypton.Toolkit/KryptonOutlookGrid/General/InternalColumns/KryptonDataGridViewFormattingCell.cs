        ...
        if (FormatParams != null)  // null can happen when cell set to Formatting but no condition has been set !
        {
            switch (FormatType)
            {
                case EnumConditionalFormatType.Bar:
                    int barWidth;
                    KryptonOutlookGridBarParams par = (KryptonOutlookGridBarParams)FormatParams;
                ...
                case EnumConditionalFormatType.TwoColorsRange:
                    KryptonOutlookGridTwoColorsParams? twCpar = FormatParams as KryptonOutlookGridTwoColorsParams;
                ...
                case EnumConditionalFormatType.ThreeColorsRange:
                    KryptonOutlookGridThreeColorsParams? thCpar = FormatParams as KryptonOutlookGridThreeColorsParams;

...
internal class KryptonDataGridViewTreeTextCell : KryptonDataGridViewTextBoxCell
{
    ...
    public int Level
    {
        get
        {
            KryptonOutlookGridRow row = (KryptonOutlookGridRow)OwningRow!;
    ...
    /// The owning node.
    /// </value>
    public KryptonOutlookGridRow? OwningNode => OwningRow as KryptonOutlookGridRow;
    ...
    {
        KryptonOutlookGridRow? node = OwningNode;
            ...
            && ((KryptonOutlookGrid)node.DataGridView).ShowLines)
        {
            using (Pen linePen = new(SystemBrushes.ControlDark, 1.0f))
            {
                ...
                else
                {
                    ...
                    KryptonOutlookGridRow? previousNode = node.ParentNode;

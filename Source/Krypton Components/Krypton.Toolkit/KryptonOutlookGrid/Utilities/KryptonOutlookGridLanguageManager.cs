...
internal class KryptonOutlookGridLanguageManager
{
    #region Instance Fields

    private static KryptonOutlookGridLanguageManager? _mInstance = null;
    ...
    public static KryptonOutlookGridLanguageManager Instance
    {
        get
        {
            if (_mInstance == null)
            {
                lock (_myLock)
                {
                    if (_mInstance == null)
                    {
                        _mInstance = new KryptonOutlookGridLanguageManager();
                    }
                }
            }

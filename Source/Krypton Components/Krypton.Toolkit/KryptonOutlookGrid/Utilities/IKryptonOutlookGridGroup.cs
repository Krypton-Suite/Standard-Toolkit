...
/// </summary>
public interface IKryptonOutlookGridGroup : IComparable, ICloneable
{
    /// <summary>
    ...
    /// </summary>
    KryptonOutlookGridColumn Column { get; set; }

    /// <summary>
    /// The list of the rows contained in a group
    /// </summary>
    List<KryptonOutlookGridRow> Rows { get; set; }

    /// <summary>
    /// The parent group if any
    /// </summary>
    IKryptonOutlookGridGroup? ParentGroup { get; set; }
    ...
    /// The children groups
    /// </summary>
    KryptonOutlookGridGroupCollection Children { get; set; }
    ...
    /// </summary>
    KryptonOutlookGridRow? SummaryRow { get; set; }
}
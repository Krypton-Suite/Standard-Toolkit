...
/// </summary>
internal static class KryptonOutlookGridExpressionBuilder
{
    ...
    /// standard object properties and <see cref="DataGridViewRow"/>/<see cref="KryptonOutlookGridRow"/> cell values.
    /// </summary>
    ...
    /// <param name="columns">Optional: A <see cref="DataGridViewColumnCollection"/> providing context for column types when filtering <see cref="DataGridViewRow"/> or <see cref="KryptonOutlookGridRow"/>.</param>
    /// <returns>An <see cref="Expression"/> representing the specified filter condition.</returns>
    /// <exception cref="InvalidOperationException">Thrown if filtering a <see cref="DataGridViewRow"/> or <see cref="KryptonOutlookGridRow"/> without providing a <paramref name="columns"/> collection.</exception>
    ...
    public static Expression GetExpression<T>(Expression parameter, string property, string op, string valueString, string value2String = null!, DataGridViewColumnCollection? columns = null)
    {
        ...
        if (typeof(T) == typeof(DataGridViewRow) || typeof(T) == typeof(KryptonOutlookGridRow))
        {
            if (columns == null)
            {
    ...
    /// of a specific column within a <see cref="DataGridViewRow"/> or <see cref="KryptonOutlookGridRow"/>.
    /// </summary>
    /// <param name="parameter">The <see cref="Expression"/> representing the <see cref="DataGridViewRow"/>
    /// or <see cref="KryptonOutlookGridRow"/> instance.</param>
    ...
    public static Expression BuildComparisonExpression(Expression left, string op, string valueString, Type? targetPropertyType)
    {
        ...
        if (finalLeft.Type == typeof(object) && commonType != typeof(object))
        {
            ...
            {
                MethodInfo? toStringNullMethod = typeof(KryptonOutlookGridHelperExtensions).GetMethod(nameof(KryptonOutlookGridHelperExtensions.ToStringNull), BindingFlags.Static | BindingFlags.Public);
                if (toStringNullMethod == null) throw new InvalidOperationException($"Could not find '{nameof(KryptonOutlookGridHelperExtensions.ToStringNull)}' extension method.");
            ...
            else // Convert to a specific non-string type (int, double, DateTime etc.)
            {
                ...
                // Call a generic To<Type> method from KryptonOutlookGridHelperExtensions if available
                // E.g., KryptonOutlookGridHelperExtensions.ToInteger(obj), KryptonOutlookGridHelperExtensions.ToDouble(obj)
                MethodInfo? conversionMethod = null;
                if (nonNullableCommonType == typeof(int)) conversionMethod = typeof(KryptonOutlookGridHelperExtensions).GetMethod(nameof(KryptonOutlookGridHelperExtensions.ToInteger), BindingFlags.Static | BindingFlags.Public);
                else if (nonNullableCommonType == typeof(long)) conversionMethod = typeof(KryptonOutlookGridHelperExtensions).GetMethod(nameof(KryptonOutlookGridHelperExtensions.ToLong), BindingFlags.Static | BindingFlags.Public);
                else if (nonNullableCommonType == typeof(double)) conversionMethod = typeof(KryptonOutlookGridHelperExtensions).GetMethod(nameof(KryptonOutlookGridHelperExtensions.ToDouble), BindingFlags.Static | BindingFlags.Public);
                else if (nonNullableCommonType == typeof(decimal)) conversionMethod = typeof(KryptonOutlookGridHelperExtensions).GetMethod(nameof(KryptonOutlookGridHelperExtensions.ToDecimal), BindingFlags.Static | BindingFlags.Public);
                else if (nonNullableCommonType == typeof(bool)) conversionMethod = typeof(KryptonOutlookGridHelperExtensions).GetMethod(nameof(KryptonOutlookGridHelperExtensions.ToBoolean), BindingFlags.Static | BindingFlags.Public);
                else if (nonNullableCommonType == typeof(DateTime)) conversionMethod = typeof(KryptonOutlookGridHelperExtensions).GetMethod(nameof(KryptonOutlookGridHelperExtensions.ToDateTime), BindingFlags.Static | BindingFlags.Public);
                else if (nonNullableCommonType == typeof(Guid)) conversionMethod = typeof(KryptonOutlookGridHelperExtensions).GetMethod(nameof(KryptonOutlookGridHelperExtensions.ToGuid), BindingFlags.Static | BindingFlags.Public);


                if (conversionMethod != null)
                {
                    // Call KryptonOutlookGridHelperExtensions.ToX(originalLeft)
    ...
    public static Expression BuildLikeExpression(Expression left, string value, Type? targetPropertyType)
    {
        ...
        {
            throw new InvalidOperationException($"Could not find '{nameof(KryptonOutlookGridHelperExtensions.ToStringNull)}' extension method. " +
                                                "Ensure 'KryptonOutlookGridHelperExtensions' class is public and method is static public in an accessible namespace.");
        }
    ...
    public static Expression ConvertExpressionToTargetType(Expression expression, Type targetType)
    {
        ...
        if (expression.Type == typeof(object) && targetType != typeof(object))
        {
            ...
            {
                MethodInfo? conversionMethod = null;
                // Look for direct KryptonOutlookGridHelperExtensions.ToX methods
                if (nonNullableTargetType == typeof(int)) conversionMethod = typeof(KryptonOutlookGridHelperExtensions).GetMethod(nameof(KryptonOutlookGridHelperExtensions.ToInteger), BindingFlags.Static | BindingFlags.Public);
                else if (nonNullableTargetType == typeof(long)) conversionMethod = typeof(KryptonOutlookGridHelperExtensions).GetMethod(nameof(KryptonOutlookGridHelperExtensions.ToLong), BindingFlags.Static | BindingFlags.Public);
                else if (nonNullableTargetType == typeof(double)) conversionMethod = typeof(KryptonOutlookGridHelperExtensions).GetMethod(nameof(KryptonOutlookGridHelperExtensions.ToDouble), BindingFlags.Static | BindingFlags.Public);
                else if (nonNullableTargetType == typeof(decimal)) conversionMethod = typeof(KryptonOutlookGridHelperExtensions).GetMethod(nameof(KryptonOutlookGridHelperExtensions.ToDecimal), BindingFlags.Static | BindingFlags.Public);
                else if (nonNullableTargetType == typeof(bool)) conversionMethod = typeof(KryptonOutlookGridHelperExtensions).GetMethod(nameof(KryptonOutlookGridHelperExtensions.ToBoolean), BindingFlags.Static | BindingFlags.Public);
                else if (nonNullableTargetType == typeof(DateTime)) conversionMethod = typeof(KryptonOutlookGridHelperExtensions).GetMethod(nameof(KryptonOutlookGridHelperExtensions.ToDateTime), BindingFlags.Static | BindingFlags.Public);
                else if (nonNullableTargetType == typeof(Guid)) conversionMethod = typeof(KryptonOutlookGridHelperExtensions).GetMethod(nameof(KryptonOutlookGridHelperExtensions.ToGuid), BindingFlags.Static | BindingFlags.Public);

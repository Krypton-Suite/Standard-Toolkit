...
namespace Krypton.Toolkit
{
    internal partial class VisualToolkitBinaryInformationForm : KryptonForm
    {
        ...
        private static FileVersionInfo[] _fileVersionInfoCache = new FileVersionInfo[GlobalStaticValues.TOOLKIT_DLL_NAMES.Length];

        private ToolkitSupportType _toolkitType;

        private string _applicationBaseInstallPath = AppDomain.CurrentDomain.BaseDirectory;

        #endregion

        #region Identity

        public VisualToolkitBinaryInformationForm(ToolkitSupportType toolkitType)
        {

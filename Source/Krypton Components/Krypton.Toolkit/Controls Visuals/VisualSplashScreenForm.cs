...
internal partial class VisualSplashScreenForm : KryptonForm/*, ISplashScreenData*/
{
    ...
    private void tmrCountdown_Tick(object sender, EventArgs e)
    {
        ...
        kpbProgress.Text = _splashScreenData.ShowProgressBarPercentage ? $@"{kpbProgress.Value}%" : SharedStaticVariables.DEFAULT_EMPTY_STRING;
    ...
    {
        kbtnClose.StateCommon.Content.ShortText.Color1 = SharedStaticVariables.EMPTY_COLOR;
    }

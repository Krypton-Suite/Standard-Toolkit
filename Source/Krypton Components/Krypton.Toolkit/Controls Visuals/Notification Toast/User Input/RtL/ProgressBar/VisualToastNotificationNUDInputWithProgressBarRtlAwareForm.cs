...
{
    internal partial class VisualToastNotificationNUDInputWithProgressBarRtlAwareForm : KryptonForm
    {
        ...
        public VisualToastNotificationNUDInputWithProgressBarRtlAwareForm(KryptonUserInputToastNotificationData data)
        {
            InitializeComponent();
        ...
        public static decimal ShowToastNotification(KryptonUserInputToastNotificationData data)
        {
            ...
            using var toast = new VisualToastNotificationNUDInputWithProgressBarRtlAwareForm(data);

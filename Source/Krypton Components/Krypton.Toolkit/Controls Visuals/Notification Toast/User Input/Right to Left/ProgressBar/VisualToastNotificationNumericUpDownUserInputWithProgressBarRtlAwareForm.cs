...
{
    internal partial class VisualToastNotificationNumericUpDownUserInputWithProgressBarRtlAwareForm : KryptonForm
    {
        ...
        public VisualToastNotificationNumericUpDownUserInputWithProgressBarRtlAwareForm(KryptonUserInputToastNotificationData data)
        {
            InitializeComponent();
        ...
        public static decimal ShowToastNotification(KryptonUserInputToastNotificationData data)
        {
            ...
            using var toast = new VisualToastNotificationNumericUpDownUserInputWithProgressBarRtlAwareForm(data);

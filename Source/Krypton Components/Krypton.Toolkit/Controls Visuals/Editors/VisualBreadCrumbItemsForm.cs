...
internal partial class VisualBreadCrumbItemsForm : VisualDesignerCollectionForm
{
    #region Types
        /// <summary>
        /// Simple class to reduce the length of declarations!
        /// </summary>
        private class DictItemBase : Dictionary<KryptonBreadCrumbItem, KryptonBreadCrumbItem>;

        /// <summary>
        /// Act as proxy for a crumb item to control the exposed properties to the property grid.
        /// </summary>
        private class CrumbProxy
        {
    ...
    #region Identity
    /// <summary>
    /// Initialize a new instance of the <see cref="VisualBreadCrumbItemsForm"/> class for the WinForms designer.
    /// </summary>
    public VisualBreadCrumbItemsForm()
        : base()
    {
        InitializeComponent();
    ...
    /// </summary>
    public VisualBreadCrumbItemsForm(KryptonBreadCrumbItemsEditor editor)
        : base(editor)
    {
        InitializeComponent();
        ConfigureDesignerChrome();

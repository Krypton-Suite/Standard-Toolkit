...
public class ToolBarImageStorage : Storage
{
    ...
    {
        _toolBarImages = new List<Image>(SharedStaticConstants.REQUIRED_TOOLBAR_IMAGE_COUNT);
    ...
    {
        if (images == null || images.Length < SharedStaticConstants.REQUIRED_TOOLBAR_IMAGE_COUNT)
        {
            return;
        }
        ...
        for (int i = 0; i < SharedStaticConstants.REQUIRED_TOOLBAR_IMAGE_COUNT; i++)
        {
    ...
    {
        if (imageCollection.Count < SharedStaticConstants.REQUIRED_TOOLBAR_IMAGE_COUNT)
        {
            return;
        }

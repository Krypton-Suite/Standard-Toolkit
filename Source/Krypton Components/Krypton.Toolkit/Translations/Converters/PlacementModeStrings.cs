...
namespace Krypton.Toolkit
{
    ...
    public class PlacementModeStrings : GlobalId
    {
        ...
        /// <summary>Gets or sets the absolute placement mode.</summary>
        [Category(@"Visuals")]
        ...
        /// <summary>Gets or sets the absolute point placement mode.</summary>
        [Category(@"Visuals")]
        ...
        /// <summary>Gets or sets the bottom placement mode.</summary>
        [Category(@"Visuals")]
        ...
        /// <summary>Gets or sets the center placement mode.</summary>
        [Category(@"Visuals")]
        ...
        /// <summary>Gets or sets the left placement mode.</summary>
        [Category(@"Visuals")]
        ...
        /// <summary>Gets or sets the mouse placement mode.</summary>
        [Category(@"Visuals")]
        ...
        /// <summary>Gets or sets the mouse point placement mode.</summary>
        [Category(@"Visuals")]
        ...
        /// <summary>Gets or sets the relative placement mode.</summary>
        [Category(@"Visuals")]
        ...
        /// <summary>Gets or sets the relative point placement mode.</summary>
        [Category(@"Visuals")]
        ...
        /// <summary>Gets or sets the right placement mode.</summary>
        [Category(@"Visuals")]
        ...
        /// <summary>Gets or sets the top placement mode.</summary>
        [Category(@"Visuals")]

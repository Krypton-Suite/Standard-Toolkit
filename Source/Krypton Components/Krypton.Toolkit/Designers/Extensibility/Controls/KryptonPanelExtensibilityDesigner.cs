...
/// <summary>
/// Designer for KryptonPanel using the WinForms Designer Extensibility SDK.
/// </summary>
internal class KryptonPanelExtensibilityDesigner : KryptonExtensibilityParentDesignerBase
{
    ...
    public override DesignerActionListCollection ActionLists
    {
        get
        {
            ...
            var actionLists = new DesignerActionListCollection
            {
                ...
                new KryptonPanelExtensibilityActionList(this)
            };
    ...
    protected override void InitializeDesigner(IComponent component)
    {
        ...
        _panel = component as KryptonPanel;

        if (_panel != null)
        {
            // Hook into panel events if needed
            // _panel.SomeEvent += OnSomeEvent;
        }
    }
    ...
    {
        if (_panel != null && e.Component == _panel)
        {
            // Unhook from panel events if needed
            // _panel.SomeEvent -= OnSomeEvent;
        }

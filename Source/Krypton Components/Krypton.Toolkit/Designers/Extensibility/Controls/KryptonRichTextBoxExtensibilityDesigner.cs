...
/// <summary>
/// Designer for KryptonRichTextBox using the WinForms Designer Extensibility SDK.
/// </summary>
internal class KryptonRichTextBoxExtensibilityDesigner : KryptonExtensibilityDesignerBase
{
    ...
    public override DesignerActionListCollection ActionLists
    {
        get
        {
            ...
            {
                // Add the richtextbox specific list
                new KryptonRichTextBoxExtensibilityActionList(this)
            };
    ...
    protected override void InitializeDesigner(IComponent component)
    {
        ...
        {
            // Hook into richtextbox events if needed
            // _richTextBox.SomeEvent += OnSomeEvent;
        }
    }
    ...
    {
        if (_richTextBox != null && e.Component == _richTextBox)
        {
            // Unhook from richtextbox events if needed
            // _richTextBox.SomeEvent -= OnSomeEvent;
        }

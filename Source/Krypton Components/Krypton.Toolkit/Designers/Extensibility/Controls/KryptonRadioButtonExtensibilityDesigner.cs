...
/// <summary>
/// Designer for KryptonRadioButton using the WinForms Designer Extensibility SDK.
/// </summary>
internal class KryptonRadioButtonExtensibilityDesigner : KryptonExtensibilityDesignerBase
{
    ...
    public override DesignerActionListCollection ActionLists
    {
        get
        {
            ...
            {
                // Add the radiobutton specific list
                new KryptonRadioButtonExtensibilityActionList(this)
            };
    ...
    protected override void InitializeDesigner(IComponent component)
    {
        ...
        _radioButton = component as KryptonRadioButton;

        if (_radioButton != null)
        {
            // Hook into radiobutton events if needed
            // _radioButton.SomeEvent += OnSomeEvent;
        }
    }
    ...
    {
        if (_radioButton != null && e.Component == _radioButton)
        {
            // Unhook from radiobutton events if needed
            // _radioButton.SomeEvent -= OnSomeEvent;
        }

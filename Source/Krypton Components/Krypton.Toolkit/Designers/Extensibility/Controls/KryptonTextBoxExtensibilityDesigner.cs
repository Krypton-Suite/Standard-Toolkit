...
/// <summary>
/// Designer for KryptonTextBox using the WinForms Designer Extensibility SDK.
/// </summary>
internal class KryptonTextBoxExtensibilityDesigner : KryptonExtensibilityDesignerBase
{
    ...
    public override DesignerActionListCollection ActionLists
    {
        get
        {
            ...
            {
                // Add the textbox specific list
                new KryptonTextBoxExtensibilityActionList(this)
            };
    ...
    protected override void InitializeDesigner(IComponent component)
    {
        ...
        if (_textBox != null)
        {
            // Hook into textbox events if needed
            // _textBox.SomeEvent += OnSomeEvent;
        }
    }
    ...
    protected override void OnComponentRemoving(object? sender, ComponentEventArgs e)
    {
        ...
        {
            // Unhook from textbox events if needed
            // _textBox.SomeEvent -= OnSomeEvent;
        }

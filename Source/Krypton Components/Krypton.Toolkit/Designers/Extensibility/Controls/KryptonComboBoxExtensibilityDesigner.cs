...
/// <summary>
/// Designer for KryptonComboBox using the WinForms Designer Extensibility SDK.
/// </summary>
internal class KryptonComboBoxExtensibilityDesigner : KryptonExtensibilityDesignerBase
{
    ...
    public override DesignerActionListCollection ActionLists
    {
        get
        {
            ...
            {
                // Add the combobox specific list
                new KryptonComboBoxExtensibilityActionList(this)
            };
    ...
    protected override void InitializeDesigner(IComponent component)
    {
        ...
        if (_comboBox != null)
        {
            // Hook into combobox events if needed
            // _comboBox.SomeEvent += OnSomeEvent;
        }
    }
    ...
    protected override void OnComponentRemoving(object? sender, ComponentEventArgs e)
    {
        ...
        {
            // Unhook from combobox events if needed
            // _comboBox.SomeEvent -= OnSomeEvent;
        }

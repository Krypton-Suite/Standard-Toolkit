...
/// <summary>
/// Base class for Krypton designers using the WinForms Designer Extensibility SDK.
/// Provides common functionality and patterns for all Krypton control designers.
/// </summary>
public abstract class KryptonExtensibilityDesignerBase : ControlDesigner
{
    ...
    /// <param name="oldValue">The old value.</param>
    /// <param name="newValue">The new value.</param>
    protected void NotifyPropertyChanging(IComponent component, MemberDescriptor? member, object? oldValue, object? newValue)
    {

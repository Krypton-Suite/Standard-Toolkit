...
internal class InternalKryptonCommandLinkButtonActionList : DesignerActionList
{
    #region Instance Fields
    private readonly InternalKryptonCommandLinkButton _button;
    private readonly IComponentChangeService? _service;
    #endregion

    #region Identity
    /// <summary>
    /// Initialize a new instance of the InternalKryptonButtonActionList class.
    /// </summary>
    /// <param name="owner">Designer that owns this action list instance.</param>
    public InternalKryptonCommandLinkButtonActionList(InternalKryptonCommandLinkButtonDesigner owner)
        : base(owner.Component)
    {
        // Remember the button instance
        _button = (owner.Component as InternalKryptonCommandLinkButton)!;

...
/// <summary>
/// Smart-tag action list for <see cref="KryptonTagInput"/>.
/// </summary>
internal class KryptonTagInputActionList : DesignerActionList
{
    #region Instance Fields

    private readonly KryptonTagInput _control;
    ...
    /// <summary>
    /// Initialize a new instance of the <see cref="KryptonTagInputActionList"/> class.
    /// </summary>
    /// <param name="owner">Designer that owns this action list instance.</param>
    public KryptonTagInputActionList(KryptonTagInputDesigner owner)
        : base(owner.Component)
    {
        _control = (owner.Component as KryptonTagInput)!;
    ...
    public string CueHintText
    {
        ...
        set => SetValuesProperty(nameof(TagInputValues.CueHintText), _control.Values.CueHintText, value,
    ...
    public bool AllowDuplicates
    {
        ...
        set => SetValuesProperty(nameof(TagInputValues.AllowDuplicates), _control.Values.AllowDuplicates, value,
    ...
    public int MaxTags
    {
        ...
        set => SetValuesProperty(nameof(TagInputValues.MaxTags), _control.Values.MaxTags, value,
    ...
    public bool EnableSuggestions
    {
        ...
        set => SetValuesProperty(nameof(TagInputValues.EnableSuggestions), _control.Values.EnableSuggestions, value,
    ...
    public bool ShowRemoveButton
    {
        ...
        set => SetValuesProperty(nameof(TagInputValues.ShowRemoveButton), _control.Values.ShowRemoveButton, value,

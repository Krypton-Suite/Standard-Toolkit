...
namespace Krypton.Toolkit
{
    internal class KryptonRichTextBoxActionList : DesignerActionList
    {
        ...
        {
            get => _richTextBox.EnableDarkMode;

            set
            {
                if (_richTextBox.EnableDarkMode != value)
                {
                    _service.OnComponentChanged(_richTextBox, null, _richTextBox.EnableDarkMode, value);

                    _richTextBox.EnableDarkMode = value;
                }
            }
        }
        #endregion

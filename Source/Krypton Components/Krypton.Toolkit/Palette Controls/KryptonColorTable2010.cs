...
public class KryptonColorTable2010White : KryptonColorTable2010
{
    ...
    /// MenuStripText
    /// </summary>
    public override Color MenuStripText => SchemeBaseColorsExtensions.Coalesce(Colors.Get(SchemeBaseColors.MenuStripText), Color.FromArgb(255, 30, 30, 30));
}
...
public class KryptonColorTable2010 : KryptonColorTable
{
    ...
    /// <param name="roundedEdges">Should have rounded edges.</param>
    /// <param name="palette">Associated palette instance.</param>
    public KryptonColorTable2010([DisallowNull] Color[] colors,
        InheritBool roundedEdges,
        PaletteBase palette)
        : base(palette)
    {

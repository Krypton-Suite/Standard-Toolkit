...
namespace Krypton.Toolkit
{
    ...
    public class KryptonVisualStudio2010With2010ColorTable : KryptonColorTable
    {
        ...
        public KryptonVisualStudio2010With2010ColorTable(Color[] colors,
        ...
        /// </summary>
        public override Color MenuItemText => _menuStripItemTextColor; // Colors[(int)SchemeOfficeColors.TextButtonNormal];
        ...
        /// </summary>
        public override Color MenuStripText => _menuStripItemTextColor; //Colors[(int)SchemeOfficeColors.StatusStripText];

...
public class PaletteContentInheritNode : PaletteContentInherit
{
    ...
    /// <param name="state">Palette value should be applicable to this state.</param>
    /// <returns>Color value.</returns>
    public override Color GetContentShortTextColor1(PaletteState state) => (TreeNode != null) && (TreeNode.ForeColor != SharedStaticVariables.EMPTY_COLOR) ? TreeNode.ForeColor : _inherit.GetContentShortTextColor1(state);
    ...
    /// <param name="state">Palette value should be applicable to this state.</param>
    /// <returns>Color value.</returns>
    public override Color GetContentShortTextColor2(PaletteState state) => (TreeNode != null) && (TreeNode.ForeColor != SharedStaticVariables.EMPTY_COLOR) ? TreeNode.ForeColor : _inherit.GetContentShortTextColor2(state);
    ...
    public override Color GetContentLongTextColor1(PaletteState state) =>
        (TreeNode is KryptonTreeNode kryptonNode) && (kryptonNode.LongForeColor != SharedStaticVariables.EMPTY_COLOR)

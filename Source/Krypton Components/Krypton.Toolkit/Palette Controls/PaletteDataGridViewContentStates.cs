    ...
    IPaletteContent
{
    ...
    /// <param name="state">Palette value should be applicable to this state.</param>
    /// <returns>Color value.</returns>
    public Color GetContentShortTextColor1(PaletteState state) => _color1 != SharedStaticVariables.EMPTY_COLOR ? _color1 : Inherit.GetContentShortTextColor1(state);
    ...
    /// <param name="state">Palette value should be applicable to this state.</param>
    /// <returns>Color value.</returns>
    public Color GetContentShortTextColor2(PaletteState state) => _color2 != SharedStaticVariables.EMPTY_COLOR ? _color2 : Inherit.GetContentShortTextColor2(state);

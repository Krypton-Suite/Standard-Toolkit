...
public class InternalViewDrawCommandLinkButton : ViewComposite
{
    ...
    /// <summary>
    /// Initialize a new instance of the <see cref="InternalViewDrawCommandLinkButton"/> class.
    /// </summary>
    ...
    public InternalViewDrawCommandLinkButton(IPaletteTriple paletteDisabled,
        IPaletteTriple paletteNormal,
        IPaletteTriple paletteTracking,
        IPaletteTriple palettePressed,
        IPaletteMetric paletteMetric,
        InternalCommandLinkImageValues imageValues,
        InternalCommandLinkTextValues commandLinkTextValues,

...
namespace Krypton.Toolkit
{
    internal class DesignTimeUtilities
    {
        ...
        internal const string DEFAULT_HEADER_STYLE_CALENDAR = nameof(System.Globalization.Calendar);
        ...
        internal const string DEFAULT_HEADER_STYLE_FORM = nameof(System.Windows.Forms.Form);
        ...
        internal const string DEFAULT_PALETTE_BUTTON_STYLE_FORM = nameof(System.Windows.Forms.Form);
        internal const string DEFAULT_PALETTE_BUTTON_STYLE_FORM_CLOSE = @"Form Close";
        internal const string DEFAULT_PALETTE_BUTTON_STYLE_BUTTON_SPEC = nameof(Toolkit.ButtonSpec);

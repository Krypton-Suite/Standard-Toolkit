...
namespace Krypton.Toolkit
{
    ...
    internal class PaletteModeManagerConverter : StringLookupConverter
    {
        ...
        private readonly Pair[] _pairs = new Pair[] { new(PaletteModeManager.ProfessionalSystem,    "Professional - System"),
                                             ...
                                             new(PaletteModeManager.Office2007BlueAlt,     "Office 2007 - Blue (Alternative)"),
                                             ...
                                             new(PaletteModeManager.Office2007BlackAlt,    "Office 2007 - Black (Alternative)"),
                                             new(PaletteModeManager.Office2010Blue,        "Office 2010 - Blue"),
                                             new(PaletteModeManager.Office2010BlueAlt,     "Office 2010 - Blue (Alternative)"),
                                             ...
                                             new(PaletteModeManager.Office2010BlackAlt,    "Office 2010 - Black (Alternative)"),
                                             new(PaletteModeManager.Office2013White,       "Office 2013 - White"),
                                             new(PaletteModeManager.Office365Black,        "Office 365 - Black"),
                                             new(PaletteModeManager.Office365BlackAlt,     "Office 365 - Black (Alternative)"),
                                             new(PaletteModeManager.Office365Blue,         "Office 365 - Blue"),
                                             new(PaletteModeManager.Office365BlueAlt,      "Office 365 - Blue (Alternative)"),

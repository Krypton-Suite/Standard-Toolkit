...
namespace Krypton.Toolkit
{
    ...
    internal class InputControlStyleConverter : StringLookupConverter<InputControlStyle>
    {
            ...
            new Dictionary<InputControlStyle, string>
        {
            ...
            // {InputControlStyle.PanelAlternateInverted, DesignTimeUtilities.DEFAULT_INPUT_CONTROL_STYLE_PANEL_CLIENT_INVERTED},
            {InputControlStyle.PanelAlternate, DesignTimeUtilities.DEFAULT_INPUT_CONTROL_STYLE_PANEL_ALTERNATE},
            // {InputControlStyle.PanelAlternateInverted, DesignTimeUtilities.DEFAULT_INPUT_CONTROL_STYLE_PANEL_ALTERNATE_INVERTED}

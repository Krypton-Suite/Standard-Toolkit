...
namespace Krypton.Toolkit
{
    ...
    internal class PaletteModeConverter : StringLookupConverter
    {
        ...
        private readonly Pair[] _pairs = new Pair[] { new(PaletteMode.ProfessionalSystem,    "Professional - System"),
                                             ...
                                             new(PaletteMode.Office2007BlueAlt,     "Office 2007 - Blue (Alternative)"),
                                             ...
                                             new(PaletteMode.Office2007BlackAlt,    "Office 2007 - Black (Alternative)"),
                                             new(PaletteMode.Office2010Blue,        "Office 2010 - Blue"),
                                             new(PaletteMode.Office2010BlueAlt,     "Office 2010 - Blue (Alternative)"),
                                             ...
                                             new(PaletteMode.Office2010BlackAlt,    "Office 2010 - Black (Alternative)"),
                                             new(PaletteMode.Office2013White,       "Office 2013 - White"),
                                             new(PaletteMode.Office365Black,        "Office 365 - Black"),
                                             new(PaletteMode.Office365BlackAlt,     "Office 365 - Black (Alternative)"),
                                             new(PaletteMode.Office365Blue,         "Office 365 - Blue"),
                                             new(PaletteMode.Office365BlueAlt,      "Office 365 - Blue (Alternative)"),

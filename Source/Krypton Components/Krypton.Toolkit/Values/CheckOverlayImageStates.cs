...
/// <summary>
/// Storage for check-button per-state overlay image information.
/// </summary>
public class CheckOverlayImageStates : OverlayImageStates
{
    ...
    [Localizable(true)]
    [Category(@"Visuals")]
    [Description(@"Overlay image for checked normal state.")]
    ...
    [Localizable(true)]
    [Category(@"Visuals")]
    [Description(@"Overlay image for checked pressed state.")]
    [RefreshProperties(RefreshProperties.All)]
    [EditorBrowsable(EditorBrowsableState.Always)]
    [Browsable(true)]
    [DefaultValue(null)]
    ...
    [Localizable(true)]
    [Category(@"Visuals")]
    [Description(@"Overlay image for checked tracking state.")]
    [RefreshProperties(RefreshProperties.All)]
    [EditorBrowsable(EditorBrowsableState.Always)]
    [Browsable(true)]
    [DefaultValue(null)]
    ...
    public void CopyFrom(CheckOverlayImageStates source)
    {

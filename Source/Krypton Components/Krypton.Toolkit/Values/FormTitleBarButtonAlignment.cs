...
public class FormTitleBarButtonAlignment
{
    ...
    public FormTitleBarButtonAlignment(Action? onChanged = null) => _onChanged = onChanged;
    ...
    [DefaultValue(typeof(PaletteRelativeEdgeAlign), "PaletteRelativeEdgeAlign.Far")]

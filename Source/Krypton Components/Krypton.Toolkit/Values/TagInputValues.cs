...
/// <summary>
/// Behaviour and appearance values for <see cref="KryptonTagInput"/>.
/// </summary>
[TypeConverter(typeof(ExpandableObjectConverter))]
public class TagInputValues : Storage
{
    ...
    /// <summary>
    /// Initialize a new instance of the <see cref="TagInputValues"/> class.
    /// </summary>
    /// <param name="owner">Owning tag input control.</param>
    public TagInputValues(KryptonTagInput owner)
    {

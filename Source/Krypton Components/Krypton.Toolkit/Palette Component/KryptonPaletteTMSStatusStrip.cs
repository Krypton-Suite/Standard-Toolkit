...
public class KryptonPaletteTMSStatusStrip : KryptonPaletteTMSBase
{
    ...
    public override bool IsDefault => (InternalKCT.InternalStatusStripText == SharedStaticVariables.EMPTY_COLOR) &&
                                      (InternalKCT.InternalStatusStripFont == null) &&
                                      (InternalKCT.InternalStatusStripGradientBegin == SharedStaticVariables.EMPTY_COLOR) &&
                                      (InternalKCT.InternalStatusStripGradientEnd == SharedStaticVariables.EMPTY_COLOR);
    ...
    /// </summary>
    public void ResetStatusStripText() => StatusStripText = SharedStaticVariables.EMPTY_COLOR;
    #endregion
    ...
    /// </summary>
    public void ResetStatusStripFont() => StatusStripText = SharedStaticVariables.EMPTY_COLOR;
    #endregion
    ...
    /// </summary>
    public void ResetStatusStripGradientBegin() => StatusStripGradientBegin = SharedStaticVariables.EMPTY_COLOR;
    #endregion
    ...
    /// </summary>
    public void ResetStatusStripGradientEnd() => StatusStripGradientEnd = SharedStaticVariables.EMPTY_COLOR;
    #endregion
}
...
public class KryptonPaletteTMSSeparator : KryptonPaletteTMSBase
{
    ...
    public override bool IsDefault => (InternalKCT.InternalSeparatorDark == SharedStaticVariables.EMPTY_COLOR) &&
                                      (InternalKCT.InternalSeparatorLight == SharedStaticVariables.EMPTY_COLOR);
    ...
    /// </summary>
    public void ResetSeparatorDark() => SeparatorDark = SharedStaticVariables.EMPTY_COLOR;
    #endregion
    ...
    /// </summary>
    public void ResetSeparatorLight() => SeparatorLight = SharedStaticVariables.EMPTY_COLOR;
    #endregion
}
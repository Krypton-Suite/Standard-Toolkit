...
public class PaletteRibbonFileAppTab : Storage, IPaletteRibbonFileAppTab
{
        ...
        NeedPaintHandler needPaint)
    {
        ...
        // Set default values
        _ribbonFileAppTabBottomColor = SharedStaticVariables.DEFAULT_RIBBON_FILE_APP_TAB_BOTTOM_COLOR;
        _ribbonFileAppTabTopColor = SharedStaticVariables.DEFAULT_RIBBON_FILE_APP_TAB_TOP_COLOR;
        _ribbonFileAppTabTextColor = SharedStaticVariables.DEFAULT_RIBBON_FILE_APP_TAB_TEXT_COLOR;
    }
    #endregion
    ...
    private void ResetRibbonFileAppTabBottomColor() => RibbonFileAppTabBottomColor = SharedStaticVariables.DEFAULT_RIBBON_FILE_APP_TAB_BOTTOM_COLOR;
    private bool ShouldSerializeRibbonFileAppTabBottomColor() => RibbonFileAppTabBottomColor != SharedStaticVariables.DEFAULT_RIBBON_FILE_APP_TAB_BOTTOM_COLOR;
    ...
    private void ResetRibbonFileAppTabTopColor() => RibbonFileAppTabTopColor = SharedStaticVariables.DEFAULT_RIBBON_FILE_APP_TAB_TOP_COLOR;
    private bool ShouldSerializeRibbonFileAppTabTopColor() => RibbonFileAppTabTopColor != SharedStaticVariables.DEFAULT_RIBBON_FILE_APP_TAB_TOP_COLOR;
    ...
    private void ResetRibbonFileAppTabTextColor() => RibbonFileAppTabTextColor = SharedStaticVariables.DEFAULT_RIBBON_FILE_APP_TAB_TEXT_COLOR;
    private bool ShouldSerializeRibbonFileAppTabTextColor() => RibbonFileAppTabTextColor != SharedStaticVariables.DEFAULT_RIBBON_FILE_APP_TAB_TEXT_COLOR;

    ...
    IPaletteRibbonText
{
        ...
        NeedPaintHandler? needPaint) 
    {
        ...
        _backColor1 = SharedStaticVariables.EMPTY_COLOR;
        _backColor2 = SharedStaticVariables.EMPTY_COLOR;
        _backColor3 = SharedStaticVariables.EMPTY_COLOR;
        _backColor4 = SharedStaticVariables.EMPTY_COLOR;
        _backColor5 = SharedStaticVariables.EMPTY_COLOR;
        _textColor = SharedStaticVariables.EMPTY_COLOR;
    }
    #endregion
    ...
    public override bool IsDefault => (BackColor1 == SharedStaticVariables.EMPTY_COLOR) &&
                                      (BackColor2 == SharedStaticVariables.EMPTY_COLOR) &&
                                      (BackColor3 == SharedStaticVariables.EMPTY_COLOR) &&
                                      (BackColor4 == SharedStaticVariables.EMPTY_COLOR) &&
                                      (BackColor5 == SharedStaticVariables.EMPTY_COLOR) &&
                                      (TextColor == SharedStaticVariables.EMPTY_COLOR);
    ...
    private bool ShouldSerializeBackColor1() => BackColor1 != SharedStaticVariables.EMPTY_COLOR;
    private void ResetBackColor1() => BackColor1 = SharedStaticVariables.EMPTY_COLOR;
    ...
    public Color GetRibbonBackColor1(PaletteState state) =>
        BackColor1 != SharedStaticVariables.EMPTY_COLOR ? BackColor1 : _inheritBack.GetRibbonBackColor1(state);
    ...
    private bool ShouldSerializeBackColor2() => BackColor2 != SharedStaticVariables.EMPTY_COLOR;
    private void ResetBackColor2() => BackColor2 = SharedStaticVariables.EMPTY_COLOR;
    ...
    public Color GetRibbonBackColor2(PaletteState state) =>
        BackColor2 != SharedStaticVariables.EMPTY_COLOR ? BackColor2 : _inheritBack.GetRibbonBackColor2(state);
    ...
    private bool ShouldSerializeBackColor3() => BackColor3 != SharedStaticVariables.EMPTY_COLOR;
    private void ResetBackColor3() => BackColor3 = SharedStaticVariables.EMPTY_COLOR;
    ...
    public Color GetRibbonBackColor3(PaletteState state) =>
        BackColor3 != SharedStaticVariables.EMPTY_COLOR ? BackColor3 : _inheritBack.GetRibbonBackColor3(state);
    ...
    private bool ShouldSerializeBackColor4() => BackColor4 != SharedStaticVariables.EMPTY_COLOR;
    private void ResetBackColor4() => BackColor4 = SharedStaticVariables.EMPTY_COLOR;
    ...
    public Color GetRibbonBackColor4(PaletteState state) =>
        BackColor4 != SharedStaticVariables.EMPTY_COLOR ? BackColor4 : _inheritBack.GetRibbonBackColor4(state);
    ...
    private bool ShouldSerializeBackColor5() => BackColor5 != SharedStaticVariables.EMPTY_COLOR;
    private void ResetBackColor5() => BackColor5 = SharedStaticVariables.EMPTY_COLOR;
    ...
    public Color GetRibbonBackColor5(PaletteState state) =>
        BackColor5 != SharedStaticVariables.EMPTY_COLOR ? BackColor5 : _inheritBack.GetRibbonBackColor5(state);
    ...
    private bool ShouldSerializeTextColor() => TextColor != SharedStaticVariables.EMPTY_COLOR;
    private void ResetTextColor() => TextColor = SharedStaticVariables.EMPTY_COLOR;
    ...
    public Color GetRibbonTextColor(PaletteState state) =>
        TextColor != SharedStaticVariables.EMPTY_COLOR ? TextColor : _inheritText.GetRibbonTextColor(state);

    ...
    IPaletteRibbonText
{
    ...
    public override bool IsDefault => TextColor == SharedStaticVariables.EMPTY_COLOR;
    ...
    public Color GetRibbonTextColor(PaletteState state) => TextColor != SharedStaticVariables.EMPTY_COLOR
        ? TextColor
        : (_inheritText?.GetRibbonTextColor(state) ?? SharedStaticVariables.EMPTY_COLOR);

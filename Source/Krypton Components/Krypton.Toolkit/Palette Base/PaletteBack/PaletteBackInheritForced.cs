...
namespace Krypton.Toolkit
{
    ...
    public class PaletteBackInheritForced : PaletteBackInherit
    {
        ...
        public override PaletteGraphicsHint GetBackGraphicsHint(PaletteState state) => ForceGraphicsHint != PaletteGraphicsHint.Inherit ? ForceGraphicsHint : _inherit!.GetBackGraphicsHint(state);

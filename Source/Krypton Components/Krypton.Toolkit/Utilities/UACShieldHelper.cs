...
public static class UACShieldHelper
{
    ...
    private const int UAC_SHIELD_ICON_ID = (int)PI.ImageresIconID.Shield; // Standard UAC shield icon
    private const int UAC_SHIELD_ICON_ID_ALT = (int)PI.ImageresIconID.ShieldAlt; // Alternative UAC shield icon

...
public static class UACShieldHelper
{
    ...
    public static Bitmap? GetUACShieldFromImageres(Size size)
    {
        try
        {
            ...
            var icon = GraphicsExtensions.ExtractIcon(Libraries.Imageres, SharedStaticConstants.UAC_SHIELD_ICON_ID, isLargeIcon);
            ...
            icon = GraphicsExtensions.ExtractIcon(Libraries.Imageres, SharedStaticConstants.UAC_SHIELD_ICON_ID_ALT, isLargeIcon);

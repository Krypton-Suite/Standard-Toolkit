...
namespace System
{
    internal static partial class SR
    {
        ...
        private static readonly ResourceManager ResourceManager = new ResourceManager("YourResourceNamespace.ResourceFileName", typeof(SR).Assembly);

        public static string PlatformNotSupported_FullFrameworkRequired => GetResourceString("PlatformNotSupported_FrameworkUpdatedRequired", @"The native library '{0}' does not have all required functions. Please, update the .NET Framework.");

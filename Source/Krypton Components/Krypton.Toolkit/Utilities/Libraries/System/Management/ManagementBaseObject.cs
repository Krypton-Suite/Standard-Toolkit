...
#pragma warning disable CS0169 // Kept for possible reflection, comment above for history
        private static readonly WbemContext _lockOnFastProx; // RemovedDuringPort System.Management.Instrumentation.WMICapabilities.IsWindowsXPOrHigher()?null:new WbemContext();
...
#pragma warning restore CA1823
        ...
        {
            return null == managementObject ? IntPtr.Zero : (IntPtr)managementObject.WbemObject!;
        }
        ...
        {
            IWbemClassObjectFreeThreaded? theClone;
        ...
        public virtual PropertyDataCollection Properties
        {
            get
            {
                ...
                return _properties ??= new PropertyDataCollection(this, false);
            }
        }
        ...
        public virtual PropertyDataCollection SystemProperties
        {
            get
            {
                ...
                return _systemProperties ??= new PropertyDataCollection(this, true);
            }
        }
        ...
        public virtual QualifierDataCollection Qualifiers
        {
            get
            {
                ...
                return _qualifiers ??= new QualifierDataCollection(this);
            }
        }
        ...
        public virtual ManagementPath? ClassPath
        {
            get
            {
                ...
                try
                {
                    classPath.Server = (string)(serverName is DBNull ? "" : serverName)!;
                    classPath.NamespacePath = (string)(scopeName is DBNull ? "" : scopeName)!;
                    classPath.ClassName = (string)(className is DBNull ? "" : className)!;
                }
                catch
                {
                }
        ...
        public string? GetText(TextFormat format)
        {
            ...
            switch (format)
            {
                ...
                case TextFormat.WmiDtd20:
                    ...
                    IWbemObjectTextSrc? wbemTextSrc = new WbemObjectTextSrc() as IWbemObjectTextSrc;
                    IWbemContext? ctx = new WbemContext() as IWbemContext;
                    object v = (bool)true;
        ...
        internal string? ClassName
        {
            get
            {
                ...
                return val is DBNull ? string.Empty : (string)val!;
            }
        }

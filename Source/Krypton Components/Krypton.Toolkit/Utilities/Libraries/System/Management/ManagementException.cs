...
namespace System.Management
{
    ...
    {
        private readonly ManagementBaseObject? _errorObject;
        private readonly ManagementStatus     _errorCode;
        ...
        internal ManagementException(Exception e, string msg, ManagementBaseObject errObj) : base(msg, e)
        {
            try
            {
                ...
                {
                    _errorCode = ((ManagementException)e).ErrorCode;

                    // May/may not have extended error info.
                    //
                    if (_errorObject != null)
                    {
                        _errorObject = (ManagementBaseObject)((ManagementException)e)._errorObject.Clone();
                    }
                    else
                    {
                        _errorObject = null;
                ...
                {
                    _errorCode = (ManagementStatus)((COMException)e).ErrorCode;
                }
                else
                {
                    _errorCode = (ManagementStatus)this.HResult;
                }
            }
            catch { }
        }
        ...
        {
            _errorCode = (ManagementStatus)info.GetValue("errorCode", typeof(ManagementStatus));
        }
        /// <summary>
        ...
        public ManagementException(string message, Exception innerException) : this(innerException, message, null)
        {
            ...
            {
                _errorCode = ManagementStatus.Failed;
            }
        }

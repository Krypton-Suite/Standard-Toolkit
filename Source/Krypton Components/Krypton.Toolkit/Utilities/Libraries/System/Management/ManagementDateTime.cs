...
namespace System.Management
{
    ...
    public sealed class ManagementDateTimeConverter
    {
        ...
        public static DateTime ToDateTime(string dmtfDate)
        {
            ...
            IFormatProvider? frmInt32 = CultureInfo.InvariantCulture.GetFormat(typeof(int)) as IFormatProvider;
            long ticks = 0;
            int utcOffset = 0;
            try
            {
                ...
                if (("******" != tempString))
                {
                    ticks = (long.Parse(tempString, CultureInfo.InvariantCulture.GetFormat(typeof(long)) as IFormatProvider)) * (TimeSpan.TicksPerMillisecond / 1000);
                }
        ...
        public static string ToDmtfDateTime(DateTime date)
        {
            ...
            string strMicrosec = microsec.ToString((CultureInfo.InvariantCulture.GetFormat(typeof(long)) as IFormatProvider)!);
        ...
        public static TimeSpan ToTimeSpan(string dmtfTimespan)
        {
            ...
            if (dmtfts == null)
            {
                throw new ArgumentOutOfRangeException(nameof(dmtfTimespan));
            }
            if (dmtfts.Length == 0)
            {
                throw new ArgumentOutOfRangeException(nameof(dmtfTimespan));
        ...
        public static string ToDmtfTimeInterval(TimeSpan timespan)
        {
            ...
            string dmtftimespan = timespan.Days.ToString(CultureInfo.InvariantCulture.GetFormat(typeof(int)) as IFormatProvider).PadLeft(8, '0');
            IFormatProvider? frmInt32 = CultureInfo.InvariantCulture.GetFormat(typeof(int)) as IFormatProvider;
            ...
            long microsec = ((timespan.Ticks - tsTemp.Ticks) * 1000) / TimeSpan.TicksPerMillisecond;

...
namespace Krypton.Toolkit
{
    ...
    /// </summary>
    public class PaletteOffice2010BlueAlt : PaletteOffice2010Base
    {
        #region Static Fields
        private static readonly ImageList _checkBoxList;
        private static readonly ImageList _galleryButtonList;
        private static readonly Image[] _radioButtonArray;
        private static readonly Image _blueDropDownButton = Resources._2010BlueDropDownButton;
        ...
        #region Identity
        static PaletteOffice2010BlueAlt()
        {
        ...
        /// </summary>
        public PaletteOffice2010BlueAlt()
            : base(_schemeColors,
                   _checkBoxList,
                   _galleryButtonList,
                   _radioButtonArray,

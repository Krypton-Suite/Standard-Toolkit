...
/// </summary>
public class PaletteSparkleHighContrast : PaletteSparkleBase
{
    ...
    static PaletteSparkleHighContrast()
    {
    ...
    /// <summary>
    /// Initialize a new instance of the <see cref="PaletteSparkleHighContrast"/> class.
    /// </summary>
    public PaletteSparkleHighContrast()
        : base(new PaletteHighContrast_BaseScheme(), _sparkleColors, _appButtonNormal, _appButtonTrack, _appButtonPressed,
            _ribbonGroupCollapsedBorderContextTracking, _checkBoxList, _radioButtonArray)
    {
        ThemeName = nameof(PaletteSparkleHighContrast);
        AccessibilitySparkleAccents.ApplyHighContrast(_sparkleColors, _appButtonTrack, _appButtonPressed);
    }

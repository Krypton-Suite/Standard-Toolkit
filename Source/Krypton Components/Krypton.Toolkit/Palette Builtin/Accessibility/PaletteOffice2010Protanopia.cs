...
/// <summary>
/// Office 2010 renderer with protanopia-friendly colours (#4168).
/// </summary>
public class PaletteOffice2010Protanopia : PaletteOffice2010Base
{
    ...
    static PaletteOffice2010Protanopia()
    {
    ...
    /// <summary>
    /// Initialize a new instance of the <see cref="PaletteOffice2010Protanopia"/> class.
    /// </summary>
    public PaletteOffice2010Protanopia()
        : base(new PaletteProtanopia_BaseScheme(), _checkBoxList, _galleryButtonList, _radioButtonArray)
    {
        ThemeName = nameof(PaletteOffice2010Protanopia);

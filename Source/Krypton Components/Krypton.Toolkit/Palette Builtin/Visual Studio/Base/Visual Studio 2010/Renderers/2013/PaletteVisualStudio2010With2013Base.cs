...
public abstract class PaletteVisualStudio2010With2013Base : PaletteBase
{
    ...
    public PaletteVisualStudio2010With2013Base([DisallowNull] Color[] schemeColours,
    ...
    public override KryptonColorTable ColorTable
    {
        get
        {
            _table ??= new KryptonVisualStudio2010With2013ColorTable(_ribbonColours, InheritBool.True, this);

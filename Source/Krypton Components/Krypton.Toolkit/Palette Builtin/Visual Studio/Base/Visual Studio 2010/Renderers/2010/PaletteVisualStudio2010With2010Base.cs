...
public abstract class PaletteVisualStudio2010With2010Base : PaletteBase
{
    ...
    public PaletteVisualStudio2010With2010Base([DisallowNull] Color[] schemeColours,
    ...
    public override IRenderer GetRenderer() => KryptonManager.RenderVisualStudio2010With2010;
    ...
    public override KryptonColorTable ColorTable
    {
        get
        {
            _table ??= new KryptonVisualStudio2010With2010ColorTable(_ribbonColours, InheritBool.True, this);

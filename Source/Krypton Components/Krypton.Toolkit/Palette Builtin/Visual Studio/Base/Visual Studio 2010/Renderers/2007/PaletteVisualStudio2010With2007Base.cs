...
public abstract class PaletteVisualStudio2010With2007Base : PaletteBase
{
    ...
    [
        ...
        Color.FromArgb(229, 195, 101), // Button, Tracking, Border 1
        Color.FromArgb(255, 226, 112), // Button, Tracking, Border 2
    ...
    [
        ...
        Color.FromArgb(255, 246, 217), // Button, Tracking, Back 1
        Color.FromArgb(255, 236, 181), // Button, Tracking, Back 2
    ...
    /// <summary>Initializes a new instance of the <see cref="PaletteVisualStudio2010With2007Base" /> class.</summary>
    ...
    public PaletteVisualStudio2010With2007Base([DisallowNull] Color[] schemeColours,
        ...
        [DisallowNull] Image?[] radioButtonArray, Color[] trackBarColours)
    {
        ...
        ThemeName = nameof(PaletteVisualStudio2010With2007Base);
    ...
    public override IRenderer GetRenderer() => KryptonManager.RenderVisualStudio2010With2007;
    ...
    public override Color GetBackColor1(PaletteBackStyle style, PaletteState state)
    {
        ...
        switch (style)
        {
            ...
            case PaletteBackStyle.GridDataCellCustom3:
                return state == PaletteState.CheckedNormal ? _ribbonColours[(int)SchemeBaseColors.GridDataCellSelected] : SystemColors.Window;
    ...
    public override Color GetBackColor2(PaletteBackStyle style, PaletteState state)
    {
        ...
        switch (style)
        {
            ...
            case PaletteBackStyle.ControlToolTip:
                return _ribbonColours[(int)SchemeBaseColors.ToolTipBottom];
            case PaletteBackStyle.ContextMenuOuter:
                return _contextMenuBack;
            case PaletteBackStyle.ContextMenuSeparator:
            case PaletteBackStyle.ContextMenuItemSplit:
    ...
    public override Color GetContentShortTextColor1(PaletteContentStyle style, PaletteState state)
    {
        ...
        return style switch
        {
            ...
            PaletteContentStyle.LabelNormalPanel or PaletteContentStyle.LabelBoldPanel or PaletteContentStyle.LabelItalicPanel or PaletteContentStyle.LabelTitlePanel or PaletteContentStyle.LabelGroupBoxCaption => _ribbonColours[(int)SchemeBaseColors.TextLabelPanel],
            ...
            PaletteContentStyle.LabelAlternatePanel or PaletteContentStyle.LabelAlternateControl => _ribbonColours[(int)SchemeBaseColors.StatusStripText],
    ...
    public override KryptonColorTable ColorTable
    {
        get
        {
            _table ??= new KryptonVisualStudio2010With2007ColorTable(_ribbonColours, InheritBool.True, this);

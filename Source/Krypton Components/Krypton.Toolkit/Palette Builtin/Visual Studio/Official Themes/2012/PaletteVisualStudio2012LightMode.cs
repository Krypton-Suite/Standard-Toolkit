...
namespace Krypton.Toolkit
{
    ...
    {
        protected PaletteVisualStudio2012LightMode(Color[] schemeColours, ImageList checkBoxList, ImageList galleryButtonList, Image[] radioButtonArray, Color[] trackBarColours) 
            : base(schemeColours, checkBoxList, galleryButtonList, radioButtonArray, trackBarColours)
        {
            ThemeName = nameof(PaletteVisualStudio2012LightMode);
        }
    }
}

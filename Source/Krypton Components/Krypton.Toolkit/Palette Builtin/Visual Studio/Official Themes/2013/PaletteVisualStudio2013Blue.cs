...
/// <summary>
/// Visual Studio 2013 blue palette.
/// </summary>
public class PaletteVisualStudio2013Blue : PaletteVisualStudio2022LightBase
{
    #region Static Fields

    private static readonly Color _tabRowBackgroundColor = Color.FromArgb(214, 219, 233);
    ...
    static PaletteVisualStudio2013Blue()
    {
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PaletteVisualStudio2013Blue"/> class.
    /// </summary>
    public PaletteVisualStudio2013Blue()
        : base(
            new PaletteVisualStudio2013Blue_BaseScheme(),
            _checkBoxList,
            _galleryButtonList,
            _radioButtonArray)
    {
        ThemeName = nameof(PaletteVisualStudio2013Blue);
    }

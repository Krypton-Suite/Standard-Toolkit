...
/// <summary>
/// Visual Studio 2013 dark palette.
/// </summary>
public class PaletteVisualStudio2013Dark : PaletteVisualStudio2022DarkBase
{
    #region Static Fields

    private static readonly Color _tabRowBackgroundColor = Color.FromArgb(45, 45, 48);
    ...
    static PaletteVisualStudio2013Dark()
    {
    ...
    public PaletteVisualStudio2013Dark()
        : base(
            new PaletteVisualStudio2013Dark_BaseScheme(),
            _checkBoxList,
            _galleryButtonList,
            _radioButtonArray)
    {
        ThemeName = nameof(PaletteVisualStudio2013Dark);
    }

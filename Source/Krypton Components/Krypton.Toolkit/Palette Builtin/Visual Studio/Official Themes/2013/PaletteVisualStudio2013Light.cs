...
/// <summary>
/// Visual Studio 2013 light palette.
/// </summary>
public class PaletteVisualStudio2013Light : PaletteVisualStudio2022LightBase
{
    #region Static Fields

    private static readonly Color _tabRowBackgroundColor = Color.FromArgb(238, 238, 242);

    private static readonly Color _ribbonAppButtonDarkColor = Color.FromArgb(0, 99, 177);

    private static readonly Color _ribbonAppButtonLightColor = Color.FromArgb(0, 122, 204);
    ...
    static PaletteVisualStudio2013Light()
    {
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PaletteVisualStudio2013Light"/> class.
    /// </summary>
    public PaletteVisualStudio2013Light()
        : base(
            new PaletteVisualStudio2013Light_BaseScheme(),
            _checkBoxList,
            _galleryButtonList,
            _radioButtonArray)
    {
        ThemeName = nameof(PaletteVisualStudio2013Light);
    }

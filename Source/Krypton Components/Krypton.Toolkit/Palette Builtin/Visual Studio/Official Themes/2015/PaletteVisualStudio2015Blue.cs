...
/// <summary>
/// Visual Studio 2015 blue palette.
/// </summary>
public class PaletteVisualStudio2015Blue : PaletteVisualStudio2022LightBase
{
    #region Static Fields

    private static readonly Color _tabRowBackgroundColor = Color.FromArgb(210, 216, 232);
    ...
    static PaletteVisualStudio2015Blue()
    {
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PaletteVisualStudio2015Blue"/> class.
    /// </summary>
    public PaletteVisualStudio2015Blue()
        : base(
            new PaletteVisualStudio2015Blue_BaseScheme(),
            _checkBoxList,
            _galleryButtonList,
            _radioButtonArray)
    {
        ThemeName = nameof(PaletteVisualStudio2015Blue);
    }

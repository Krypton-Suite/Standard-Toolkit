...
/// <summary>
/// Visual Studio 2026 dark palette (Fluent tokens).
/// </summary>
public class PaletteVisualStudio2026Dark : PaletteVisualStudio2022DarkBase
{
    #region Static Fields

    private static readonly Color _tabRowBackgroundColor = Color.FromArgb(28, 28, 28);

    private static readonly Color _ribbonAppButtonDarkColor = Color.FromArgb(63, 54, 130);

    private static readonly Color _ribbonAppButtonLightColor = Color.FromArgb(145, 132, 238);
    ...
    static PaletteVisualStudio2026Dark()
    {
    ...
    public PaletteVisualStudio2026Dark()
        : base(
            new PaletteVisualStudio2026Dark_BaseScheme(),
            _checkBoxList,
            _galleryButtonList,
            _radioButtonArray)
    {
        ThemeName = nameof(PaletteVisualStudio2026Dark);
    }

...
/// <summary>
/// Visual Studio 2017 blue palette.
/// </summary>
public class PaletteVisualStudio2017Blue : PaletteVisualStudio2022LightBase
{
    #region Static Fields

    private static readonly Color _tabRowBackgroundColor = Color.FromArgb(208, 215, 229);
    ...
    static PaletteVisualStudio2017Blue()
    {
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PaletteVisualStudio2017Blue"/> class.
    /// </summary>
    public PaletteVisualStudio2017Blue()
        : base(
            new PaletteVisualStudio2017Blue_BaseScheme(),
            _checkBoxList,
            _galleryButtonList,
            _radioButtonArray)
    {
        ThemeName = nameof(PaletteVisualStudio2017Blue);
    }

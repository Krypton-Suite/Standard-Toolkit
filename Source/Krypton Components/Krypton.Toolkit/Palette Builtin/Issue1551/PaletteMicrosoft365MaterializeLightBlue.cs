...
/// <summary>
/// Provides the light Materialize Light Blue color scheme variant of the Microsoft 365 palette.
/// </summary>
/// <remarks>
/// Reuses the Microsoft 365 White chrome (control box glyphs, radio buttons, check boxes, integrated
/// toolbar images) while replacing the button/panel/header/form accent colours with Materialize Light Blue via
/// <see cref="MaterializeSchemeHelper"/>.
/// </remarks>
public class PaletteMicrosoft365MaterializeLightBlue : PaletteMicrosoft365Base
{
    ...
    static PaletteMicrosoft365MaterializeLightBlue()
    {
        ...
        MaterializeSchemeHelper.RegisterButtonStateColors<PaletteMicrosoft365MaterializeLightBlue>(MaterializeAccentKind.LightBlue, dark: false);
    }

    /// <summary>
    /// Initialize a new instance of the PaletteMicrosoft365MaterializeLightBlue class.
    /// </summary>
    public PaletteMicrosoft365MaterializeLightBlue() : base(
        MaterializeSchemeHelper.Create(new PaletteMicrosoft365White_BaseScheme(), MaterializeAccentKind.LightBlue, false),
        _checkBoxList,
        _galleryButtonList,
        _radioButtonArray) =>
        ThemeName = "Microsoft 365 - Materialize Light Blue";

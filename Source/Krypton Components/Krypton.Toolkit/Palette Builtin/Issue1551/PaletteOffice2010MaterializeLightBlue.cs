...
/// <summary>
/// Provides the light Materialize Light Blue color scheme variant of the Office 2010 palette.
/// </summary>
/// <remarks>
/// Reuses the Office 2010 Blue chrome (control box glyphs, radio buttons, check boxes, ribbon tab row
/// gradient/rafting) while replacing the button/panel/header/form accent colours with Materialize Light Blue via
/// <see cref="MaterializeSchemeHelper"/>.
/// </remarks>
public class PaletteOffice2010MaterializeLightBlue : PaletteOffice2010Base
{
    ...
    #region Identity
    static PaletteOffice2010MaterializeLightBlue()
    {
        ...
        MaterializeSchemeHelper.RegisterButtonStateColors<PaletteOffice2010MaterializeLightBlue>(MaterializeAccentKind.LightBlue, dark: false);
    }

    /// <summary>
    /// Initialize a new instance of the PaletteOffice2010MaterializeLightBlue class.
    /// </summary>
    public PaletteOffice2010MaterializeLightBlue()
        : base(
        MaterializeSchemeHelper.Create(new PaletteOffice2010Blue_BaseScheme(), MaterializeAccentKind.LightBlue, false),
        _checkBoxList,
        _galleryButtonList,
        _radioButtonArray) =>
        ThemeName = "Office 2010 - Materialize Light Blue";

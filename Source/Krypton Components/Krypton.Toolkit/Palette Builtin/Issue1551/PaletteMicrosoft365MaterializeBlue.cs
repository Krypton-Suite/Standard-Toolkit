...
/// <summary>
/// Provides the light Materialize Blue color scheme variant of the Microsoft 365 palette.
/// </summary>
/// <remarks>
/// Reuses the Microsoft 365 White chrome (control box glyphs, radio buttons, check boxes, integrated
/// toolbar images) while replacing the button/panel/header/form accent colours with Materialize Blue via
/// <see cref="MaterializeSchemeHelper"/>.
/// </remarks>
public class PaletteMicrosoft365MaterializeBlue : PaletteMicrosoft365Base
{
    ...
    static PaletteMicrosoft365MaterializeBlue()
    {
        ...
        MaterializeSchemeHelper.RegisterButtonStateColors<PaletteMicrosoft365MaterializeBlue>(MaterializeAccentKind.Blue, dark: false);
    }

    /// <summary>
    /// Initialize a new instance of the PaletteMicrosoft365MaterializeBlue class.
    /// </summary>
    public PaletteMicrosoft365MaterializeBlue() : base(
        MaterializeSchemeHelper.Create(new PaletteMicrosoft365White_BaseScheme(), MaterializeAccentKind.Blue, false),
        _checkBoxList,
        _galleryButtonList,
        _radioButtonArray) =>
        ThemeName = "Microsoft 365 - Materialize Blue";

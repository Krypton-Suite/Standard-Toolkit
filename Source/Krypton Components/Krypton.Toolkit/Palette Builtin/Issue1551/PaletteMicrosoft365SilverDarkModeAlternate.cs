...
/// <summary>
/// Provides the dark Silver (Dark Mode - Alternate) color scheme variant of the Microsoft 365 palette.
/// </summary>
/// <remarks>
...
/// accent colours with the dark-mode Silver (Dark Mode - Alternate) accents via <see cref="MaterializeSchemeHelper"/>.
/// </remarks>
public class PaletteMicrosoft365SilverDarkModeAlternate : PaletteMicrosoft365Base
{
    ...
    static PaletteMicrosoft365SilverDarkModeAlternate()
    {
        ...
        MaterializeSchemeHelper.RegisterButtonStateColors<PaletteMicrosoft365SilverDarkModeAlternate>(MaterializeAccentKind.SilverDarkAlternate, dark: true);
    }

    /// <summary>
    /// Initializes a new instance of the <see cref="PaletteMicrosoft365SilverDarkModeAlternate"/> class.
    /// </summary>
    public PaletteMicrosoft365SilverDarkModeAlternate() : base(
        MaterializeSchemeHelper.Create(new PaletteMicrosoft365SilverDarkMode_BaseScheme(), MaterializeAccentKind.SilverDarkAlternate, true),
        _checkBoxList,
        _galleryButtonList,
        _radioButtonArray) =>
        ThemeName = "Microsoft 365 - Silver (Dark Mode - Alternate)";

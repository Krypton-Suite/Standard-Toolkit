...
/// <summary>
/// Material Light Materialize Light Blue palette — flat Material metrics/renderer with Materialize Light Blue accents.
/// </summary>
public class PaletteMaterialMaterializeLightBlue : PaletteMaterialBase
{
    ...
    static PaletteMaterialMaterializeLightBlue()
    {
        ...
        var scheme = MaterializeSchemeHelper.Create(new PaletteMaterialLight_BaseScheme(), MaterializeAccentKind.LightBlue, dark: false);
        ...
        MaterializeSchemeHelper.RegisterButtonStateColors<PaletteMaterialMaterializeLightBlue>(MaterializeAccentKind.LightBlue, dark: false);
    }

    /// <summary>
    /// Initialize a new instance of the <see cref="PaletteMaterialMaterializeLightBlue"/> class.
    /// </summary>
    public PaletteMaterialMaterializeLightBlue()
        : base(
            MaterializeSchemeHelper.Create(new PaletteMaterialLight_BaseScheme(), MaterializeAccentKind.LightBlue, dark: false),
            _checkBoxList,
            _galleryButtonList,
            _radioButtonArray)
    {
        ThemeName = "Material - Materialize Light Blue";
    }

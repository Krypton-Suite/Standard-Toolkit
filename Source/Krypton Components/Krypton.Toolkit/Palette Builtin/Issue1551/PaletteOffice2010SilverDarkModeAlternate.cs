...
/// <summary>
/// Provides the dark Silver (Dark Mode - Alternate) color scheme variant of the Office 2010 palette.
/// </summary>
/// <remarks>
...
/// Silver (Dark Mode - Alternate) accents via <see cref="MaterializeSchemeHelper"/>.
/// </remarks>
public class PaletteOffice2010SilverDarkModeAlternate : PaletteOffice2010Base
{
    ...
    #region Identity
    static PaletteOffice2010SilverDarkModeAlternate()
    {
        ...
        MaterializeSchemeHelper.RegisterButtonStateColors<PaletteOffice2010SilverDarkModeAlternate>(MaterializeAccentKind.SilverDarkAlternate, dark: true);
    }

    /// <summary>
    /// Initialize a new instance of the PaletteOffice2010SilverDarkModeAlternate class.
    /// </summary>
    public PaletteOffice2010SilverDarkModeAlternate()
        : base(
        MaterializeSchemeHelper.Create(new PaletteOffice2010SilverDarkMode_BaseScheme(), MaterializeAccentKind.SilverDarkAlternate, true),
        _checkBoxList,
        _galleryButtonList,
        _radioButtonArray) =>
        ThemeName = "Office 2010 - Silver (Dark Mode - Alternate)";

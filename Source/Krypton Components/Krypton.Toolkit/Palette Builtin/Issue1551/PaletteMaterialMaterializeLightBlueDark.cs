...
/// <summary>
/// Material Dark Materialize Light Blue - Dark Mode palette — flat Material metrics/renderer with Materialize Light Blue - Dark Mode accents on dark olive chrome.
/// </summary>
public class PaletteMaterialMaterializeLightBlueDark : PaletteMaterialBase
{
    ...
    static PaletteMaterialMaterializeLightBlueDark()
    {
        ...
        var scheme = MaterializeSchemeHelper.Create(new PaletteMaterialDark_BaseScheme(), MaterializeAccentKind.LightBlue, dark: true);
        ...
        MaterializeSchemeHelper.RegisterButtonStateColors<PaletteMaterialMaterializeLightBlueDark>(MaterializeAccentKind.LightBlue, dark: true);
    }

    /// <summary>
    /// Initialize a new instance of the <see cref="PaletteMaterialMaterializeLightBlueDark"/> class.
    /// </summary>
    public PaletteMaterialMaterializeLightBlueDark()
        : base(
            MaterializeSchemeHelper.Create(new PaletteMaterialDark_BaseScheme(), MaterializeAccentKind.LightBlue, dark: true),
            _checkBoxList,
            _galleryButtonList,
            _radioButtonArray)
    {
        ThemeName = "Material - Materialize Light Blue - Dark Mode";
    }
    ...
    public override Color GetBackColor1(PaletteBackStyle style, PaletteState state) =>
        IsLimeFilledButton(style) ? MaterializeSchemeHelper.GetMaterialButtonBack(MaterializeAccentKind.LightBlue, state) : base.GetBackColor1(style, state);

    /// <inheritdoc />
    public override Color GetBackColor2(PaletteBackStyle style, PaletteState state) =>
        IsLimeFilledButton(style) ? MaterializeSchemeHelper.GetMaterialButtonBack(MaterializeAccentKind.LightBlue, state) : base.GetBackColor2(style, state);

    /// <inheritdoc />
    public override Color GetBorderColor1(PaletteBorderStyle style, PaletteState state) =>
        IsLimeFilledButtonBorder(style) ? MaterializeSchemeHelper.GetMaterialButtonBorder(MaterializeAccentKind.LightBlue, state) : base.GetBorderColor1(style, state);

    /// <inheritdoc />
    public override Color GetBorderColor2(PaletteBorderStyle style, PaletteState state) =>
        IsLimeFilledButtonBorder(style) ? MaterializeSchemeHelper.GetMaterialButtonBorder(MaterializeAccentKind.LightBlue, state) : base.GetBorderColor2(style, state);

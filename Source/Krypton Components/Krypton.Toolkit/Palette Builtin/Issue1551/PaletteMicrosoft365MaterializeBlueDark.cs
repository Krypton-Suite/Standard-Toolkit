...
/// <summary>
/// Provides the dark Materialize Blue - Dark Mode color scheme variant of the Microsoft 365 palette.
/// </summary>
/// <remarks>
...
/// accent colours with the dark-mode Materialize Blue - Dark Mode accents via <see cref="MaterializeSchemeHelper"/>.
/// </remarks>
public class PaletteMicrosoft365MaterializeBlueDark : PaletteMicrosoft365Base
{
    ...
    static PaletteMicrosoft365MaterializeBlueDark()
    {
        ...
        MaterializeSchemeHelper.RegisterButtonStateColors<PaletteMicrosoft365MaterializeBlueDark>(MaterializeAccentKind.Blue, dark: true);
    }

    /// <summary>
    /// Initializes a new instance of the <see cref="PaletteMicrosoft365MaterializeBlueDark"/> class.
    /// </summary>
    public PaletteMicrosoft365MaterializeBlueDark() : base(
        MaterializeSchemeHelper.Create(new PaletteMicrosoft365BlackDarkMode_BaseScheme(), MaterializeAccentKind.Blue, true),
        _checkBoxList,
        _galleryButtonList,
        _radioButtonArray) =>
        ThemeName = "Microsoft 365 - Materialize Blue - Dark Mode";

...
/// <summary>
/// Provides the dark Materialize Blue - Dark Mode color scheme variant of the Office 2010 palette.
/// </summary>
/// <remarks>
...
/// Materialize Blue - Dark Mode accents via <see cref="MaterializeSchemeHelper"/>.
/// </remarks>
public class PaletteOffice2010MaterializeBlueDark : PaletteOffice2010Base
{
    ...
    #region Identity
    static PaletteOffice2010MaterializeBlueDark()
    {
        ...
        MaterializeSchemeHelper.RegisterButtonStateColors<PaletteOffice2010MaterializeBlueDark>(MaterializeAccentKind.Blue, dark: true);
    }

    /// <summary>
    /// Initialize a new instance of the PaletteOffice2010MaterializeBlueDark class.
    /// </summary>
    public PaletteOffice2010MaterializeBlueDark()
        : base(
        MaterializeSchemeHelper.Create(new PaletteOffice2010BlueDarkMode_BaseScheme(), MaterializeAccentKind.Blue, true),
        _checkBoxList,
        _galleryButtonList,
        _radioButtonArray) =>
        ThemeName = "Office 2010 - Materialize Blue - Dark Mode";

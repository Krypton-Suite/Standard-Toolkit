...
/// </summary>
public class PaletteOffice2013SilverDarkModeAlternate : PaletteOffice2013Base
{
    ...
    #region Identity
    static PaletteOffice2013SilverDarkModeAlternate()
    {
        MaterializeSchemeHelper.RegisterButtonStateColors<PaletteOffice2013SilverDarkModeAlternate>(MaterializeAccentKind.SilverDarkAlternate, dark: true);
    ...
    /// <summary>
    /// Initialize a new instance of the PaletteOffice2013SilverDarkModeAlternate class.
    /// </summary>
    public PaletteOffice2013SilverDarkModeAlternate()
        : base(
        MaterializeSchemeHelper.Create(new PaletteOffice2013DarkGray_BaseScheme(), MaterializeAccentKind.SilverDarkAlternate, true),
        _checkBoxList,
        _galleryButtonList,
        _radioButtonArray)
    {
        ThemeName = "Office 2013 - Silver (Dark Mode - Alternate)";
    }
    #endregion

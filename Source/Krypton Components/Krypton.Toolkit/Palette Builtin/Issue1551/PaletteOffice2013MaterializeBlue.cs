...
/// </summary>
public class PaletteOffice2013MaterializeBlue : PaletteOffice2013WhiteBase
{
    ...
    static PaletteOffice2013MaterializeBlue()
    {
        MaterializeSchemeHelper.RegisterButtonStateColors<PaletteOffice2013MaterializeBlue>(MaterializeAccentKind.Blue, dark: false);
    ...
    /// </summary>
    public PaletteOffice2013MaterializeBlue()
        : base(
        MaterializeSchemeHelper.Create(new PaletteOffice2013White_BaseScheme(), MaterializeAccentKind.Blue, false),
        _checkBoxList,
        _galleryButtonList,
        _radioButtonArray)
    {
        ThemeName = "Office 2013 - Materialize Blue";
    }

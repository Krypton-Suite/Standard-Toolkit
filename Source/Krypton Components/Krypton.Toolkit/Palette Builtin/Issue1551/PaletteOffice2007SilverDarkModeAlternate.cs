...
/// <summary>
/// Provides the dark Silver (Dark Mode - Alternate) color scheme variant of the Office 2007 palette.
/// </summary>
/// <remarks>
...
/// Green accents via <see cref="MaterializeSchemeHelper"/>.
/// </remarks>
public class PaletteOffice2007SilverDarkModeAlternate : PaletteOffice2007Base
{
    ...
    #region Identity
    static PaletteOffice2007SilverDarkModeAlternate()
    {
        ...
        MaterializeSchemeHelper.RegisterButtonStateColors<PaletteOffice2007SilverDarkModeAlternate>(MaterializeAccentKind.SilverDarkAlternate, dark: true);
    }

    /// <summary>
    /// Initialize a new instance of the PaletteOffice2007SilverDarkModeAlternate class.
    /// </summary>
    public PaletteOffice2007SilverDarkModeAlternate()
        : base(
        "Office 2007 - Silver (Dark Mode - Alternate)",
        MaterializeSchemeHelper.Create(new PaletteOffice2007SilverDarkMode_BaseScheme(), MaterializeAccentKind.SilverDarkAlternate, true),
        _checkBoxList,
        _galleryButtonList,
        _radioButtonArray)
    {

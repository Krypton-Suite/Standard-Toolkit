...
/// </summary>
public class PaletteOffice2013MaterializeBlueDark : PaletteOffice2013Base
{
    ...
    #region Identity
    static PaletteOffice2013MaterializeBlueDark()
    {
        MaterializeSchemeHelper.RegisterButtonStateColors<PaletteOffice2013MaterializeBlueDark>(MaterializeAccentKind.Blue, dark: true);
    ...
    /// <summary>
    /// Initialize a new instance of the PaletteOffice2013MaterializeBlueDark class.
    /// </summary>
    public PaletteOffice2013MaterializeBlueDark()
        : base(
        MaterializeSchemeHelper.Create(new PaletteOffice2013DarkGray_BaseScheme(), MaterializeAccentKind.Blue, true),
        _checkBoxList,
        _galleryButtonList,
        _radioButtonArray)
    {
        ThemeName = "Office 2013 - Materialize Blue - Dark Mode";
    }
    #endregion

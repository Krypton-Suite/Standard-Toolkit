...
/// <summary>
/// Provides the dark Materialize Light Blue - Dark Mode color scheme variant of the Microsoft 365 palette.
/// </summary>
/// <remarks>
/// Reuses the Microsoft 365 Black Dark Mode chrome (control box glyphs, radio buttons, check boxes,
/// pendant/ribbon glyphs, integrated toolbar images) while replacing the button/panel/header/form
/// accent colours with the dark-mode Materialize Light Blue - Dark Mode accents via <see cref="MaterializeSchemeHelper"/>.
/// </remarks>
public class PaletteMicrosoft365MaterializeLightBlueDark : PaletteMicrosoft365Base
{
    ...
    static PaletteMicrosoft365MaterializeLightBlueDark()
    {
        ...
        MaterializeSchemeHelper.RegisterButtonStateColors<PaletteMicrosoft365MaterializeLightBlueDark>(MaterializeAccentKind.LightBlue, dark: true);
    }

    /// <summary>
    /// Initializes a new instance of the <see cref="PaletteMicrosoft365MaterializeLightBlueDark"/> class.
    /// </summary>
    public PaletteMicrosoft365MaterializeLightBlueDark() : base(
        MaterializeSchemeHelper.Create(new PaletteMicrosoft365BlackDarkMode_BaseScheme(), MaterializeAccentKind.LightBlue, true),
        _checkBoxList,
        _galleryButtonList,
        _radioButtonArray) =>
        ThemeName = "Microsoft 365 - Materialize Light Blue - Dark Mode";

...
namespace Krypton.Toolkit
{
    ...
    #region Class: PaletteOffice365BlueThemeLightModeBase
    ...
    public abstract class PaletteOffice365BlueThemeLightModeBase : PaletteBase
    {
        ...
        protected PaletteOffice365BlueThemeLightModeBase(Color[] schemeColours, ImageList checkBoxList, ImageList galleryButtonList, Image[] radioButtonArray, Color[] trackBarColours)
        {

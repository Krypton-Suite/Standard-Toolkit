...
{
    public class PaletteOffice365Access : PaletteOffice365Base
    {
        ...
        /// </summary>
        public PaletteOffice365Access() : base(_schemeOfficeColors, _checkBoxList, _galleryButtonList, _radioButtonArray, _trackBarColors)
        {

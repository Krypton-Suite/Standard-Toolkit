...
namespace Krypton.Toolkit
{
    ...
    public class PaletteOffice365BlackDarkMode : PaletteOffice365BlackThemeDarkModeBase
    {
        ...
        private static readonly Color[] _schemeOfficeColors = {             Color.White,             // TextLabelControl - Why is this used for  context menu normal & tracking text?
                                                                      ...
                                                                      Color.FromArgb(38, 38, 38),    // InputControlBackDisabled
                                                                      Color.FromArgb(192, 192, 192),    // InputControlBackInactive
                                                                      Color.FromArgb(99, 99, 99),       // InputDropDownNormal1
                                                                      Color.FromArgb(61, 61, 61),       // InputDropDownNormal2
    ...
    #region Classes: PaletteOffice365BlackThemeDarkModeBase
    ...
    public abstract class PaletteOffice365BlackThemeDarkModeBase : PaletteBase
    {
        ...
        protected PaletteOffice365BlackThemeDarkModeBase(Color[] schemeColours, ImageList checkBoxList, ImageList galleryButtonList, Image[] radioButtonArray, Color[] trackBarColours)
        {

...
namespace Krypton.Toolkit
{
    ...
    public class PaletteOffice365BlueDarkMode : PaletteOffice365BlueThemeDarkModeBase
    {
        ...
        /// </summary>
        public PaletteOffice365BlueDarkMode() : base(_schemeOfficeColors, _checkBoxList, _galleryButtonList, _radioButtonArray, _trackBarColors)
        {
    ...
    public abstract class PaletteOffice365BlueThemeDarkModeBase : PaletteBase
    {
        ...
        protected PaletteOffice365BlueThemeDarkModeBase(Color[] schemeColours, ImageList checkBoxList, ImageList galleryButtonList, Image[] radioButtonArray, Color[] trackBarColours)
        {

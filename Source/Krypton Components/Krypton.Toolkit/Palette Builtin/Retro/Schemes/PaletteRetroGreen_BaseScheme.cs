...
public class PaletteRetroGreen_BaseScheme : KryptonColorSchemeBase
{
    ...
    public override Color RibbonQATMini4                   { get; set; } = SharedStaticVariables.EMPTY_COLOR;
    public override Color RibbonQATMini5                   { get; set; } = SharedStaticVariables.EMPTY_COLOR;
    ...
    public override Color RibbonQATMini4I                  { get; set; } = SharedStaticVariables.EMPTY_COLOR;
    public override Color RibbonQATMini5I                  { get; set; } = SharedStaticVariables.EMPTY_COLOR;

...
public class PaletteSparkleOrange : PaletteSparkleBase
{
    ...
    [
        ...
        Color.FromArgb(219, 217,
            210), // ButtonClusterButtonBack1                                                      
        Color.FromArgb(223, 222,
            214), // ButtonClusterButtonBack2                                                      
        Color.FromArgb(191, 188,
            179), // ButtonClusterButtonBorder1                                                      
        Color.FromArgb(159, 156,
            145), // ButtonClusterButtonBorder2                                                      
    ...
    {
        ThemeName = nameof(PaletteSparkleOrange);
    }
    #endregion
}
...
public abstract class PaletteMicrosoft365BlueLightModeBase : PaletteBase
{
    ...
    protected KryptonColorTable365BlueLightMode? Table;
            ...
            case PaletteBackStyle.TabCustom3:
                switch (state)
                {
                    ...
                    case PaletteState.Normal:
                        return style == PaletteBackStyle.TabLowProfile ? GlobalStaticValues.EMPTY_COLOR : _ribbonColours[(int)SchemeBaseColors.PanelAlternative];
        ...
        switch (style)
        {
            ...
            case PaletteBackStyle.TabCustom3:
                return state switch
                {
                    ...
                    PaletteState.Tracking or PaletteState.Pressed => style == PaletteBackStyle.TabLowProfile ? GlobalStaticValues.EMPTY_COLOR : _ribbonColours[(int)SchemeBaseColors.PanelAlternative],
    ...
    public override KryptonColorTable ColorTable =>
        Table ??= new KryptonColorTable365BlueLightMode(BaseColors.ToArray(), InheritBool.True, this);
...
#region Class: KryptonColorTable365BlueLightMode
/// <summary>
...
public class KryptonColorTable365BlueLightMode : KryptonColorTable
{
    ...
    static KryptonColorTable365BlueLightMode()
    {
    ...
    /// <summary>
    /// Initialize a new instance of the KryptonColorTable365BlueLightMode class.
    /// </summary>

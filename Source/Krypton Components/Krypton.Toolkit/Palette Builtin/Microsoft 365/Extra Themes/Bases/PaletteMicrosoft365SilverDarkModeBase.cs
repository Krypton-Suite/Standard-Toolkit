...
public abstract class PaletteMicrosoft365SilverDarkModeBase : PaletteBase
{
        ...
        switch (style)
        {
            ...
            case PaletteBackStyle.GridDataCellCustom3:
                return state == PaletteState.CheckedNormal
                    ? _ribbonColors[(int)SchemeBaseColors.GridDataCellSelected] : _ribbonColors[(int)SchemeBaseColors.PanelAlternative];

            case PaletteBackStyle.GridDataCellSheet:
                return state == PaletteState.CheckedNormal ? _buttonBackColors[6] : _ribbonColors[(int)SchemeBaseColors.PanelAlternative];
            ...
            case PaletteBackStyle.PanelClient:
                ...
                return state == PaletteState.Disabled
                    ? _disabledBack
                    : _ribbonColors[(int)SchemeBaseColors.PanelClient];
            ...
            case PaletteBackStyle.PanelAlternate:
                ...
                return state == PaletteState.Disabled
                    ? _disabledBack
                    : _ribbonColors[(int)SchemeBaseColors.PanelAlternative];
            ...
            case PaletteBackStyle.InputControlCustom3:
                return state == PaletteState.Disabled
                    ? _ribbonColors[(int)SchemeBaseColors.InputControlBackDisabled]
            ...
            case PaletteBackStyle.ButtonForm:
                return state switch
                {
                    ...
                    PaletteState.CheckedTracking => _ribbonColors[
                        (int)SchemeBaseColors.FormButtonBack1CheckTrack],
                    PaletteState.Pressed or PaletteState.CheckedPressed => _ribbonColors[
    ...
    public override Color GetBackColor2(PaletteBackStyle style, PaletteState state)
    {
        ...
        switch (style)
        {
            ...
            case PaletteBackStyle.GridDataCellCustom2:
            case PaletteBackStyle.GridDataCellCustom3:
                return state == PaletteState.CheckedNormal ? _ribbonColors[(int)SchemeBaseColors.GridDataCellSelected] : _ribbonColors[(int)SchemeBaseColors.PanelAlternative];

            case PaletteBackStyle.GridDataCellSheet:
                return state == PaletteState.CheckedNormal ? _buttonBackColors[7] : _ribbonColors[(int)SchemeBaseColors.PanelAlternative];

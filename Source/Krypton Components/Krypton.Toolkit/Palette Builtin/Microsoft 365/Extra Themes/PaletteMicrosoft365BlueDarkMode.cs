...
{
    #region Class: PaletteMicrosoft365BlueDarkMode
    public class PaletteMicrosoft365BlueDarkMode : PaletteMicrosoft365BlueDarkModeBase
    {
        ...
        [
            ...
            Color.FromArgb(134, 179, 236), // RibbonMinimizeBarDark
            Color.FromArgb(63, 122, 197), // RibbonMinimizeBarLight
        ...
        /// </summary>
        public PaletteMicrosoft365BlueDarkMode() : base(_schemeOfficeColors, _checkBoxList, _galleryButtonList, _radioButtonArray, _trackBarColors)
        {
    ...
    public abstract class PaletteMicrosoft365BlueDarkModeBase : PaletteBase
    {
        ...
        protected PaletteMicrosoft365BlueDarkModeBase([DisallowNull] Color[] schemeColours,
        ...
        public override Color GetBackColor1(PaletteBackStyle style, PaletteState state)
        {
            ...
            switch (style)
            {
                ...
                case PaletteBackStyle.PanelClient:
                    ...
                    return state == PaletteState.Disabled ? _disabledBack : _ribbonColours[(int)SchemeOfficeColors.PanelClient];
                ...
                case PaletteBackStyle.PanelAlternate:
                    // Note: Alter these to control the backgrounds
                    return state == PaletteState.Disabled ? _disabledBack : _ribbonColours[(int)SchemeOfficeColors.PanelAlternative];

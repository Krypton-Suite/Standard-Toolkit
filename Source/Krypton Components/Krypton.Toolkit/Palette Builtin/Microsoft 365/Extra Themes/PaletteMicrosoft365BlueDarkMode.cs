...
public class PaletteMicrosoft365BlueDarkMode : PaletteMicrosoft365BlueDarkModeBase
{
    ...
    /// </summary>
    public PaletteMicrosoft365BlueDarkMode() : base(_schemeBaseColors, _checkBoxList, _galleryButtonList, _radioButtonArray, _trackBarColors)
    {
    ...
    public override Color GetBackColor1(PaletteBackStyle style, PaletteState state)
    {
        ...
        switch (style)
        {
            ...
            case PaletteBackStyle.PanelClient:
                ...
                return state == PaletteState.Disabled ? _disabledBack : _ribbonColours[(int)SchemeBaseColors.PanelClient];
            ...
            case PaletteBackStyle.PanelAlternate:
                // Note: Alter these to control the backgrounds
                return state == PaletteState.Disabled ? _disabledBack : _ribbonColours[(int)SchemeBaseColors.PanelAlternative];

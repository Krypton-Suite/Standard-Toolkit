...
public class PaletteMicrosoft365BlueLightMode : PaletteMicrosoft365BlueLightModeBase
{
    ...
    [
        ...
        Color.FromArgb(230, 239, 249), // RibbonMinimizeBarLight
    ...
    /// </summary>
    public PaletteMicrosoft365BlueLightMode() : base(_schemeBaseColors, _checkBoxList, _galleryButtonList, _radioButtonArray, _trackBarColors)
    {
...
public abstract class PaletteMicrosoft365BlueLightModeBase : PaletteBase
{
    ...
    public override KryptonColorTable ColorTable
    {
        get
        {
            _table ??= new KryptonColorTable365BlueLightMode(_ribbonColours, InheritBool.True, this);

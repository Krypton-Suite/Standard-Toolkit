            ...
            case PaletteBackStyle.TabCustom3:
                switch (state)
                {
                    ...
                    case PaletteState.Normal:
                        return style == PaletteBackStyle.TabLowProfile ? GlobalStaticValues.EMPTY_COLOR : _ribbonColours[(int)SchemeOfficeColors.PanelAlternative];
        ...
        switch (style)
        {
            ...
            case PaletteBackStyle.TabCustom3:
                return state switch
                {
                    ...
                    PaletteState.Tracking or PaletteState.Pressed => style == PaletteBackStyle.TabLowProfile ? GlobalStaticValues.EMPTY_COLOR : _ribbonColours[(int)SchemeOfficeColors.PanelAlternative],

...
public class PaletteMicrosoft365BlueLightMode : PaletteMicrosoft365BlueLightModeBase
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PaletteMicrosoft365BlueLightMode"/> class.
    /// </summary>
    public PaletteMicrosoft365BlueLightMode() : base(
        new PaletteMicrosoft365BlueLightMode_BaseScheme(),
        _checkBoxList,
        _galleryButtonList,
        _radioButtonArray)
    {

...
namespace Krypton.Toolkit
{
    ...
    public class PaletteOffice2007BlueDarkMode : PaletteOffice2007BlueDarkModeBase
    {
        ...
        [
            ...
            Color.FromArgb(63, 122, 197),    // RibbonGroupsArea4
            Color.FromArgb(134, 179, 236),    // RibbonGroupsArea5
    ...
    public abstract class PaletteOffice2007BlueDarkModeBase : PaletteBase
    {
        ...
        protected PaletteOffice2007BlueDarkModeBase([DisallowNull] Color[] schemeColors,
                                     ...
                                     Color[] trackBarColors)
        {
            ...
            ThemeName = nameof(PaletteOffice2007BlueDarkModeBase);
...
: _ribbonColours[(int)SchemeOfficeColors.InputDropDownDisabled2],
        ...
        /// </summary>
        public override KryptonColorTable ColorTable => _table ??= new KryptonColorTable2007BlueDarkMode(_ribbonColours, InheritBool.True, this);
    ...
    public class KryptonColorTable2007BlueDarkMode : KryptonColorTable
    {
        ...
        public KryptonColorTable2007BlueDarkMode([DisallowNull] Color[] colors,

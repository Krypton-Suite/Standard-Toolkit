...
{
    #region Class: PaletteOffice2007BlueDarkMode
    /// <summary>
    ...
    #region Class: PaletteOffice2007BlueDarkModeBase
    /// <summary>
    ...
    public abstract class PaletteOffice2007BlueDarkModeBase : PaletteBase
    {
        ...
        private static readonly Color _contextMenuInnerBack = Color.FromArgb(134, 179, 236);
        ...
        protected PaletteOffice2007BlueDarkModeBase(Color[] schemeColors,
...
: _ribbonColors[(int)SchemeOfficeColors.InputDropDownDisabled2],
        ...
        /// </summary>
        public override KryptonColorTable ColorTable => _table ??= new KryptonColorTable2007BlueDarkMode(_ribbonColors, InheritBool.True, this);
    ...
    #region Class: KryptonColorTable2007BlueDarkMode
    /// <summary>
    /// Provide KryptonColorTable2007BlueDarkMode values using an array of Color values as the source.
    /// </summary>
    public class KryptonColorTable2007BlueDarkMode : KryptonColorTable
    {
        #region Static Fields
        ...
        #region Identity
        static KryptonColorTable2007BlueDarkMode()
        {
            // Get the font settings from the system
            DefineFonts();

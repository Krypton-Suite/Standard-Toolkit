...
namespace Krypton.Toolkit
{
    ...
    public abstract class PaletteOffice2007SilverLightModeBase : PaletteBase
    {
        ...
        protected PaletteOffice2007SilverLightModeBase([DisallowNull] Color[] schemeColors,
...
: _ribbonColours[(int)SchemeOfficeColors.InputDropDownDisabled2],
        ...
        /// </summary>
        public override KryptonColorTable ColorTable => _table ??= new KryptonColorTable2007SilverLightMode(_ribbonColours, InheritBool.True, this);
    ...
    public class KryptonColorTable2007SilverLightMode : KryptonColorTable
    {
        ...
        #region Identity
        static KryptonColorTable2007SilverLightMode()
        {
            // Get the font settings from the system
            DefineFonts();

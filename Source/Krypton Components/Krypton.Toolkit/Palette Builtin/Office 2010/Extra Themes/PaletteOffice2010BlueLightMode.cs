...
#region Class: PaletteOffice2010BlueLightMode
/// <summary>
...
#region Class: PaletteOffice2010BlueLightModeBase
/// <summary>
...
public abstract class PaletteOffice2010BlueLightModeBase : PaletteBase
{
    ...
    public override Color GetBorderColor1(PaletteBorderStyle style, PaletteState state)
    {
        ...
        return style switch
        {
            ...
            {
                PaletteState.Disabled => style == PaletteBorderStyle.ButtonGallery ? _ribbonColours[(int)SchemeBaseColors.RibbonGalleryBack2] : _buttonBorderColors[0],
                PaletteState.Normal => _ribbonColours[(int)SchemeBaseColors.ButtonNormalBorder],
    ...
    /// </summary>
    public override KryptonColorTable ColorTable => _table ??= new KryptonColorTable2010BlueLightMode(_ribbonColours, InheritBool.True, this);
...
#region Class: KryptonColorTable2010BlueLightMode
/// <summary>
...
public class KryptonColorTable2010BlueLightMode : KryptonColorTable
{
    ...
    #region Identity
    static KryptonColorTable2010BlueLightMode()
    {
        // Get the font settings from the system
        DefineFonts();

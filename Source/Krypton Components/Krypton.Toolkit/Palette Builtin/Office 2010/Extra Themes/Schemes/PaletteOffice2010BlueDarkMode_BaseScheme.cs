...
public sealed class PaletteOffice2010BlueDarkMode_BaseScheme : KryptonColorSchemeBase
{
    ...
    public override Color ButtonNavigatorText              { get; set; } = Color.FromArgb(0, 21, 110);

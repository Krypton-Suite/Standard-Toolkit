        ...
        switch (style)
        {
            ...
            case PaletteBackStyle.ButtonNavigatorMini:
                return state switch
                {
                    ...
                    PaletteState.CheckedNormal or PaletteState.CheckedTracking or PaletteState.CheckedPressed => Color.FromArgb(73, 73, 73), // ToDo: Find out why this is a problem... _ribbonColors[(int)SchemeBaseColors.ButtonNavigatorChecked2],

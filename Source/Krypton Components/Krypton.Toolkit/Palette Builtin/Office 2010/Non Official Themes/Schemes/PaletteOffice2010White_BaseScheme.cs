...
public sealed class PaletteOffice2010White_BaseScheme : KryptonColorSchemeBase
{
    ...
    public override Color StatusStripLight                 { get; set; } = Color.FromArgb(0 , 114, 198);
    public override Color StatusStripDark                  { get; set; } = Color.FromArgb(0 , 114, 198);
    public override Color ImageMargin                      { get; set; } = Color.White;
    public override Color ToolStripBegin                   { get; set; } = Color.FromArgb(255, 255, 255);
    public override Color ToolStripMiddle                  { get; set; } = Color.FromArgb(255, 255, 255);
    public override Color ToolStripEnd                     { get; set; } = Color.FromArgb(255, 255, 255);
    ...
    public override Color RibbonGroupDialogDark            { get; set; } = Color.FromArgb(180, 180, 180);
    public override Color RibbonGroupDialogLight           { get; set; } = Color.FromArgb(102, 102, 102);
    ...
    public override Color RibbonMinimizeBarLight           { get; set; } = Color.FromArgb(205, 209, 214);
    ...
    public override Color RibbonQATFullbar1                { get; set; } = Color.White;
    public override Color RibbonQATFullbar2                { get; set; } = Color.White;
    public override Color RibbonQATFullbar3                { get; set; } = Color.FromArgb(212, 212, 212);
    public override Color RibbonQATButtonDark              { get; set; } = Color.FromArgb(134, 139, 145);
    ...
    public override Color RibbonGroupTitleText             { get; set; } = Color.FromArgb(90, 90, 90);

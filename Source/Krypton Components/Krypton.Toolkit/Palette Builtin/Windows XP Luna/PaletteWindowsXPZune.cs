...
/// </summary>
public class PaletteWindowsXPZune : PaletteWindowsXPLunaBase
{
    /// <summary>
    /// Initialize a new instance of the <see cref="PaletteWindowsXPZune"/> class.
    /// </summary>
    public PaletteWindowsXPZune()
        : base(
            @"Windows XP - Zune",
            new PaletteWindowsXPZune_BaseScheme(),
    ...
    {
        ThemeName = nameof(PaletteWindowsXPZune);
    }
}

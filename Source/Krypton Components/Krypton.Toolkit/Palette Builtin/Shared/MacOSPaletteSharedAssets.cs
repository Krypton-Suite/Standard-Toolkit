...
/// <summary>
/// Traffic-light form button images for macOS-style palettes (Aqua, Mac light/dark).
/// </summary>
internal static class MacOSPaletteSharedAssets
{
    ...
    private static TrafficLightSet CreateSet(bool isDarkSurface) => new TrafficLightSet(isDarkSurface, FormButtonSize);

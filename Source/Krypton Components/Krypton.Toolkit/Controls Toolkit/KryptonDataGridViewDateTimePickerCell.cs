...
public class KryptonDataGridViewDateTimePickerCell : DataGridViewTextBoxCell
{
    ...
    {
        var dateTimeCell = base.Clone() as KryptonDataGridViewDateTimePickerCell ?? throw new NullReferenceException(SharedStaticFunctions.VariableCannotBeNull("dateTimeCell"));
    ...
    private KryptonDataGridViewDateTimePickerEditingControl EditingDateTimePicker =>
        DataGridView!.EditingControl as KryptonDataGridViewDateTimePickerEditingControl ?? throw new NullReferenceException(SharedStaticFunctions.VariableCannotBeNull(nameof(DataGridView.EditingControl)));

...
{
    /// <summary>Public API to display the <see cref="VisualKryptonMultilineStringEditorForm"/>.</summary>
    public class KryptonMultilineStringEditor
    {
        #region Public

        /// <summary>Shows a new <see cref="VisualKryptonMultilineStringEditorForm"/> with default options.</summary>
        /// <returns>A new <see cref="VisualKryptonMultilineStringEditorForm"/> with default data.</returns>
        public static DialogResult Show() => ShowCore(null, null, null, null, null);

        /// <summary>Shows a new <see cref="VisualKryptonMultilineStringEditorForm"/> with specified options.</summary>
        /// <param name="contents">The string contents array.</param>
        /// <returns>A new <see cref="VisualKryptonMultilineStringEditorForm"/> with specified data.</returns>
        ...
        {
            using var kmse = new VisualKryptonMultilineStringEditorForm(contents, collection, useRichTextBox, headerText, windowTitle);

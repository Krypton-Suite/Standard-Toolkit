...
/// <summary>A <see cref="KryptonCommand"/> for the <see cref="PaletteButtonSpecStyle.Save"/> button spec.</summary>
[Category(@"code")]
[ToolboxItem(false)]
...
{
    [DefaultValue(null)]
    [Description(@"Access to the save button spec.")]
    [AllowNull]
    ...
    public KryptonIntegratedToolbarSaveCommand()
        : base(KryptonCommandType.IntegratedToolBarSaveCommand)
    {
    }
}

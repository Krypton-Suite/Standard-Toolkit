...
{
    /// <summary>A <see cref="KryptonCommand"/> created specifically for the <see cref="PaletteButtonSpecStyle.Save"/> button spec.</summary>
    [Category(@"code")]
    [ToolboxItem(false)]
    ...
    public class KryptonIntegratedToolbarSaveCommand : KryptonCommand
    {
        ...
        private ButtonSpecAny? _saveButtonSpec;
        ...
        /// <summary>Initializes a new instance of the <see cref="KryptonIntegratedToolbarSaveCommand" /> class.</summary>
        public KryptonIntegratedToolbarSaveCommand()
        {
            _imageStates = new ButtonImageStates();

            Text = KryptonManager.Strings.IntegratedToolBarStrings.Save;
        }
        ...
        private void UpdateActiveImage(Image activeImage)
        {
            ...
            if (_saveButtonSpec != null)
            {
                _saveButtonSpec.ImageStates.ImageTracking = _activeImage;
            }
        }

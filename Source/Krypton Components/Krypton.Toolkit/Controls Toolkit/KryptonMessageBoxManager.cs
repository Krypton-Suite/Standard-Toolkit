...
namespace Krypton.Toolkit
{
    ...
    public class KryptonMessageBoxManager : Component
    {
        ...
        [DefaultValue(GlobalStaticValues.CORNER_ROUNDING_VALUE), Description("Defines the corner radius of the KryptonMessageBox.")]
        ...
        public KryptonMessageBoxManager()
        {
            ...
            _cornerRadius = GlobalStaticValues.CORNER_ROUNDING_VALUE;

...
namespace Krypton.Toolkit
{
    ...
    public class KryptonSystemMenu : IKryptonSystemMenu, IDisposable
    {
            ...
            if (insertBeforeClose && _itemsGroup.Items.Count > 0)
            {
                ...
                for (int i = _itemsGroup.Items.Count - 1; i >= 0; i--)
                {
                    if (_itemsGroup.Items[i] is KryptonContextMenuItem menuItem)
                    {
                        ...
                        if (itemText.Equals(KryptonLanguageManager.Win32SystemMenuStrings.Close, StringComparison.OrdinalIgnoreCase) ||
                            itemText.Replace("&", "").Equals(KryptonLanguageManager.Win32SystemMenuStrings.Close.Replace("&", ""), StringComparison.OrdinalIgnoreCase))
                        {
        ...
        public List<string> GetCustomMenuItems()
        {
            ...
            {
                KryptonLanguageManager.Win32SystemMenuStrings.Restore,
                KryptonLanguageManager.Win32SystemMenuStrings.Move,
                KryptonLanguageManager.Win32SystemMenuStrings.Size,
                KryptonLanguageManager.Win32SystemMenuStrings.Minimize,
                KryptonLanguageManager.Win32SystemMenuStrings.Maximize,
                KryptonLanguageManager.Win32SystemMenuStrings.Close
            };
            ...
            if (_form is KryptonForm kryptonForm)
            {
                ...
                foreach (var item in _itemsGroup.Items)
                {
                    if (item is KryptonContextMenuItem menuItem)
                    {
                        ...
                        if (menuText.Equals(KryptonLanguageManager.Win32SystemMenuStrings.Restore, StringComparison.OrdinalIgnoreCase) ||
                            menuText.Replace("&", "").Equals(KryptonLanguageManager.Win32SystemMenuStrings.Restore.Replace("&", ""), StringComparison.OrdinalIgnoreCase))
                        {
                            menuItem.Enabled = (windowState != FormWindowState.Normal);
                        }
                        else if (menuText.Equals(KryptonLanguageManager.Win32SystemMenuStrings.Minimize, StringComparison.OrdinalIgnoreCase) ||
                                 menuText.Replace("&", "").Equals(KryptonLanguageManager.Win32SystemMenuStrings.Minimize.Replace("&", ""), StringComparison.OrdinalIgnoreCase))
                        {
                        ...
                        else if (menuText.Equals(KryptonLanguageManager.Win32SystemMenuStrings.Maximize, StringComparison.OrdinalIgnoreCase) ||
                                 menuText.Replace("&", "").Equals(KryptonLanguageManager.Win32SystemMenuStrings.Maximize.Replace("&", ""), StringComparison.OrdinalIgnoreCase))
                        {
                        ...
                        else if (menuText.Equals(KryptonLanguageManager.Win32SystemMenuStrings.Move, StringComparison.OrdinalIgnoreCase) ||
                                 menuText.Replace("&", "").Equals(KryptonLanguageManager.Win32SystemMenuStrings.Move.Replace("&", ""), StringComparison.OrdinalIgnoreCase))
                        {
                        ...
                        else if (menuText.Equals(KryptonLanguageManager.Win32SystemMenuStrings.Size, StringComparison.OrdinalIgnoreCase) ||
                                 menuText.Replace("&", "").Equals(KryptonLanguageManager.Win32SystemMenuStrings.Size.Replace("&", ""), StringComparison.OrdinalIgnoreCase))
                        {
        ...
        private SystemMenuIconType? GetIconTypeFromText(string text)
        {
            ...
            if (normalizedText.StartsWith(KryptonLanguageManager.Win32SystemMenuStrings.Restore.ToLower()))
            {
                return SystemMenuIconType.Restore;
            }

            if (normalizedText.StartsWith(KryptonLanguageManager.Win32SystemMenuStrings.Minimize.ToLower()))
            {
                return SystemMenuIconType.Minimize;
            }

            if (normalizedText.StartsWith(KryptonLanguageManager.Win32SystemMenuStrings.Maximize.ToLower()))
            {
                return SystemMenuIconType.Maximize;
            }

            if (normalizedText.StartsWith(KryptonLanguageManager.Win32SystemMenuStrings.Close.ToLower()))
            {
                return SystemMenuIconType.Close;
            }

            if (normalizedText.StartsWith(KryptonLanguageManager.Win32SystemMenuStrings.Move.ToLower()))
            {
                return SystemMenuIconType.Move;
            }

            if (normalizedText.StartsWith(KryptonLanguageManager.Win32SystemMenuStrings.Size.ToLower()))
            {
        ...
        private void CreateBasicMenuItems()
        {
            ...
            {
                var restoreItem = new KryptonContextMenuItem(KryptonLanguageManager.Win32SystemMenuStrings.Restore);
            ...
            {
                var moveItem = new KryptonContextMenuItem(KryptonLanguageManager.Win32SystemMenuStrings.Move);
                // Move doesn't typically have an icon in Windows
                moveItem.Click += (sender, e) => ExecuteMove();
                _itemsGroup.Items.Add(moveItem);

                var sizeItem = new KryptonContextMenuItem(KryptonLanguageManager.Win32SystemMenuStrings.Size);
            ...
            var minimizeItem = new KryptonContextMenuItem(KryptonLanguageManager.Win32SystemMenuStrings.Minimize);
            ...
            var maximizeItem = new KryptonContextMenuItem(KryptonLanguageManager.Win32SystemMenuStrings.Maximize);
            ...
            if (_form.ControlBox)
            {
                var closeItem = new KryptonContextMenuItem($"{KryptonLanguageManager.Win32SystemMenuStrings.Close}\tAlt+F4");

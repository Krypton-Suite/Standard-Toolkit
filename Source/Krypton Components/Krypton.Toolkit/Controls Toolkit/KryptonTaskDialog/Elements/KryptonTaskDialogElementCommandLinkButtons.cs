 ...
 * Modifications by Peter Wagner (aka Wagnerp), Simon Coghlan (aka Smurf-IV), Giduac, Ahmed Abdelhameed, tobitege,  KamaniAR, Lesandro Gotardo (aka lesandrog), Jorge A. Avil̩s (aka mcpbcs) et al. 2025 - 2026. All rights reserved.
 *
 */
#endregion

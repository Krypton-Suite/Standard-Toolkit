...
namespace Krypton.Toolkit
{
    ...
    public sealed class KryptonManager : Component
    {
        ...
        private bool ShouldSerializeGlobalPalette() => InternalGlobalPalette is { IsDefault: false };

        private void ResetGlobalPalette() => InternalGlobalPalette = null;
        ...
        /// <summary>Gets or sets the custom palette manager.</summary>
        /// <value>The custom palette manager.</value>
        [Category(@"Visuals")]
        [Description(@"Specifies a custom palette manager.")]
        [DefaultValue(null)]

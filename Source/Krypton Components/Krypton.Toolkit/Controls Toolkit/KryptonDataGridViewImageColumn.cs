...
public class KryptonDataGridViewImageColumn : DataGridViewImageColumn, IIconCell
{
    ...
    {
        var cloned =base.Clone() as KryptonDataGridViewImageColumn ?? ThrowHelper.ThrowNullReferenceException<KryptonDataGridViewImageColumn>(SharedStaticFunctions.VariableCannotBeNull("cloned"));

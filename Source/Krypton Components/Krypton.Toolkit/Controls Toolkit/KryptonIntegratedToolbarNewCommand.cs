...
namespace Krypton.Toolkit
{
    ...
    public class KryptonIntegratedToolbarNewCommand : KryptonCommand
    {
        ...
        private ButtonSpecAny? _newButtonSpec;
        ...
        public KryptonIntegratedToolbarNewCommand()
        {
            ...
            Text = KryptonManager.Strings.IntegratedToolBarStrings.New;
        }
        ...
        private void UpdateActiveImage(Image activeImage)
        {
            ...
            if (_newButtonSpec != null)
            {
                _newButtonSpec.ImageStates.ImageTracking = _activeImage;
            }
        }
        ...
        private void UpdateActiveImage(PaletteMode mode)
        {
            switch (mode)
            {
                case PaletteMode.Global:
                    break;
                case PaletteMode.ProfessionalSystem:
                    UpdateActiveImage(GenericToolbarImageResources.GenericNewDocument);
                    break;
                case PaletteMode.ProfessionalOffice2003:
            ...
            if (_newButtonSpec != null)
            {
                switch (mode)
                {
                    case PaletteMode.Global:
                        break;
                    case PaletteMode.ProfessionalSystem:
                        AddImageStates(null, SystemToolbarImageResources.SystemToolbarNewDisabled, SystemToolbarImageResources.SystemToolbarNewNormal, null);
                        break;
                    case PaletteMode.ProfessionalOffice2003:

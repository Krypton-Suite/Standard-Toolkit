...
public class KryptonDataGridViewDomainUpDownColumn : KryptonDataGridViewIconColumn
{
    ...
    {
        var cloned = base.Clone() as KryptonDataGridViewDomainUpDownColumn ?? throw new NullReferenceException(SharedStaticFunctions.VariableCannotBeNull("cloned"));
    ...
    /// </summary>
    private KryptonDataGridViewDomainUpDownCell DomainUpDownCellTemplate => CellTemplate as KryptonDataGridViewDomainUpDownCell ?? throw new NullReferenceException(SharedStaticFunctions.VariableCannotBeNull(nameof(CellTemplate)));
    #endregion

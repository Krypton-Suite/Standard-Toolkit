    ...
    IContentValues
{
    ...
    public KryptonForm()
    {
        ...
        // Add internal panel for control hosting
        if (!base.Controls.Contains(_internalKryptonPanel))
        {
...
#pragma warning restore CS0618
    ...
    public new void ResumeLayout(bool performLayout)
    {
            ...
            && _internalPanelState == InheritBool.False)
        {
            ...
            {
                // DESIGN MODE COMPATIBILITY: Only add internal panel at runtime
    ...
    public new Control.ControlCollection Controls
    {
        get
        {
            // Always use internal panel for control hosting
    ...
    [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
    public override IKryptonSystemMenu? KryptonSystemMenu => 
        IsInDesignMode() || IsNetProject() 
            ? null 
            : _systemMenuService?.SystemMenu;

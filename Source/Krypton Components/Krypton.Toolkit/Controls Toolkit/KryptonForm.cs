    ...
    IContentValues
{
    ...
    //private KryptonSystemMenuService? _kryptonSystemMenuService;
    ...
    public KryptonForm()
    {
        ...
        // ToDo: 'KRYPTONSYSTEMMENU' Needs to be looked at again!
        ...
        if (LicenseManager.UsageMode != LicenseUsageMode.Designtime)
        {
            ...
            _kryptonSystemMenuService = new KryptonSystemMenuService(this);
            ...
            SystemMenuService = _kryptonSystemMenuService;

            // Synchronize the values with the themed system menu service
            //_kryptonSystemMenuService.ShowSystemMenuOnLeftClick = _systemMenuValues.ShowOnLeftClick;
            _kryptonSystemMenuService.ShowSystemMenuOnRightClick = _systemMenuValues.ShowOnRightClick;
            _kryptonSystemMenuService.ShowSystemMenuOnAltSpace = _systemMenuValues.ShowOnAltSpace;
...
#pragma warning restore CS0618
    ...
    protected override void Dispose(bool disposing)
    {
        if (disposing)
        {
            ...
            _kryptonSystemMenuService?.Dispose();*/
    ...
    public new bool MinimizeBox 
    {
        ...
        set
        {
            if (base.MinimizeBox != value)
            {
                ...
                _kryptonSystemMenuService?.SystemMenu?.Refresh();*/
            }
        }
    }
    ...
    [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
    public override IKryptonSystemMenu? KryptonSystemMenu => IsInDesignMode() ? null : _kryptonSystemMenuService?.SystemMenu;
    ...
    /// 
    /// <para><strong>Why This Method Exists:</strong></para>
    /// <para>Without this method, the system menu would interfere with designer drag and drop operations, 
    /// preventing controls from being dragged from toolbox to form and causing intermittent behavior.</para>
    /// 
    /// <para><strong>Detection Strategy (in order of reliability):</strong></para>
    /// <para>1. LicenseManager.UsageMode (PRIMARY) - Available immediately during constructor execution</para>
    /// <para>2. Site?.DesignMode (SECONDARY) - Standard .NET approach, available after control is sited</para>
    /// <para>3. Container Component Check (FALLBACK) - Handles edge cases where direct detection fails</para>
    /// 
    /// <para><strong>Performance:</strong> Uses short-circuit evaluation, typical execution ~0.001-0.002ms, 
    /// zero allocation in 95% of cases.</para>
    /// 
    ...
    protected override void WndProc(ref Message m)
    {
        ...
        /*else if (m.Msg == PI.WM_.NCRBUTTONDOWN)
        {
            ...
            if (!IsInDesignMode() && ControlBox && _systemMenuValues.Enabled &&
                _systemMenuValues.ShowOnRightClick && _kryptonSystemMenuService != null &&
                _kryptonSystemMenuService.ShowSystemMenuOnRightClick)
            {
        ...
        if (_drawContent.IsImageDisplayed(context))
        {
            ...
            if (_drawContent.ImageRectangle(context).Contains(windowPoint))
            {
                ...
                if (ControlBox && _systemMenuValues.Enabled && _systemMenuValues.ShowOnIconClick &&
                    _kryptonSystemMenuService != null)
                {
                    ShowSystemMenu(screenPoint);
                    return true;
                }*/
    ...
    {
        if (_kryptonSystemMenuService != null)
        {
            switch (e.PropertyName)
            {
                case nameof(SystemMenuValues.Enabled):
                    _kryptonSystemMenuService.UseSystemMenu = _systemMenuValues.Enabled;
                    break;
    ...
    protected override bool ProcessCmdKey(ref Message msg, Keys keyData)
    {
        ...
        if (!IsInDesignMode() && ControlBox && _systemMenuValues.Enabled && _kryptonSystemMenuService != null)
        {
            if (_kryptonSystemMenuService.HandleKeyboardShortcut(keyData))
            {
                return true;
            }
        }*/
...
#pragma warning restore CS0618 // Type or member is obsolete
    ...
    protected override void ShowSystemMenu(Point screenLocation)
    {
        ...
        if (!IsInDesignMode() && _systemMenuValues.Enabled && _kryptonSystemMenuService != null)
        {
            // Refresh the menu to ensure it reflects current form state
            _kryptonSystemMenuService.SystemMenu.Refresh();
            _kryptonSystemMenuService.SystemMenu.Show(screenLocation);
        }
    }
    ...
    protected override void ShowSystemMenuAtFormTopLeft()
    {
        ...
        if (!IsInDesignMode() && _systemMenuValues.Enabled && _kryptonSystemMenuService != null)
        {
            // Refresh the menu to ensure it reflects current form state
            _kryptonSystemMenuService.SystemMenu.Refresh();
            _kryptonSystemMenuService.SystemMenu.ShowAtFormTopLeft();
        }
    }
    ...
    protected override bool HandleSystemMenuKeyboardShortcut(Keys keyData)
    {
        ...
        if (!IsInDesignMode() && ControlBox && _systemMenuValues.Enabled && _kryptonSystemMenuService != null)
        {
            ...
            {
                return _kryptonSystemMenuService.SystemMenu.HandleKeyboardShortcut(keyData);
            }
        }
        return false;
    }*/

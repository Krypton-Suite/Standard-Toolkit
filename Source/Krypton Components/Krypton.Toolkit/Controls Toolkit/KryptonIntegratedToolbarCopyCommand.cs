...
/// <summary>A <see cref="KryptonCommand"/> for the <see cref="PaletteButtonSpecStyle.Copy"/> button spec.</summary>
[Category(@"code")]
[ToolboxItem(false)]
...
{
    [DefaultValue(null)]
    [Description(@"Access to the copy button spec.")]
    [AllowNull]
    ...
    public KryptonIntegratedToolbarCopyCommand()
        : base(KryptonCommandType.IntegratedToolBarCopyCommand)
    {
    }
}

...
#pragma warning restore IDE0066 // Convert switch statement to expression
        ...
        switch (style)
        {
            ...
            case PaletteBackStyle.ButtonCustom3:
                return state switch
                {
                    ...
                    PaletteState.Normal => style == PaletteBackStyle.ButtonNavigatorStack
                        ? _sparkleColors[2]
                        : _sparkleColors[5],
                    PaletteState.NormalDefaultOverride => SharedStaticVariables.EMPTY_COLOR,
            ...
            case PaletteBackStyle.TabCustom3:
                return state switch
                {
                    ...
                    PaletteState.Normal => style == PaletteBackStyle.TabLowProfile ? SharedStaticVariables.EMPTY_COLOR : _colorWhite220,
                    PaletteState.Pressed or PaletteState.Tracking => style == PaletteBackStyle.TabLowProfile ? SharedStaticVariables.EMPTY_COLOR : _colorWhite220,
        ...
        switch (style)
        {
            ...
            case PaletteBackStyle.TabCustom3:
                return state switch
                {
                    PaletteState.Disabled => style == PaletteBackStyle.TabLowProfile ? SharedStaticVariables.EMPTY_COLOR : _disabledBack,
                    PaletteState.Normal => style == PaletteBackStyle.TabLowProfile ? SharedStaticVariables.EMPTY_COLOR : _colorWhite220,
                    PaletteState.Tracking or PaletteState.Pressed => style == PaletteBackStyle.TabLowProfile ? SharedStaticVariables.EMPTY_COLOR : _colorWhite238,
    ...
    public override Color GetElementColor5(PaletteElement element, PaletteState state)
    {
        ...
        {
            case PaletteElement.TrackBarTick:
                return CommonHelper.IsOverrideState(state) ? SharedStaticVariables.EMPTY_COLOR : BaseColors!.TrackBarTickMarks;

            case PaletteElement.TrackBarTrack:
                return CommonHelper.IsOverrideState(state) ? SharedStaticVariables.EMPTY_COLOR : BaseColors!.TrackBarFillTrack;

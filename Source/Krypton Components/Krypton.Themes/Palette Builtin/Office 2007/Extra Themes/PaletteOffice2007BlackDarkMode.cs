...
public class PaletteOffice2007BlackDarkMode : PaletteOffice2007BlackDarkModeBase
{
    ...
    public PaletteOffice2007BlackDarkMode()
        : base(
        new PaletteOffice2007BlackDarkMode_BaseScheme(),
        _checkBoxList,
        _galleryButtonList,
        _radioButtonArray)
    {
...
public abstract class PaletteOffice2007BlackDarkModeBase : PaletteBase
{
    ...
    static PaletteOffice2007BlackDarkModeBase()
    {
...
public class KryptonColorTable2007BlackDarkMode : KryptonColorTable
{
    ...
    public KryptonColorTable2007BlackDarkMode([DisallowNull] Color[] colors,
        ...
        palette)
    {
        ...
        Colors = colors ?? ThrowHelper.ThrowArgumentNullException(colors);
    ...
    /// </summary>
    public override Color MenuItemText => Colors.Resolve(SchemeBaseColors.MenuItemText, SchemeBaseColors.TextLabelPanel);
    ...
    /// </summary>
    public override Color ToolStripText => Colors.Resolve(SchemeBaseColors.ToolStripText, SchemeBaseColors.TextLabelPanel);

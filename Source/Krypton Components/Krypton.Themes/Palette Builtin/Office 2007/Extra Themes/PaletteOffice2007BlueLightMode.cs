...
public class PaletteOffice2007BlueLightMode : PaletteOffice2007BlueLightModeBase
{
    ...
    public PaletteOffice2007BlueLightMode()
        : base(
        new PaletteOffice2007BlueLightMode_BaseScheme(),
        _checkBoxList,
        _galleryButtonList,
        _radioButtonArray)
    {
...
public abstract class PaletteOffice2007BlueLightModeBase : PaletteBase
{
    ...
    static PaletteOffice2007BlueLightModeBase()
    {
        ...
        RegisterColor<ButtonBackColor>(ButtonBackColor.Color4, Color.FromArgb(168, 200, 234));
        RegisterColor<ButtonBackColor>(ButtonBackColor.Color5, Color.FromArgb(209, 226, 244));
        RegisterColor<ButtonBackColor>(ButtonBackColor.Color6, Color.FromArgb(188, 213, 239));
        RegisterColor<ButtonBackColor>(ButtonBackColor.Color7, Color.FromArgb(189, 213, 233));
        RegisterColor<ButtonBackColor>(ButtonBackColor.Color8, Color.FromArgb(188, 213, 239));
        RegisterColor<ButtonBackColor>(ButtonBackColor.Color9, Color.FromArgb(209, 226, 244));
        RegisterColor<ButtonBackColor>(ButtonBackColor.Color10, Color.FromArgb(210, 226, 244));

        RegisterColor<ButtonBorderColor>(ButtonBorderColor.Color1, Color.FromArgb(212, 212, 212));
        RegisterColor<ButtonBorderColor>(ButtonBorderColor.Color2, Color.FromArgb(168, 200, 234));
        RegisterColor<ButtonBorderColor>(ButtonBorderColor.Color3, Color.FromArgb(170, 210, 245));
        RegisterColor<ButtonBorderColor>(ButtonBorderColor.Color4, Color.FromArgb(155, 205, 230));
    ...
    public override Color GetBackColor1(PaletteBackStyle style, PaletteState state)
    {
        ...
        switch (style)
        {
            ...
            case PaletteBackStyle.GridDataCellSheet:
                return state == PaletteState.CheckedNormal ? GetArrayColor<ButtonBackColor>(ButtonBackColor.Color7) : BaseColors!.PanelAlternative;
                    ...
                    case PaletteState.CheckedTracking:
                        if (style == PaletteBackStyle.TabHighProfile)
                        {
                            return state switch
                            {
                                ...
                                PaletteState.CheckedPressed => GetArrayColor<ButtonBackColor>(ButtonBackColor.Color5),
                                _ => GetArrayColor<ButtonBackColor>(ButtonBackColor.Color9)
                            };
                        }
                        else
                        {
            ...
            case PaletteBackStyle.HeaderDockActive:
                return state == PaletteState.Disabled ? _disabledBack : GetArrayColor<ButtonBackColor>(ButtonBackColor.Color7);
            ...
            case PaletteBackStyle.ButtonGallery:
                ...
                {
                    PaletteState.Disabled => _disabledBack,
                    PaletteState.Normal or PaletteState.NormalDefaultOverride or PaletteState.CheckedNormal => BaseColors!.RibbonGalleryBack1,
                    PaletteState.Tracking or PaletteState.CheckedTracking => GetArrayColor<ButtonBackColor>(ButtonBackColor.Color3),
            ...
            case PaletteBackStyle.ContextMenuItemHighlight:
                return state switch
                {
                    ...
                    {
                        PaletteBackStyle.ButtonNavigatorStack => BaseColors!.ButtonNormalNavigatorBack1,
                        PaletteBackStyle.ButtonNavigatorMini => BaseColors!.NavigatorMiniBackColor,
                        PaletteBackStyle.ButtonCluster => BaseColors!.ButtonClusterButtonBack1,
                        _ => BaseColors!.ButtonNormalBack1
                    },
                    PaletteState.NormalDefaultOverride => BaseColors!.ButtonNormalDefaultBack1,
                    PaletteState.CheckedNormal => style == PaletteBackStyle.ButtonInputControl ? BaseColors!.ButtonNormalBack1 : GetArrayColor<ButtonBackColor>(ButtonBackColor.Color7),
                    PaletteState.Tracking => GetArrayColor<ButtonBackColor>(ButtonBackColor.Color3),
                    PaletteState.Pressed or PaletteState.CheckedPressed => style == PaletteBackStyle.ButtonAlternate
                        ? BaseColors!.AlternatePressedBack1
                        : GetArrayColor<ButtonBackColor>(ButtonBackColor.Color5),
                    PaletteState.CheckedTracking => style == PaletteBackStyle.ButtonInputControl ? BaseColors!.ButtonNormalBack1 : GetArrayColor<ButtonBackColor>(ButtonBackColor.Color9),
                    _ => throw DebugTools.NotImplemented(state.ToString())
                };
            default:
    ...
    public override Color GetBackColor2(PaletteBackStyle style, PaletteState state)
    {
        ...
        switch (style)
        {
            ...
            case PaletteBackStyle.GridDataCellSheet:
                return state == PaletteState.CheckedNormal ? GetArrayColor<ButtonBackColor>(ButtonBackColor.Color8) : BaseColors!.PanelAlternative;
            ...
            case PaletteBackStyle.TabDockAutoHidden:
                ...
                {
                    PaletteState.Disabled => _disabledBack,
                    PaletteState.Normal or PaletteState.CheckedNormal => BaseColors!.ButtonNormalBack2,
                    PaletteState.Tracking or PaletteState.CheckedTracking or PaletteState.Pressed or PaletteState.CheckedPressed => GetArrayColor<ButtonBackColor>(ButtonBackColor.Color4),
                    _ => throw DebugTools.NotImplemented(state.ToString())
                };
            case PaletteBackStyle.HeaderForm:
                return state == PaletteState.Disabled
            ...
            case PaletteBackStyle.HeaderDockActive:
                return state == PaletteState.Disabled ? _disabledBack : GetArrayColor<ButtonBackColor>(ButtonBackColor.Color8);
            ...
            case PaletteBackStyle.ContextMenuSeparator:
            case PaletteBackStyle.ContextMenuItemSplit:
                return state == PaletteState.Tracking ? GetArrayColor<ButtonBackColor>(ButtonBackColor.Color4) : _contextMenuOuterBack;
            case PaletteBackStyle.ContextMenuInner:
                return _contextMenuInnerBack;
            case PaletteBackStyle.ContextMenuHeading:
                return BaseColors!.ContextMenuHeadingBack;
            ...
            case PaletteBackStyle.ButtonGallery:
                return state switch
                {
                    ...
                    PaletteState.Normal or PaletteState.NormalDefaultOverride or PaletteState.CheckedNormal => BaseColors!.RibbonGalleryBack2,
                    PaletteState.Tracking or PaletteState.CheckedTracking => GetArrayColor<ButtonBackColor>(ButtonBackColor.Color3),
                    PaletteState.Pressed or PaletteState.CheckedPressed => GetArrayColor<ButtonBackColor>(ButtonBackColor.Color5),
                    _ => throw DebugTools.NotImplemented(state.ToString())
                };
            ...
            case PaletteBackStyle.ContextMenuItemHighlight:
                return state switch
                {
                    PaletteState.Disabled => GetArrayColor<ButtonBackColor>(ButtonBackColor.Color2),
                    PaletteState.Normal => style switch
                    {
                        PaletteBackStyle.ButtonNavigatorStack => BaseColors!.ButtonNormalNavigatorBack2,
                        PaletteBackStyle.ButtonNavigatorMini => BaseColors!.NavigatorMiniBackColor,
                        PaletteBackStyle.ButtonCluster => BaseColors!.ButtonClusterButtonBack2,
                        _ => BaseColors!.ButtonNormalBack2
                    },
                    PaletteState.NormalDefaultOverride => style switch
                    {
                        PaletteBackStyle.ButtonLowProfile or PaletteBackStyle.ButtonBreadCrumb or PaletteBackStyle.ButtonListItem or PaletteBackStyle.ButtonCommand or PaletteBackStyle.ButtonButtonSpec or PaletteBackStyle.ContextMenuItemHighlight => SharedStaticVariables.EMPTY_COLOR,
                        _ => BaseColors!.ButtonNormalDefaultBack2
                    },
                    PaletteState.CheckedNormal => style == PaletteBackStyle.ButtonInputControl ? BaseColors!.ButtonNormalBack2 : GetArrayColor<ButtonBackColor>(ButtonBackColor.Color8),
                    PaletteState.Tracking => GetArrayColor<ButtonBackColor>(ButtonBackColor.Color4),
                    PaletteState.Pressed or PaletteState.CheckedPressed => style == PaletteBackStyle.ButtonAlternate
                        ? BaseColors!.AlternatePressedBack2
                        : GetArrayColor<ButtonBackColor>(ButtonBackColor.Color6),
                    PaletteState.CheckedTracking => style == PaletteBackStyle.ButtonInputControl ? BaseColors!.ButtonNormalBack1 : GetArrayColor<ButtonBackColor>(ButtonBackColor.Color10),
                    _ => throw DebugTools.NotImplemented(state.ToString())
                };
            default:
                throw DebugTools.NotImplemented(style.ToString());
    ...
    public override PaletteRectangleAlign GetBackColorAlign(PaletteBackStyle style, PaletteState state)
    {
        ...
        return style switch
        {
            ...
            _ => ThrowHelper.ThrowArgumentOutOfRangeException<PaletteRectangleAlign>(nameof(style))
        };
    }
    ...
    public override float GetBackColorAngle(PaletteBackStyle style, PaletteState state)
    {
        ...
        return style switch
        {
            ...
            _ => ThrowHelper.ThrowArgumentOutOfRangeException<float>(nameof(style))
        };
    }
    ...
    public override Image? GetBackImage(PaletteBackStyle style, PaletteState state)
    {
        ...
        return style switch
        {
            ...
            _ => ThrowHelper.ThrowArgumentOutOfRangeException<Image>(nameof(style))
        };
    }
    ...
    public override PaletteImageStyle GetBackImageStyle(PaletteBackStyle style, PaletteState state)
    {
        ...
        return style switch
        {
            ...
            _ => ThrowHelper.ThrowArgumentOutOfRangeException<PaletteImageStyle>(nameof(style))
        };
    }
    ...
    public override InheritBool GetBorderDraw(PaletteBorderStyle style, PaletteState state)
    {
        ...
        return style switch
        {
            ...
            _ => ThrowHelper.ThrowArgumentOutOfRangeException<InheritBool>(nameof(style))
        };
    }
    ...
    public override PaletteDrawBorders GetBorderDrawBorders(PaletteBorderStyle style, PaletteState state)
    {
        ...
        return style switch
        {
            ...
            _ => ThrowHelper.ThrowArgumentOutOfRangeException<PaletteDrawBorders>(nameof(style))
        };
    }
    ...
    public override Color GetBorderColor1(PaletteBorderStyle style, PaletteState state)
    {
        ...
        return style switch
        {
            ...
            {
                PaletteState.Disabled => style == PaletteBorderStyle.TabLowProfile ? SharedStaticVariables.EMPTY_COLOR : _disabledBorder,
                PaletteState.Normal or PaletteState.Tracking or PaletteState.Pressed => style == PaletteBorderStyle.TabLowProfile ? SharedStaticVariables.EMPTY_COLOR : BaseColors!.ButtonNormalBorder,
            ...
            PaletteBorderStyle.ControlRibbon => state == PaletteState.Disabled ? _disabledBorder : BaseColors!.RibbonGroupsArea5,
            ...
            {
                PaletteState.Disabled => _disabledBorder,
                PaletteState.Normal or PaletteState.NormalDefaultOverride or PaletteState.CheckedNormal => BaseColors!.RibbonGalleryBorder,
                PaletteState.Tracking or PaletteState.CheckedTracking => GetArrayColor<ButtonBorderColor>(ButtonBorderColor.Color2),
            ...
            PaletteBorderStyle.ButtonStandalone or PaletteBorderStyle.ButtonAlternate or PaletteBorderStyle.ButtonLowProfile or PaletteBorderStyle.ButtonBreadCrumb or PaletteBorderStyle.ButtonListItem or PaletteBorderStyle.ButtonCommand or PaletteBorderStyle.ButtonButtonSpec or PaletteBorderStyle.ButtonCluster or PaletteBorderStyle.ButtonNavigatorStack or PaletteBorderStyle.ButtonNavigatorOverflow or PaletteBorderStyle.ButtonNavigatorMini or PaletteBorderStyle.ButtonCustom1 or PaletteBorderStyle.ButtonCustom2 or PaletteBorderStyle.ButtonCustom3 or PaletteBorderStyle.ButtonInputControl or PaletteBorderStyle.ContextMenuItemHighlight => state switch
            {
                ...
                PaletteState.Normal => style == PaletteBorderStyle.ButtonCluster
                    ? BaseColors!.ButtonClusterButtonBorder1
                    : BaseColors!.ButtonNormalBorder,
                ...
                PaletteState.Pressed or PaletteState.CheckedPressed => style == PaletteBorderStyle.ButtonAlternate
                    ? BaseColors!.AlternatePressedBorder1
                    : GetArrayColor<ButtonBorderColor>(ButtonBorderColor.Color4),
            ...
            _ => ThrowHelper.ThrowArgumentOutOfRangeException<Color>(nameof(style))
        };
    }
    ...
    public override Color GetBorderColor2(PaletteBorderStyle style, PaletteState state)
    {
        ...
        return style switch
        {
            ...
            PaletteBorderStyle.ButtonStandalone or PaletteBorderStyle.ButtonAlternate or PaletteBorderStyle.ButtonLowProfile or PaletteBorderStyle.ButtonBreadCrumb or PaletteBorderStyle.ButtonListItem or PaletteBorderStyle.ButtonCommand or PaletteBorderStyle.ButtonButtonSpec or PaletteBorderStyle.ButtonCluster or PaletteBorderStyle.ButtonNavigatorStack or PaletteBorderStyle.ButtonNavigatorOverflow or PaletteBorderStyle.ButtonNavigatorMini or PaletteBorderStyle.ButtonCustom1 or PaletteBorderStyle.ButtonCustom2 or PaletteBorderStyle.ButtonCustom3 or PaletteBorderStyle.ButtonInputControl or PaletteBorderStyle.ContextMenuItemHighlight => state switch
            {
                PaletteState.Disabled => GetArrayColor<ButtonBorderColor>(ButtonBorderColor.Color1),
                PaletteState.Normal => style == PaletteBorderStyle.ButtonCluster
                    ? BaseColors!.ButtonClusterButtonBorder2
                    : BaseColors!.ButtonNormalBorder,
                ...
                PaletteState.Tracking => GetArrayColor<ButtonBorderColor>(ButtonBorderColor.Color3),
                PaletteState.Pressed or PaletteState.CheckedPressed => style == PaletteBorderStyle.ButtonAlternate
                    ? BaseColors!.AlternatePressedBorder2
                    : GetArrayColor<ButtonBorderColor>(ButtonBorderColor.Color5),
    ...
    public override int GetBorderWidth(PaletteBorderStyle style, PaletteState state)
    {
        ...
        return style switch
        {
            ...
            _ => ThrowHelper.ThrowArgumentOutOfRangeException<int>(nameof(style))
        };
    }
    ...
    public override PaletteRelativeAlign GetContentImageH(PaletteContentStyle style, PaletteState state)
    {
        ...
        return style switch
        {
            ...
            _ => ThrowHelper.ThrowArgumentOutOfRangeException<PaletteRelativeAlign>(nameof(style))
        };
    }
    ...
    public override PaletteImageEffect GetContentImageEffect(PaletteContentStyle style, PaletteState state)
    {
        ...
        return style switch
        {
            ...
            _ => ThrowHelper.ThrowArgumentOutOfRangeException<PaletteImageEffect>(nameof(style))
        };
    }
    ...
    public override Color GetContentImageColorMap(PaletteContentStyle style, PaletteState state)
    {
        ...
        return style switch
        {
            PaletteContentStyle.HeaderPrimary or PaletteContentStyle.HeaderDockInactive or PaletteContentStyle.HeaderDockActive or PaletteContentStyle.HeaderCalendar or PaletteContentStyle.HeaderSecondary or PaletteContentStyle.HeaderForm or PaletteContentStyle.HeaderCustom1 or PaletteContentStyle.HeaderCustom2 or PaletteContentStyle.HeaderCustom3 or PaletteContentStyle.LabelAlternateControl or PaletteContentStyle.LabelNormalControl or PaletteContentStyle.LabelBoldControl or PaletteContentStyle.LabelItalicControl or PaletteContentStyle.LabelTitleControl or PaletteContentStyle.LabelAlternatePanel or PaletteContentStyle.LabelNormalPanel or PaletteContentStyle.LabelBoldPanel or PaletteContentStyle.LabelItalicPanel or PaletteContentStyle.LabelTitlePanel or PaletteContentStyle.LabelGroupBoxCaption or PaletteContentStyle.LabelToolTip or PaletteContentStyle.LabelSuperTip or PaletteContentStyle.LabelKeyTip or PaletteContentStyle.LabelCustom1 or PaletteContentStyle.LabelCustom2 or PaletteContentStyle.LabelCustom3 or PaletteContentStyle.ContextMenuHeading or PaletteContentStyle.ContextMenuItemImage or PaletteContentStyle.ContextMenuItemTextStandard or PaletteContentStyle.ContextMenuItemTextAlternate or PaletteContentStyle.ContextMenuItemShortcutText or PaletteContentStyle.InputControlStandalone or PaletteContentStyle.InputControlRibbon or PaletteContentStyle.InputControlCustom1 or PaletteContentStyle.InputControlCustom2 or PaletteContentStyle.InputControlCustom3 or PaletteContentStyle.TabHighProfile or PaletteContentStyle.TabStandardProfile or PaletteContentStyle.TabLowProfile or PaletteContentStyle.TabOneNote or PaletteContentStyle.TabDock or PaletteContentStyle.TabDockAutoHidden or PaletteContentStyle.TabCustom1 or PaletteContentStyle.TabCustom2 or PaletteContentStyle.TabCustom3 or PaletteContentStyle.ButtonStandalone or PaletteContentStyle.ButtonGallery or PaletteContentStyle.ButtonAlternate or PaletteContentStyle.ButtonLowProfile or PaletteContentStyle.ButtonBreadCrumb or PaletteContentStyle.ButtonListItem or PaletteContentStyle.ButtonCommand or PaletteContentStyle.ButtonButtonSpec or PaletteContentStyle.ButtonCalendarDay or PaletteContentStyle.ButtonCluster or PaletteContentStyle.ButtonNavigatorStack or PaletteContentStyle.ButtonNavigatorOverflow or PaletteContentStyle.ButtonNavigatorMini or PaletteContentStyle.ButtonForm or PaletteContentStyle.ButtonFormClose or PaletteContentStyle.ButtonCustom1 or PaletteContentStyle.ButtonCustom2 or PaletteContentStyle.ButtonCustom3 or PaletteContentStyle.ButtonInputControl or PaletteContentStyle.GridHeaderColumnList or PaletteContentStyle.GridHeaderColumnSheet or PaletteContentStyle.GridHeaderColumnCustom1 or PaletteContentStyle.GridHeaderColumnCustom2 or PaletteContentStyle.GridHeaderColumnCustom3 or PaletteContentStyle.GridHeaderRowList or PaletteContentStyle.GridHeaderRowSheet or PaletteContentStyle.GridHeaderRowCustom1 or PaletteContentStyle.GridHeaderRowCustom2 or PaletteContentStyle.GridHeaderRowCustom3 or PaletteContentStyle.GridDataCellList or PaletteContentStyle.GridDataCellSheet or PaletteContentStyle.GridDataCellCustom1 or PaletteContentStyle.GridDataCellCustom2 or PaletteContentStyle.GridDataCellCustom3 => SharedStaticVariables.EMPTY_COLOR,
            _ => ThrowHelper.ThrowArgumentOutOfRangeException<Color>(nameof(style))
        };
    }
    ...
    public override Font? GetContentShortTextFont(PaletteContentStyle style, PaletteState state)
    {
        ...
        return style switch
        {
            ...
            _ => ThrowHelper.ThrowArgumentOutOfRangeException<Font>(nameof(style))
        };
    }
    ...
    public override PaletteTextHint GetContentShortTextHint(PaletteContentStyle style, PaletteState state)
    {
        ...
        return style switch
        {
            ...
            _ => ThrowHelper.ThrowArgumentOutOfRangeException<PaletteTextHint>(nameof(style))
        };
    }
    ...
    public override PaletteTextHotkeyPrefix GetContentShortTextPrefix(PaletteContentStyle style, PaletteState state)
    {
        ...
        return style switch
        {
            ...
            _ => ThrowHelper.ThrowArgumentOutOfRangeException<PaletteTextHotkeyPrefix>(nameof(style))
        };
    }
    ...
    public override PaletteTextTrim GetContentShortTextTrim(PaletteContentStyle style, PaletteState state)
    {
        ...
        return style switch
        {
            ...
            _ => ThrowHelper.ThrowArgumentOutOfRangeException<PaletteTextTrim>(nameof(style))
        };
    }
        ...
        if (CommonHelper.IsOverrideState(state))
        {
            return style switch
            {
                PaletteContentStyle.LabelAlternateControl or PaletteContentStyle.LabelNormalControl or PaletteContentStyle.LabelBoldControl or PaletteContentStyle.LabelItalicControl or PaletteContentStyle.LabelTitleControl => state switch
                {
                    ...
                    _ => SharedStaticVariables.EMPTY_COLOR
                },
        ...
        PaletteState state)
    {
        ...
        switch (style)
        {
            ...
            default:
                return ThrowHelper.ThrowArgumentOutOfRangeException<Padding>(nameof(style));
        }
    }
    ...
    public override int GetMetricInt(KryptonForm? owningForm, PaletteState state, PaletteMetricInt metric)
    {
        switch (metric)
        {
            ...
            case PaletteMetricInt.HeaderButtonEdgeInsetFormRight:
                return ToolkitStaticConstants.HEADER_BUTTON_EDGE_INSET_FORM_RIGHT;
    ...
    /// <param name="state">Palette value should be applicable to this state.</param>
    /// <returns>Font value.</returns>
    public override Color GetRibbonContextTextColor(PaletteState state) => BaseColors!.RibbonTabTextNormal;
    ...
    public override Color GetRibbonBackColor1(PaletteRibbonBackStyle style, PaletteState state)
    {
        switch (style)
        {
            ...
            case PaletteRibbonBackStyle.RibbonGroupCollapsedBorder:
                ...
                {
                    case PaletteState.Normal:
                        return BaseColors!.RibbonGroupCollapsedBorder1;
                    case PaletteState.Tracking:
                        return BaseColors!.RibbonGroupCollapsedBorderT1;
                    case PaletteState.ContextNormal:
                        return GetArrayColor<RibbonGroupCollapsedBorder>(RibbonGroupCollapsedBorder.Color1);
                    case PaletteState.ContextTracking:
                    case PaletteState.Pressed:
                        return GetArrayColor<RibbonGroupCollapsedBorderT>(RibbonGroupCollapsedBorderT.Color1);
                    default:
                        // Should never happen!
                        Debug.Assert(false);
                        DebugTools.NotImplemented(state.ToString());
            ...
            case PaletteRibbonBackStyle.RibbonGroupCollapsedFrameBack:
                return state switch
                {
                    ...
                    _ => BaseColors!.RibbonGroupFrameInside1
                };
            case PaletteRibbonBackStyle.RibbonGroupCollapsedBack:
                switch (state)
                {
                    case PaletteState.Normal:
                        return BaseColors!.RibbonGroupCollapsedBack1;
                    case PaletteState.Tracking:
                        return BaseColors!.RibbonGroupCollapsedBackT1;
                    case PaletteState.ContextNormal:
                        return GetArrayColor<RibbonGroupCollapsedBack>(RibbonGroupCollapsedBack.Color1);
                    case PaletteState.ContextTracking:
                        return GetArrayColor<RibbonGroupCollapsedBackT>(RibbonGroupCollapsedBackT.Color1);
                    default:
                        // Should never happen!
                        Debug.Assert(false);
                        DebugTools.NotImplemented(state.ToString());
            ...
            case PaletteRibbonBackStyle.RibbonGroupNormalTitle:
                ...
                {
                    case PaletteState.Normal:
                        return BaseColors!.RibbonGroupTitle1;
                    case PaletteState.ContextNormal:
                        return BaseColors!.RibbonGroupTitleContext1;
                    case PaletteState.Tracking:
                    case PaletteState.ContextTracking:
                        return BaseColors!.RibbonGroupTitleTracking1;
                    default:
                        // Should never happen!
                        Debug.Assert(false);
                        DebugTools.NotImplemented(state.ToString());
            ...
            case PaletteRibbonBackStyle.RibbonGroupNormalBorder:
                switch (state)
                {
                    ...
                    case PaletteState.ContextNormal:
                    case PaletteState.ContextTracking:
                        return BaseColors!.RibbonGroupBorderContext1;
                    default:
                        // Should never happen!
                        Debug.Assert(false);
                        DebugTools.NotImplemented(state.ToString());
            ...
            case PaletteRibbonBackStyle.RibbonTab:
                switch (state)
                {
                    ...
                    case PaletteState.CheckedTracking:
                    case PaletteState.CheckedPressed:
                        return BaseColors!.RibbonTabHighlight1;
                    case PaletteState.ContextCheckedTracking:
                    case PaletteState.ContextCheckedNormal:
                    case PaletteState.FocusOverride:
    ...
    public override Color GetRibbonBackColor2(PaletteRibbonBackStyle style, PaletteState state)
    {
        switch (style)
        {
            ...
            case PaletteRibbonBackStyle.RibbonGroupCollapsedBorder:
                ...
                {
                    case PaletteState.Normal:
                        return BaseColors!.RibbonGroupCollapsedBorder2;
                    case PaletteState.Tracking:
                        return BaseColors!.RibbonGroupCollapsedBorderT2;
                    case PaletteState.ContextNormal:
                        return GetArrayColor<RibbonGroupCollapsedBorder>(RibbonGroupCollapsedBorder.Color2);
                    case PaletteState.ContextTracking:
                    case PaletteState.Pressed:
                        return GetArrayColor<RibbonGroupCollapsedBorderT>(RibbonGroupCollapsedBorderT.Color2);
                    default:
                        // Should never happen!
                        Debug.Assert(false);
                        DebugTools.NotImplemented(state.ToString());
            ...
            case PaletteRibbonBackStyle.RibbonGroupCollapsedFrameBack:
                return state switch
                {
                    ...
                    _ => BaseColors!.RibbonGroupFrameInside2
                };
            case PaletteRibbonBackStyle.RibbonGroupCollapsedBack:
                switch (state)
                {
                    case PaletteState.Normal:
                        return BaseColors!.RibbonGroupCollapsedBack2;
                    case PaletteState.Tracking:
                        return BaseColors!.RibbonGroupCollapsedBackT2;
                    case PaletteState.ContextNormal:
                        return GetArrayColor<RibbonGroupCollapsedBack>(RibbonGroupCollapsedBack.Color2);
                    case PaletteState.ContextTracking:
                        return GetArrayColor<RibbonGroupCollapsedBackT>(RibbonGroupCollapsedBackT.Color2);
                    default:
                        // Should never happen!
                        Debug.Assert(false);
                        DebugTools.NotImplemented(state.ToString());
            ...
            case PaletteRibbonBackStyle.RibbonGroupNormalBorder:
                switch (state)
                {
                    ...
                    case PaletteState.ContextNormal:
                    case PaletteState.ContextTracking:
                        return BaseColors!.RibbonGroupBorderContext2;
                    default:
                        // Should never happen!
                        Debug.Assert(false);
                        DebugTools.NotImplemented(state.ToString());
            ...
            case PaletteRibbonBackStyle.RibbonTab:
                switch (state)
                {
                    ...
                    case PaletteState.CheckedTracking:
                    case PaletteState.CheckedPressed:
                        return BaseColors!.RibbonTabHighlight2;
                    case PaletteState.ContextCheckedTracking:
    ...
    public override Color GetRibbonBackColor3(PaletteRibbonBackStyle style, PaletteState state)
    {
        switch (style)
        {
            ...
            case PaletteRibbonBackStyle.RibbonGroupCollapsedBorder:
                ...
                {
                    case PaletteState.Normal:
                        return BaseColors!.RibbonGroupCollapsedBorder3;
                    case PaletteState.Tracking:
                        return BaseColors!.RibbonGroupCollapsedBorderT3;
                    case PaletteState.ContextNormal:
                        return GetArrayColor<RibbonGroupCollapsedBorder>(RibbonGroupCollapsedBorder.Color3);
                    case PaletteState.ContextTracking:
                    case PaletteState.Pressed:
                        return GetArrayColor<RibbonGroupCollapsedBorderT>(RibbonGroupCollapsedBorderT.Color3);
                    default:
                        // Should never happen!
                        Debug.Assert(false);
                        DebugTools.NotImplemented(state.ToString());
            ...
            case PaletteRibbonBackStyle.RibbonGroupCollapsedFrameBack:
                return state switch
                {
                    PaletteState.ContextNormal or PaletteState.ContextTracking => SharedStaticVariables.EMPTY_COLOR,
                    _ => BaseColors!.RibbonGroupFrameInside3
                };
            case PaletteRibbonBackStyle.RibbonGroupCollapsedBack:
                switch (state)
                {
                    case PaletteState.Normal:
                        return BaseColors!.RibbonGroupCollapsedBack3;
                    case PaletteState.Tracking:
                        return BaseColors!.RibbonGroupCollapsedBackT3;
                    case PaletteState.ContextNormal:
                    case PaletteState.ContextTracking:
                        return SharedStaticVariables.EMPTY_COLOR;
                    default:
            ...
            case PaletteRibbonBackStyle.RibbonGroupArea:
                return state == PaletteState.ContextCheckedNormal ? SharedStaticVariables.EMPTY_COLOR : BaseColors!.RibbonGroupsArea3;
            ...
            case PaletteRibbonBackStyle.RibbonTab:
                switch (state)
                {
                    ...
                    case PaletteState.CheckedTracking:
                    case PaletteState.CheckedPressed:
                        return BaseColors!.RibbonTabHighlight3;
                    case PaletteState.ContextTracking:
                    case PaletteState.ContextCheckedNormal:
                    case PaletteState.ContextCheckedTracking:
                    case PaletteState.FocusOverride:
    ...
    public override Color GetRibbonBackColor4(PaletteRibbonBackStyle style, PaletteState state)
    {
        switch (style)
        {
            ...
            case PaletteRibbonBackStyle.RibbonGroupCollapsedBorder:
                ...
                {
                    case PaletteState.Normal:
                        return BaseColors!.RibbonGroupCollapsedBorder4;
                    case PaletteState.Tracking:
                        return BaseColors!.RibbonGroupCollapsedBorderT4;
                    case PaletteState.ContextNormal:
                        return GetArrayColor<RibbonGroupCollapsedBorder>(RibbonGroupCollapsedBorder.Color4);
                    case PaletteState.ContextTracking:
                    case PaletteState.Pressed:
                        return GetArrayColor<RibbonGroupCollapsedBorderT>(RibbonGroupCollapsedBorderT.Color4);
                    default:
                        // Should never happen!
                        Debug.Assert(false);
                        DebugTools.NotImplemented(state.ToString());
            ...
            case PaletteRibbonBackStyle.RibbonGroupCollapsedFrameBack:
                ...
                {
                    PaletteState.ContextNormal or PaletteState.ContextTracking => SharedStaticVariables.EMPTY_COLOR,
                    _ => BaseColors!.RibbonGroupFrameInside4
                };
            case PaletteRibbonBackStyle.RibbonGroupCollapsedBack:
                switch (state)
                {
                    case PaletteState.Normal:
                        return BaseColors!.RibbonGroupCollapsedBack4;
                    case PaletteState.Tracking:
                        return BaseColors!.RibbonGroupCollapsedBackT4;
                    case PaletteState.ContextNormal:
                    case PaletteState.ContextTracking:
                        return SharedStaticVariables.EMPTY_COLOR;
                    default:
            ...
            case PaletteRibbonBackStyle.RibbonGroupArea:
                return state == PaletteState.ContextCheckedNormal ? _lightGray : BaseColors!.RibbonGroupsArea2;
            ...
            case PaletteRibbonBackStyle.RibbonTab:
                switch (state)
                {
                    ...
                    case PaletteState.CheckedTracking:
                    case PaletteState.CheckedPressed:
                        return BaseColors!.RibbonTabHighlight4;
                    case PaletteState.ContextTracking:
                    case PaletteState.ContextCheckedNormal:
                    case PaletteState.ContextCheckedTracking:
                    case PaletteState.FocusOverride:
    ...
    public override Color GetRibbonBackColor5(PaletteRibbonBackStyle style, PaletteState state)
    {
        switch (style)
        {
            ...
            case PaletteRibbonBackStyle.RibbonGroupArea:
                return state == PaletteState.ContextCheckedNormal ? Color.White : BaseColors!.RibbonGroupsArea1;
            ...
            case PaletteRibbonBackStyle.RibbonTab:
                switch (state)
                {
                    ...
                    case PaletteState.Pressed:
                        return BaseColors!.RibbonTabTracking2;
                    case PaletteState.CheckedNormal:
                        return BaseColors!.RibbonTabSelected5;
                    case PaletteState.CheckedTracking:
                    case PaletteState.CheckedPressed:
                        return BaseColors!.RibbonTabHighlight5;
                    case PaletteState.ContextTracking:
                    case PaletteState.ContextCheckedNormal:
                    case PaletteState.ContextCheckedTracking:
                    case PaletteState.FocusOverride:
    ...
    public override Color GetElementColor1(PaletteElement element, PaletteState state)
    {
        ...
        switch (element)
        {
            ...
            case PaletteElement.TrackBarPosition:
                return state switch
                {
                    PaletteState.Disabled => SharedStaticVariables.EMPTY_COLOR,
    ...
    /// </summary>
    public override KryptonColorTable ColorTable => _table ??= new KryptonColorTable2007BlueLightMode(_ribbonColors, InheritBool.True, this);
...
public class KryptonColorTable2007BlueLightMode : KryptonColorTable
{
    ...
    /// </summary>
    public override Color ButtonPressedBorder => Colours[(int)SchemeBaseColors.ButtonBorder];
    ...
    /// </summary>
    public override Color ButtonPressedHighlightBorder => Colours[(int)SchemeBaseColors.ButtonBorder];
    ...
    /// </summary>
    public override Color ButtonSelectedBorder => Colours[(int)SchemeBaseColors.ButtonBorder];
    ...
    /// </summary>
    public override Color ButtonSelectedHighlightBorder => Colours[(int)SchemeBaseColors.ButtonBorder];
    ...
    /// </summary>
    public override Color ButtonCheckedHighlightBorder => Colours[(int)SchemeBaseColors.ButtonBorder];
    ...
    /// </summary>
    public override Color GripLight => Colours[(int)SchemeBaseColors.GripLight];
    ...
    /// </summary>
    public override Color GripDark => Colours[(int)SchemeBaseColors.GripDark];
    ...
    /// </summary>
    public override Color ImageMarginGradientBegin => Colours[(int)SchemeBaseColors.ImageMargin];
    ...
    /// </summary>
    public override Color ImageMarginGradientMiddle => Colours[(int)SchemeBaseColors.ImageMargin];
    ...
    /// </summary>
    public override Color ImageMarginGradientEnd => Colours[(int)SchemeBaseColors.ImageMargin];
    ...
    /// </summary>
    public override Color ImageMarginRevealedGradientBegin => Colours[(int)SchemeBaseColors.ImageMargin];
    ...
    /// </summary>
    public override Color ImageMarginRevealedGradientMiddle => Colours[(int)SchemeBaseColors.ImageMargin];
    ...
    /// </summary>
    public override Color ImageMarginRevealedGradientEnd => Colours[(int)SchemeBaseColors.ImageMargin];
    ...
    /// </summary>
    public override Color MenuItemSelected => Colours[(int)SchemeBaseColors.ButtonBorder];
    ...
    /// </summary>
    public override Color MenuItemPressedGradientBegin => Colours[(int)SchemeBaseColors.ToolStripBegin];
    ...
    /// </summary>
    public override Color MenuItemPressedGradientEnd => Colours[(int)SchemeBaseColors.ToolStripEnd];
    ...
    /// </summary>
    public override Color MenuItemPressedGradientMiddle => Colours[(int)SchemeBaseColors.ToolStripMiddle];
    ...
    /// </summary>
    public override Color MenuStripGradientBegin => Colours[(int)SchemeBaseColors.ToolStripBack];
    ...
    /// </summary>
    public override Color MenuStripGradientEnd => Colours[(int)SchemeBaseColors.ToolStripBack];
    ...
    /// </summary>
    public override Color OverflowButtonGradientBegin => Colours[(int)SchemeBaseColors.OverflowBegin];
    ...
    /// </summary>
    public override Color OverflowButtonGradientEnd => Colours[(int)SchemeBaseColors.OverflowEnd];
    ...
    /// </summary>
    public override Color OverflowButtonGradientMiddle => Colours[(int)SchemeBaseColors.OverflowMiddle];
    ...
    /// </summary>
    public override Color RaftingContainerGradientBegin => Colours[(int)SchemeBaseColors.ToolStripBack];
    ...
    /// </summary>
    public override Color RaftingContainerGradientEnd => Colours[(int)SchemeBaseColors.ToolStripBack];
    ...
    /// </summary>
    public override Color SeparatorLight => Colours[(int)SchemeBaseColors.SeparatorLight];
    ...
    /// </summary>
    public override Color SeparatorDark => Colours[(int)SchemeBaseColors.SeparatorDark];
    ...
    /// </summary>
    public override Color StatusStripGradientBegin => Colours[(int)SchemeBaseColors.StatusStripLight];
    ...
    /// </summary>
    public override Color StatusStripGradientEnd => Colours[(int)SchemeBaseColors.StatusStripDark];
    ...
    /// </summary>
    public override Color MenuItemText => Colours.Resolve(SchemeBaseColors.MenuItemText, SchemeBaseColors.TextButtonNormal);
    ...
    /// </summary>
    public override Color MenuStripText => Colours.Resolve(SchemeBaseColors.MenuStripText, SchemeBaseColors.TextLabelPanel);
    ...
    /// </summary>
    public override Color ToolStripText => Colours.Resolve(SchemeBaseColors.ToolStripText, SchemeBaseColors.TextButtonNormal);
    ...
    /// </summary>
    public override Color StatusStripText => Colours[(int)SchemeBaseColors.StatusStripText];
    ...
    /// </summary>
    public override Color ToolStripBorder => Colours[(int)SchemeBaseColors.ToolStripBorder];
    ...
    /// </summary>
    public override Color ToolStripContentPanelGradientBegin => Colours[(int)SchemeBaseColors.ToolStripBack];
    ...
    /// </summary>
    public override Color ToolStripContentPanelGradientEnd => Colours[(int)SchemeBaseColors.ToolStripBack];
    ...
    /// </summary>
    public override Color ToolStripGradientBegin => Colours[(int)SchemeBaseColors.ToolStripBegin];
    ...
    /// </summary>
    public override Color ToolStripGradientEnd => Colours[(int)SchemeBaseColors.ToolStripEnd];
    ...
    /// </summary>
    public override Color ToolStripGradientMiddle => Colours[(int)SchemeBaseColors.ToolStripMiddle];
    ...
    /// </summary>
    public override Color ToolStripPanelGradientBegin => Colours[(int)SchemeBaseColors.ToolStripBack];
    ...
    /// </summary>
    public override Color ToolStripPanelGradientEnd => Colours[(int)SchemeBaseColors.ToolStripBack];

...
#region Class: PaletteOffice2007SilverLightMode
/// <summary>
...
public class PaletteOffice2007SilverLightMode : PaletteOffice2007SilverLightModeBase
{
    ...
    #region Identity
    static PaletteOffice2007SilverLightMode()
    {
    ...
    public PaletteOffice2007SilverLightMode()
        : base(
        new PaletteOffice2007SilverLightMode_BaseScheme(),
        _checkBoxList,
        _galleryButtonList,
        _radioButtonArray)
    {
...
public abstract class PaletteOffice2007SilverLightModeBase : PaletteBase
{
    ...
    static PaletteOffice2007SilverLightModeBase()
    {
        ...
        RegisterColor<ButtonBackColor>(ButtonBackColor.Color3, Color.FromArgb(214, 216, 221));
        RegisterColor<ButtonBackColor>(ButtonBackColor.Color4, Color.FromArgb(194, 197, 204));
        RegisterColor<ButtonBackColor>(ButtonBackColor.Color5, Color.FromArgb(196, 198, 206));
        ...
        RegisterColor<ButtonBorderColor>(ButtonBorderColor.Color2, Color.FromArgb(232, 234, 244));
        RegisterColor<ButtonBorderColor>(ButtonBorderColor.Color3, Color.FromArgb(183, 185, 193));
        RegisterColor<ButtonBorderColor>(ButtonBorderColor.Color4, Color.FromArgb(134, 136, 142));
        RegisterColor<ButtonBorderColor>(ButtonBorderColor.Color5, Color.FromArgb(146, 148, 155));
        RegisterColor<ButtonBorderColor>(ButtonBorderColor.Color6, Color.FromArgb(121, 123, 129));
        RegisterColor<ButtonBorderColor>(ButtonBorderColor.Color7, Color.FromArgb(170, 172, 181));
    ...
    private static readonly Color _contextMenuInnerBack = Color.FromArgb(224, 225, 231);
    private static readonly Color _contextMenuOuterBack = Color.FromArgb(195, 198, 209);
        ...
        [DisallowNull] Image?[] radioButtonArray)
    {
        ...
        ThemeName = nameof(PaletteOffice2007SilverLightModeBase);
        ...
        switch (style)
        {
            ...
            case PaletteBackStyle.GridDataCellCustom3:
                return state == PaletteState.CheckedNormal
                    ? BaseColors!.GridDataCellSelected : BaseColors!.PanelAlternative;
    ...
    /// </summary>
    public override KryptonColorTable ColorTable => _table ??= new KryptonColorTable2007SilverLightMode(_ribbonColors, InheritBool.True, this);
...
#region Class: KryptonColorTable2007SilverLightMode
/// <summary>
/// Provide KryptonColorTable2007SilverLightMode values using an array of Color values as the source.
/// </summary>
public class KryptonColorTable2007SilverLightMode : KryptonColorTable
{
    #region Static Fields
    ...
    public KryptonColorTable2007SilverLightMode([DisallowNull] Color[] colors,
    ...
    /// </summary>
    public override Color MenuStripText => Colors.Resolve(SchemeBaseColors.MenuStripText, SchemeBaseColors.TextLabelPanel);

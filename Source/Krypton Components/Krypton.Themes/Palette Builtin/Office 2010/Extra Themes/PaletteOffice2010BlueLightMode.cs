...
public class PaletteOffice2010BlueLightMode : PaletteOffice2010BlueLightModeBase
{
    ...
    public PaletteOffice2010BlueLightMode()
        : base(
        new PaletteOffice2010BlueLightMode_BaseScheme(),
        _checkBoxList,
        _galleryButtonList,
        _radioButtonArray)
    {
...
public abstract class PaletteOffice2010BlueLightModeBase : PaletteBase
{
    ...
    static PaletteOffice2010BlueLightModeBase()
    {
    ...
    /// </summary>
    public override KryptonColorTable ColorTable => _table ??= new KryptonColorTable2010BlueLightMode(_ribbonColors, InheritBool.True, this);

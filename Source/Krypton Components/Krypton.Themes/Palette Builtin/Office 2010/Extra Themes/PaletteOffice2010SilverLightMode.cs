...
#region Class: PaletteOffice2010SilverLightMode
/// <summary>
...
public class PaletteOffice2010SilverLightMode : PaletteOffice2010SilverLightModeBase
{
    ...
    private readonly Color _tabRowBackgroundGradientRaftingDarkColor = Color.FromArgb(195, 198, 209);

    private readonly Color _tabRowBackgroundGradientRaftingLightColor = Color.FromArgb(224, 225, 231);
    ...
    public PaletteOffice2010SilverLightMode()
        : base(
        new PaletteOffice2010SilverLightMode_BaseScheme(),
        _checkBoxList,
        _galleryButtonList,
        _radioButtonArray)
    {
...
#region Class: PaletteOffice2010SilverLightModeBase
/// <summary>
...
public abstract class PaletteOffice2010SilverLightModeBase : PaletteBase
{
    ...
    static PaletteOffice2010SilverLightModeBase()
    {
    ...
    public override Color GetBorderColor1(PaletteBorderStyle style, PaletteState state)
    {
        ...
        return style switch
        {
            ...
            {
                PaletteState.Disabled => style == PaletteBorderStyle.ButtonGallery ? BaseColors!.RibbonGalleryBack2 : GetArrayColor<ButtonBorderColor>(ButtonBorderColor.Color1),
                PaletteState.Normal => BaseColors!.ButtonNormalBorder,
    ...
    /// </summary>
    public override KryptonColorTable ColorTable => _table ??= new KryptonColorTable2010SilverLightMode(_ribbonColors, InheritBool.True, this);
...
#region Class: KryptonColorTable2010SilverLightMode
/// <summary>
...
public class KryptonColorTable2010SilverLightMode : KryptonColorTable
{
    ...
    public KryptonColorTable2010SilverLightMode([DisallowNull] Color[] colors,
    ...
    /// </summary>
    public override Color MenuStripText => Colors.Resolve(SchemeBaseColors.MenuStripText, SchemeBaseColors.StatusStripText);

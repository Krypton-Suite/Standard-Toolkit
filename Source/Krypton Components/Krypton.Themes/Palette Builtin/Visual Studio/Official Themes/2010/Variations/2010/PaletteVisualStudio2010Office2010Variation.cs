...
/// <seealso cref="Krypton.Toolkit.PaletteVisualStudio2010With2010Base" />
public class PaletteVisualStudio2010Office2010Variation : PaletteVisualStudio2010With2010Base
{
    ...
    static PaletteVisualStudio2010Office2010Variation()
    {
    ...
    public PaletteVisualStudio2010Office2010Variation()
        : base(
        new PaletteVisualStudio2010Office2010Variation_BaseScheme(),
        _checkBoxList,
        _galleryButtonList,
        _radioButtonArray)
    {

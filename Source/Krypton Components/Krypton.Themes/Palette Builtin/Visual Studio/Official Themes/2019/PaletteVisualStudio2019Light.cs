...
/// <summary>
/// Visual Studio 2019 light palette.
/// </summary>
public class PaletteVisualStudio2019Light : PaletteVisualStudio2022LightBase
{
    ...
    static PaletteVisualStudio2019Light()
    {
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PaletteVisualStudio2019Light"/> class.
    /// </summary>
    public PaletteVisualStudio2019Light()
        : base(
            new PaletteVisualStudio2019Light_BaseScheme(),
            _checkBoxList,
            _galleryButtonList,
            _radioButtonArray)
    {
        ThemeName = nameof(PaletteVisualStudio2019Light);
    }

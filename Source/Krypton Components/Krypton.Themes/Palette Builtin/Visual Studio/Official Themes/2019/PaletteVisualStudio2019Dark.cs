...
/// <summary>
/// Visual Studio 2019 dark palette.
/// </summary>
public class PaletteVisualStudio2019Dark : PaletteVisualStudio2022DarkBase
{
    ...
    static PaletteVisualStudio2019Dark()
    {
    ...
    public PaletteVisualStudio2019Dark()
        : base(
            new PaletteVisualStudio2019Dark_BaseScheme(),
            _checkBoxList,
            _galleryButtonList,
            _radioButtonArray)
    {
        ThemeName = nameof(PaletteVisualStudio2019Dark);
    }

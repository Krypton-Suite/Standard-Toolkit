...
/// <summary>
/// Visual Studio 2019 blue palette.
/// </summary>
public class PaletteVisualStudio2019Blue : PaletteVisualStudio2022LightBase
{
    ...
    static PaletteVisualStudio2019Blue()
    {
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PaletteVisualStudio2019Blue"/> class.
    /// </summary>
    public PaletteVisualStudio2019Blue()
        : base(
            new PaletteVisualStudio2019Blue_BaseScheme(),
            _checkBoxList,
            _galleryButtonList,
            _radioButtonArray)
    {
        ThemeName = nameof(PaletteVisualStudio2019Blue);
    }

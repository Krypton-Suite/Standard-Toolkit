...
/// <summary>
/// Visual Studio 2017 light palette.
/// </summary>
public class PaletteVisualStudio2017Light : PaletteVisualStudio2022LightBase
{
    ...
    static PaletteVisualStudio2017Light()
    {
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PaletteVisualStudio2017Light"/> class.
    /// </summary>
    public PaletteVisualStudio2017Light()
        : base(
            new PaletteVisualStudio2017Light_BaseScheme(),
            _checkBoxList,
            _galleryButtonList,
            _radioButtonArray)
    {

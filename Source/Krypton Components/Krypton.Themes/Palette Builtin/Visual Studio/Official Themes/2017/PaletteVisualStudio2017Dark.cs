...
/// <summary>
/// Visual Studio 2017 dark palette.
/// </summary>
public class PaletteVisualStudio2017Dark : PaletteVisualStudio2022DarkBase
{
    ...
    static PaletteVisualStudio2017Dark()
    {
    ...
    public PaletteVisualStudio2017Dark()
        : base(
            new PaletteVisualStudio2017Dark_BaseScheme(),
            _checkBoxList,
            _galleryButtonList,
            _radioButtonArray)
    {
        ThemeName = nameof(PaletteVisualStudio2017Dark);
    }

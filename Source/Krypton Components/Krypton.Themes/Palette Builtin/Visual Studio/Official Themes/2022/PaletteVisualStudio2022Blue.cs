...
/// <summary>
/// Visual Studio 2022 blue palette.
/// </summary>
public class PaletteVisualStudio2022Blue : PaletteVisualStudio2022LightBase
{
    #region Static Fields

    private static readonly Color _tabRowBackgroundColor = Color.FromArgb(206, 212, 223);
    ...
    static PaletteVisualStudio2022Blue()
    {
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PaletteVisualStudio2022Blue"/> class.
    /// </summary>
    public PaletteVisualStudio2022Blue()
        : base(
            new PaletteVisualStudio2022Blue_BaseScheme(),
            _checkBoxList,
            _galleryButtonList,
            _radioButtonArray)
    {
        ThemeName = nameof(PaletteVisualStudio2022Blue);
    }

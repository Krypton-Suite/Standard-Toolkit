...
/// <summary>
/// Visual Studio 2022 light palette.
/// </summary>
public class PaletteVisualStudio2022Light : PaletteVisualStudio2022LightBase
{
    ...
    static PaletteVisualStudio2022Light()
    {
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PaletteVisualStudio2022Light"/> class.
    /// </summary>
    public PaletteVisualStudio2022Light()
        : base(
            new PaletteVisualStudio2022Light_BaseScheme(),
            _checkBoxList,
            _galleryButtonList,
            _radioButtonArray)
    {
        ThemeName = nameof(PaletteVisualStudio2022Light);
    }

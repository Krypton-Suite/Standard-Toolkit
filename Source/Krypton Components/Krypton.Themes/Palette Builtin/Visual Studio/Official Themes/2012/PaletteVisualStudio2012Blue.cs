...
/// <summary>
/// Visual Studio 2012 blue palette.
/// </summary>
public class PaletteVisualStudio2012Blue : PaletteVisualStudio2022LightBase
{
    ...
    static PaletteVisualStudio2012Blue()
    {
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PaletteVisualStudio2012Blue"/> class.
    /// </summary>
    public PaletteVisualStudio2012Blue()
        : base(
            new PaletteVisualStudio2012Blue_BaseScheme(),
            _checkBoxList,
            _galleryButtonList,
            _radioButtonArray)
    {
        ThemeName = nameof(PaletteVisualStudio2012Blue);
    }

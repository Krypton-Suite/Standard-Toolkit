...
/// <summary>
/// Material Dark Materialize Blue - Dark Mode palette — flat Material metrics/renderer with Materialize Blue - Dark Mode accents on dark olive chrome.
/// </summary>
public class PaletteMaterialMaterializeBlueDark : PaletteMaterialBase
{
    ...
    static PaletteMaterialMaterializeBlueDark()
    {
        ...
        var scheme = MaterializeSchemeHelper.Create(new PaletteMaterialDark_BaseScheme(), MaterializeAccentKind.Blue, dark: true);
        ...
        MaterializeSchemeHelper.RegisterButtonStateColors<PaletteMaterialMaterializeBlueDark>(MaterializeAccentKind.Blue, dark: true);
    }

    /// <summary>
    /// Initialize a new instance of the <see cref="PaletteMaterialMaterializeBlueDark"/> class.
    /// </summary>
    public PaletteMaterialMaterializeBlueDark()
        : base(
            MaterializeSchemeHelper.Create(new PaletteMaterialDark_BaseScheme(), MaterializeAccentKind.Blue, dark: true),
            _checkBoxList,
            _galleryButtonList,
            _radioButtonArray)
    {
        ThemeName = "Material - Materialize Blue - Dark Mode";
    }
    ...
    public override Color GetBackColor1(PaletteBackStyle style, PaletteState state) =>
        IsLimeFilledButton(style) ? MaterializeSchemeHelper.GetMaterialButtonBack(MaterializeAccentKind.Blue, state) : base.GetBackColor1(style, state);

    /// <inheritdoc />
    public override Color GetBackColor2(PaletteBackStyle style, PaletteState state) =>
        IsLimeFilledButton(style) ? MaterializeSchemeHelper.GetMaterialButtonBack(MaterializeAccentKind.Blue, state) : base.GetBackColor2(style, state);

    /// <inheritdoc />
    public override Color GetBorderColor1(PaletteBorderStyle style, PaletteState state) =>
        IsLimeFilledButtonBorder(style) ? MaterializeSchemeHelper.GetMaterialButtonBorder(MaterializeAccentKind.Blue, state) : base.GetBorderColor1(style, state);

    /// <inheritdoc />
    public override Color GetBorderColor2(PaletteBorderStyle style, PaletteState state) =>
        IsLimeFilledButtonBorder(style) ? MaterializeSchemeHelper.GetMaterialButtonBorder(MaterializeAccentKind.Blue, state) : base.GetBorderColor2(style, state);

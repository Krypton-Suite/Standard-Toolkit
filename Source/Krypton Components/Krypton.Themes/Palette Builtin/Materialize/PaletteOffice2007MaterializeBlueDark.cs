...
/// <summary>
/// Provides the dark Materialize Blue - Dark Mode color scheme variant of the Office 2007 palette.
/// </summary>
/// <remarks>
...
/// </remarks>
public class PaletteOffice2007MaterializeBlueDark : PaletteOffice2007Base
{
    ...
    #region Identity
    static PaletteOffice2007MaterializeBlueDark()
    {
        ...
        MaterializeSchemeHelper.RegisterButtonStateColors<PaletteOffice2007MaterializeBlueDark>(MaterializeAccentKind.Blue, dark: true);
    }

    /// <summary>
    /// Initialize a new instance of the PaletteOffice2007MaterializeBlueDark class.
    /// </summary>
    public PaletteOffice2007MaterializeBlueDark()
        : base(
        "Office 2007 - Materialize Blue - Dark Mode",
        MaterializeSchemeHelper.Create(new PaletteOffice2007BlueDarkMode_BaseScheme(), MaterializeAccentKind.Blue, true),
        _checkBoxList,
        _galleryButtonList,
        _radioButtonArray)
    {

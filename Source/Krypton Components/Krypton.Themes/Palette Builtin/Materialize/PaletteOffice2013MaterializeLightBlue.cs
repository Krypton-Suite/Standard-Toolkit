...
/// </summary>
public class PaletteOffice2013MaterializeLightBlue : PaletteOffice2013WhiteBase
{
    ...
    static PaletteOffice2013MaterializeLightBlue()
    {
        MaterializeSchemeHelper.RegisterButtonStateColors<PaletteOffice2013MaterializeLightBlue>(MaterializeAccentKind.LightBlue, dark: false);
    ...
    /// </summary>
    public PaletteOffice2013MaterializeLightBlue()
        : base(
        MaterializeSchemeHelper.Create(new PaletteOffice2013White_BaseScheme(), MaterializeAccentKind.LightBlue, false),
        _checkBoxList,
        _galleryButtonList,
        _radioButtonArray)
    {
        ThemeName = "Office 2013 - Materialize Light Blue";
    }

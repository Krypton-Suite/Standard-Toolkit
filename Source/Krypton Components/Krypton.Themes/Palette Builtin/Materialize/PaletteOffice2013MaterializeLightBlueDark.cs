...
/// </summary>
public class PaletteOffice2013MaterializeLightBlueDark : PaletteOffice2013Base
{
    ...
    #region Identity
    static PaletteOffice2013MaterializeLightBlueDark()
    {
        MaterializeSchemeHelper.RegisterButtonStateColors<PaletteOffice2013MaterializeLightBlueDark>(MaterializeAccentKind.LightBlue, dark: true);
    ...
    /// <summary>
    /// Initialize a new instance of the PaletteOffice2013MaterializeLightBlueDark class.
    /// </summary>
    public PaletteOffice2013MaterializeLightBlueDark()
        : base(
        MaterializeSchemeHelper.Create(new PaletteOffice2013DarkGray_BaseScheme(), MaterializeAccentKind.LightBlue, true),
        _checkBoxList,
        _galleryButtonList,
        _radioButtonArray)
    {
        ThemeName = "Office 2013 - Materialize Light Blue - Dark Mode";
    }
    #endregion

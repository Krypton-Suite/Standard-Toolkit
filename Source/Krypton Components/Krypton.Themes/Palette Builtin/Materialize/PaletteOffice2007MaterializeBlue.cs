...
/// <summary>
/// Provides the light Materialize Blue color scheme variant of the Office 2007 palette.
/// </summary>
/// <remarks>
/// Reuses the Office 2007 Blue chrome (control box glyphs, radio buttons, check boxes, rounded header
/// form corners) while replacing the button/panel/header/form accent colours with Materialize Blue via
/// <see cref="MaterializeSchemeHelper"/>.
/// </remarks>
public class PaletteOffice2007MaterializeBlue : PaletteOffice2007Base
{
    ...
    #region Identity
    static PaletteOffice2007MaterializeBlue()
    {
        ...
        MaterializeSchemeHelper.RegisterButtonStateColors<PaletteOffice2007MaterializeBlue>(MaterializeAccentKind.Blue, dark: false);
    }

    /// <summary>
    /// Initialize a new instance of the PaletteOffice2007MaterializeBlue class.
    /// </summary>
    public PaletteOffice2007MaterializeBlue()
        : base(
        "Office 2007 - Materialize Blue",
        MaterializeSchemeHelper.Create(new PaletteOffice2007Blue_BaseScheme(), MaterializeAccentKind.Blue, false),
        _checkBoxList,
        _galleryButtonList,
        _radioButtonArray)
    {

...
/// <summary>
/// Provides the light Materialize Blue color scheme variant of the Office 2010 palette.
/// </summary>
/// <remarks>
/// Reuses the Office 2010 Blue chrome (control box glyphs, radio buttons, check boxes, ribbon tab row
/// gradient/rafting) while replacing the button/panel/header/form accent colours with Materialize Blue via
/// <see cref="MaterializeSchemeHelper"/>.
/// </remarks>
public class PaletteOffice2010MaterializeBlue : PaletteOffice2010Base
{
    ...
    #region Identity
    static PaletteOffice2010MaterializeBlue()
    {
        ...
        MaterializeSchemeHelper.RegisterButtonStateColors<PaletteOffice2010MaterializeBlue>(MaterializeAccentKind.Blue, dark: false);
    }

    /// <summary>
    /// Initialize a new instance of the PaletteOffice2010MaterializeBlue class.
    /// </summary>
    public PaletteOffice2010MaterializeBlue()
        : base(
        MaterializeSchemeHelper.Create(new PaletteOffice2010Blue_BaseScheme(), MaterializeAccentKind.Blue, false),
        _checkBoxList,
        _galleryButtonList,
        _radioButtonArray) =>
        ThemeName = "Office 2010 - Materialize Blue";

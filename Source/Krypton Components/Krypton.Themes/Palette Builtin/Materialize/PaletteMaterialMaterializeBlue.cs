...
/// <summary>
/// Material Light Materialize Blue palette — flat Material metrics/renderer with Materialize Blue accents.
/// </summary>
public class PaletteMaterialMaterializeBlue : PaletteMaterialBase
{
    ...
    static PaletteMaterialMaterializeBlue()
    {
        ...
        var scheme = MaterializeSchemeHelper.Create(new PaletteMaterialLight_BaseScheme(), MaterializeAccentKind.Blue, dark: false);
        ...
        MaterializeSchemeHelper.RegisterButtonStateColors<PaletteMaterialMaterializeBlue>(MaterializeAccentKind.Blue, dark: false);
    }

    /// <summary>
    /// Initialize a new instance of the <see cref="PaletteMaterialMaterializeBlue"/> class.
    /// </summary>
    public PaletteMaterialMaterializeBlue()
        : base(
            MaterializeSchemeHelper.Create(new PaletteMaterialLight_BaseScheme(), MaterializeAccentKind.Blue, dark: false),
            _checkBoxList,
            _galleryButtonList,
            _radioButtonArray)
    {
        ThemeName = "Material - Materialize Blue";
    }

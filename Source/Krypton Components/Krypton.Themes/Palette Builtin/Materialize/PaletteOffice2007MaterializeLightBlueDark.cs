...
/// <summary>
/// Provides the dark Materialize Light Blue - Dark Mode color scheme variant of the Office 2007 palette.
/// </summary>
/// <remarks>
...
/// </remarks>
public class PaletteOffice2007MaterializeLightBlueDark : PaletteOffice2007Base
{
    ...
    #region Identity
    static PaletteOffice2007MaterializeLightBlueDark()
    {
        ...
        MaterializeSchemeHelper.RegisterButtonStateColors<PaletteOffice2007MaterializeLightBlueDark>(MaterializeAccentKind.LightBlue, dark: true);
    }

    /// <summary>
    /// Initialize a new instance of the PaletteOffice2007MaterializeLightBlueDark class.
    /// </summary>
    public PaletteOffice2007MaterializeLightBlueDark()
        : base(
        "Office 2007 - Materialize Light Blue - Dark Mode",
        MaterializeSchemeHelper.Create(new PaletteOffice2007BlueDarkMode_BaseScheme(), MaterializeAccentKind.LightBlue, true),
        _checkBoxList,
        _galleryButtonList,
        _radioButtonArray)
    {

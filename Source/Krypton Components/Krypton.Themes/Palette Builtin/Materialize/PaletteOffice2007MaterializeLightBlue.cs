...
/// <summary>
/// Provides the light Materialize Light Blue color scheme variant of the Office 2007 palette.
/// </summary>
/// <remarks>
/// Reuses the Office 2007 Blue chrome (control box glyphs, radio buttons, check boxes, rounded header
/// form corners) while replacing the button/panel/header/form accent colours with Materialize Light Blue via
/// <see cref="MaterializeSchemeHelper"/>.
/// </remarks>
public class PaletteOffice2007MaterializeLightBlue : PaletteOffice2007Base
{
    ...
    #region Identity
    static PaletteOffice2007MaterializeLightBlue()
    {
        ...
        MaterializeSchemeHelper.RegisterButtonStateColors<PaletteOffice2007MaterializeLightBlue>(MaterializeAccentKind.LightBlue, dark: false);
    }

    /// <summary>
    /// Initialize a new instance of the PaletteOffice2007MaterializeLightBlue class.
    /// </summary>
    public PaletteOffice2007MaterializeLightBlue()
        : base(
        "Office 2007 - Materialize Light Blue",
        MaterializeSchemeHelper.Create(new PaletteOffice2007Blue_BaseScheme(), MaterializeAccentKind.LightBlue, false),
        _checkBoxList,
        _galleryButtonList,
        _radioButtonArray)
    {

...
/// <summary>
/// Provides the dark Materialize Light Blue - Dark Mode color scheme variant of the Office 2010 palette.
/// </summary>
/// <remarks>
/// Reuses the Office 2010 Blue chrome (control box glyphs, radio buttons, check boxes, ribbon tab row
/// gradient/rafting) while replacing the button/panel/header/form accent colours with the dark-mode
/// Materialize Light Blue - Dark Mode accents via <see cref="MaterializeSchemeHelper"/>.
/// </remarks>
public class PaletteOffice2010MaterializeLightBlueDark : PaletteOffice2010Base
{
    ...
    #region Identity
    static PaletteOffice2010MaterializeLightBlueDark()
    {
        ...
        MaterializeSchemeHelper.RegisterButtonStateColors<PaletteOffice2010MaterializeLightBlueDark>(MaterializeAccentKind.LightBlue, dark: true);
    }

    /// <summary>
    /// Initialize a new instance of the PaletteOffice2010MaterializeLightBlueDark class.
    /// </summary>
    public PaletteOffice2010MaterializeLightBlueDark()
        : base(
        MaterializeSchemeHelper.Create(new PaletteOffice2010BlueDarkMode_BaseScheme(), MaterializeAccentKind.LightBlue, true),
        _checkBoxList,
        _galleryButtonList,
        _radioButtonArray) =>
        ThemeName = "Office 2010 - Materialize Light Blue - Dark Mode";

...
/// <summary>
/// Provides a base for Office 365 Black Dark Mode palettes.
/// </summary>
...
public abstract class PaletteMicrosoft365BlackDarkModeBase : PaletteBase
{
    ...
    private new static void RegisterColor<TEnum>(TEnum slot, Color value) where TEnum : struct, Enum =>
        RegisterColor<PaletteMicrosoft365BlackDarkModeBase, TEnum>(slot, value);

    static PaletteMicrosoft365BlackDarkModeBase()
    {
        ...
        RegisterColor<ButtonBackColor>(ButtonBackColor.Color9, Color.FromArgb(41, 41, 41));
    ...
    protected KryptonColorTable365BlackDarkMode? Table;
    ...
    public override Color GetBorderColor1(PaletteBorderStyle style, PaletteState state)
    {
        ...
        return style switch
        {
            PaletteBorderStyle.TabHighProfile or PaletteBorderStyle.TabStandardProfile or PaletteBorderStyle.TabLowProfile or PaletteBorderStyle.TabOneNote or PaletteBorderStyle.TabCustom1 or PaletteBorderStyle.TabCustom2 or PaletteBorderStyle.TabCustom3 => state switch
            {
                ...
                PaletteState.Normal
                    or PaletteState.Tracking
                    or PaletteState.Pressed => style == PaletteBorderStyle.TabLowProfile ? SharedStaticVariables.EMPTY_COLOR : BaseColors.ButtonNormalBorder,
                PaletteState.CheckedNormal
                    or PaletteState.CheckedPressed
                    or PaletteState.CheckedTracking => BaseColors.ControlBorder,
                _ => throw DebugTools.NotImplemented(state.ToString())
            },
            ...
            PaletteBorderStyle.ButtonGallery or PaletteBorderStyle.ButtonStandalone or PaletteBorderStyle.ButtonAlternate or PaletteBorderStyle.ButtonLowProfile or PaletteBorderStyle.ButtonBreadCrumb or PaletteBorderStyle.ButtonListItem or PaletteBorderStyle.ButtonCommand or PaletteBorderStyle.ButtonButtonSpec or PaletteBorderStyle.ButtonCluster or PaletteBorderStyle.ButtonCustom1 or PaletteBorderStyle.ButtonCustom2 or PaletteBorderStyle.ButtonCustom3 or PaletteBorderStyle.ContextMenuItemHighlight => state switch
            {
                ...
                PaletteState.Tracking => GetArrayColor<ButtonBorderColor>(ButtonBorderColor.Color2),
                PaletteState.Pressed
                    or PaletteState.CheckedPressed => GetArrayColor<ButtonBorderColor>(ButtonBorderColor.Color4),
    ...
    public override Color GetBorderColor2(PaletteBorderStyle style, PaletteState state)
    {
        ...
        return style switch
        {
            ...
            PaletteBorderStyle.ButtonGallery or PaletteBorderStyle.ButtonStandalone or PaletteBorderStyle.ButtonAlternate or PaletteBorderStyle.ButtonLowProfile or PaletteBorderStyle.ButtonBreadCrumb or PaletteBorderStyle.ButtonListItem or PaletteBorderStyle.ButtonCommand or PaletteBorderStyle.ButtonButtonSpec or PaletteBorderStyle.ButtonCluster or PaletteBorderStyle.ButtonCustom1 or PaletteBorderStyle.ButtonCustom2 or PaletteBorderStyle.ButtonCustom3 or PaletteBorderStyle.ContextMenuItemHighlight => state switch
            {
                ...
                PaletteState.Tracking => GetArrayColor<ButtonBorderColor>(ButtonBorderColor.Color3),
                PaletteState.Pressed
                    or PaletteState.CheckedPressed => GetArrayColor<ButtonBorderColor>(ButtonBorderColor.Color5),
    ...
    public override Color GetContentShortTextColor1(PaletteContentStyle style, PaletteState state)
    {
        ...
        return style switch
        {
            ...
            {
                PaletteState.Tracking
                    or PaletteState.CheckedTracking => BaseColors.TextButtonFormTracking,
                PaletteState.Pressed
                    or PaletteState.CheckedPressed
                    or PaletteState.CheckedNormal => BaseColors.TextButtonFormPressed,
                _ => BaseColors.TextButtonFormNormal
            },
            PaletteContentStyle.ButtonInputControl => state switch
            {
                PaletteState.Disabled => BaseColors.InputDropDownDisabled1,
                _ => BaseColors.InputDropDownNormal1
            },
    ...
    public override Color GetContentShortTextColor2(PaletteContentStyle style, PaletteState state)
    {
        ...
        return style switch
        {
            ...
            PaletteContentStyle.ButtonListItem or PaletteContentStyle.ButtonCommand or PaletteContentStyle.ButtonLowProfile or PaletteContentStyle.ButtonBreadCrumb or PaletteContentStyle.ButtonButtonSpec => state switch
            {
                ...
                PaletteState.CheckedNormal
                    or PaletteState.CheckedTracking
                    or PaletteState.CheckedPressed => BaseColors.TextButtonChecked,
                _ => BaseColors.TextButtonNormal
            },
            PaletteContentStyle.ButtonForm or PaletteContentStyle.ButtonFormClose => state switch
            {
                PaletteState.Tracking
                    or PaletteState.CheckedTracking => BaseColors.TextButtonFormTracking,
                PaletteState.Pressed
                    or PaletteState.CheckedPressed => BaseColors.TextButtonFormPressed,
                _ => BaseColors.TextButtonFormNormal
            },
    ...
    public override KryptonColorTable ColorTable =>
        Table ??= new KryptonColorTable365BlackDarkMode(_ribbonColors, InheritBool.True, this);

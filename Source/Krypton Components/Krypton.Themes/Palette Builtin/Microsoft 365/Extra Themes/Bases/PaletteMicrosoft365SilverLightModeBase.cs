...
/// <summary>
/// Provides a base for Office 365 silver light mode palettes.
/// </summary>
...
public abstract class PaletteMicrosoft365SilverLightModeBase : PaletteBase
{
    ...
    protected KryptonColorTable365SilverLightMode? Table { get; set; }
    ...
    public override KryptonColorTable ColorTable =>
        Table ??= new KryptonColorTable365SilverLightMode(_ribbonColors, InheritBool.True, this);

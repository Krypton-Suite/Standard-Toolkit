...
public class PaletteMicrosoft365BlueDarkMode : PaletteMicrosoft365BlueDarkModeBase
{
    ...
    private static readonly Color _tabRowBackgroundColor = Color.FromArgb(134, 179, 236);
    ...
    static PaletteMicrosoft365BlueDarkMode()
    {
    ...
    /// </summary>
    public PaletteMicrosoft365BlueDarkMode() : base(
        new PaletteMicrosoft365BlueDarkMode_BaseScheme(),
        _checkBoxList,
        _galleryButtonList,
        _radioButtonArray)
    {

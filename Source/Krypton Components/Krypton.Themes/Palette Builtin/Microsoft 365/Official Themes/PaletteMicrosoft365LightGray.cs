...
/// <summary>
/// Microsoft 365 renderer using the Office 2013 Light Grey chrome colour map.
/// </summary>
public class PaletteMicrosoft365LightGray : PaletteMicrosoft365Base
{
    ...
    private static readonly Color _tabRowBackgroundColor = Color.FromArgb(230, 230, 230);
    ...
    /// </summary>
    public PaletteMicrosoft365LightGray() : base(

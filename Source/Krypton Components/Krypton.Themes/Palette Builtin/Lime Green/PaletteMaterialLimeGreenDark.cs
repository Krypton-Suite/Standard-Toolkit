...
/// </summary>
public class PaletteMaterialLimeGreenDark : PaletteMaterialBase
{
    ...
    static PaletteMaterialLimeGreenDark()
    {
        ...
        var scheme = LimeGreenSchemeHelper.Create(new PaletteMaterialDark_BaseScheme(), dark: true);
        ...
        LimeGreenSchemeHelper.RegisterButtonStateColors<PaletteMaterialLimeGreenDark>(dark: true);
    }

    /// <summary>
    /// Initialize a new instance of the <see cref="PaletteMaterialLimeGreenDark"/> class.
    /// </summary>
    public PaletteMaterialLimeGreenDark()
        : base(
            LimeGreenSchemeHelper.Create(new PaletteMaterialDark_BaseScheme(), dark: true),
            _checkBoxList,
            _galleryButtonList,
            _radioButtonArray)
    {
        ThemeName = "Material - Lime Green - Dark Mode";
    }

...
/// <summary>
/// Provides the light Lime Green color scheme variant of the Office 2007 palette.
/// </summary>
/// <remarks>
/// Reuses the Office 2007 Blue chrome (control box glyphs, radio buttons, check boxes, rounded header
/// form corners) while replacing the button/panel/header/form accent colours with Lime Green via
/// <see cref="LimeGreenSchemeHelper"/>.
/// </remarks>
public class PaletteOffice2007LimeGreen : PaletteOffice2007Base
{
    ...
    #region Identity
    static PaletteOffice2007LimeGreen()
    {
        ...
        LimeGreenSchemeHelper.RegisterButtonStateColors<PaletteOffice2007LimeGreen>(dark: false);
    }

    /// <summary>
    /// Initialize a new instance of the PaletteOffice2007LimeGreen class.
    /// </summary>
    public PaletteOffice2007LimeGreen()
        : base(
        "Office 2007 - Lime Green",
        LimeGreenSchemeHelper.Create(new PaletteOffice2007Blue_BaseScheme(), false),
        _checkBoxList,
        _galleryButtonList,
        _radioButtonArray)
    {

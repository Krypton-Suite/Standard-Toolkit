...
/// <summary>
/// Provides the dark Lime Green color scheme variant of the Office 2010 palette.
/// </summary>
/// <remarks>
...
/// Lime Green accents via <see cref="LimeGreenSchemeHelper"/>.
/// </remarks>
public class PaletteOffice2010LimeGreenDark : PaletteOffice2010Base
{
    ...
    #region Identity
    static PaletteOffice2010LimeGreenDark()
    {
        ...
        LimeGreenSchemeHelper.RegisterButtonStateColors<PaletteOffice2010LimeGreenDark>(dark: true);
    }

    /// <summary>
    /// Initialize a new instance of the PaletteOffice2010LimeGreenDark class.
    /// </summary>
    public PaletteOffice2010LimeGreenDark()
        : base(
        LimeGreenSchemeHelper.Create(new PaletteOffice2010BlueDarkMode_BaseScheme(), true),
        _checkBoxList,
        _galleryButtonList,
        _radioButtonArray) =>
        ThemeName = "Office 2010 - Lime Green Dark";

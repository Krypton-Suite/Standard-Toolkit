...
/// <summary>
/// Provides the dark Lime Green color scheme variant of the Microsoft 365 palette.
/// </summary>
/// <remarks>
...
/// accent colours with the dark-mode Lime Green accents via <see cref="LimeGreenSchemeHelper"/>.
/// </remarks>
public class PaletteMicrosoft365LimeGreenDark : PaletteMicrosoft365Base
{
    ...
    static PaletteMicrosoft365LimeGreenDark()
    {
        ...
        LimeGreenSchemeHelper.RegisterButtonStateColors<PaletteMicrosoft365LimeGreenDark>(dark: true);
    }

    /// <summary>
    /// Initializes a new instance of the <see cref="PaletteMicrosoft365LimeGreenDark"/> class.
    /// </summary>
    public PaletteMicrosoft365LimeGreenDark() : base(
        LimeGreenSchemeHelper.Create(new PaletteMicrosoft365BlackDarkMode_BaseScheme(), true),
        _checkBoxList,
        _galleryButtonList,
        _radioButtonArray) =>
        ThemeName = "Microsoft 365 - Lime Green Dark";

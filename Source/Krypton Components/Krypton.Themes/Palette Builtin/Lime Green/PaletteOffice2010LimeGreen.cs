...
/// gradient/rafting) while replacing the button/panel/header/form accent colours with Lime Green via
/// <see cref="LimeGreenSchemeHelper"/>.
/// </remarks>
public class PaletteOffice2010LimeGreen : PaletteOffice2010Base
{
    ...
    #region Identity
    static PaletteOffice2010LimeGreen()
    {
        ...
        LimeGreenSchemeHelper.RegisterButtonStateColors<PaletteOffice2010LimeGreen>(dark: false);
    }

    /// <summary>
    /// Initialize a new instance of the PaletteOffice2010LimeGreen class.
    /// </summary>
    public PaletteOffice2010LimeGreen()
        : base(
        LimeGreenSchemeHelper.Create(new PaletteOffice2010Blue_BaseScheme(), false),
        _checkBoxList,
        _galleryButtonList,
        _radioButtonArray) =>
        ThemeName = "Office 2010 - Lime Green";

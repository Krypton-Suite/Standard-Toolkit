...
/// <summary>
/// Provides the light Lime Green color scheme variant of the Microsoft 365 palette.
/// </summary>
/// <remarks>
/// Reuses the Microsoft 365 White chrome (control box glyphs, radio buttons, check boxes, integrated
/// toolbar images) while replacing the button/panel/header/form accent colours with Lime Green via
/// <see cref="LimeGreenSchemeHelper"/>.
/// </remarks>
public class PaletteMicrosoft365LimeGreen : PaletteMicrosoft365Base
{
    ...
    static PaletteMicrosoft365LimeGreen()
    {
        ...
        LimeGreenSchemeHelper.RegisterButtonStateColors<PaletteMicrosoft365LimeGreen>(dark: false);
    }

    /// <summary>
    /// Initialize a new instance of the PaletteMicrosoft365LimeGreen class.
    /// </summary>
    public PaletteMicrosoft365LimeGreen() : base(
        LimeGreenSchemeHelper.Create(new PaletteMicrosoft365White_BaseScheme(), false),
        _checkBoxList,
        _galleryButtonList,
        _radioButtonArray) =>
        ThemeName = "Microsoft 365 - Lime Green";

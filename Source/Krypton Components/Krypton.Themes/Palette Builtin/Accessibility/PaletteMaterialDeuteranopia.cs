...
/// </summary>
public class PaletteMaterialDeuteranopia : PaletteMaterialBase
{
    ...
    private readonly AccessibilityMaterialAccents.AccentSet _accents = AccessibilityMaterialAccents.Deuteranopia;

    static PaletteMaterialDeuteranopia()
    {
        ...
        var scheme = new PaletteDeuteranopia_BaseScheme();
    ...
    /// <summary>
    /// Initialize a new instance of the <see cref="PaletteMaterialDeuteranopia"/> class.
    /// </summary>
    public PaletteMaterialDeuteranopia()
        : base(new PaletteDeuteranopia_BaseScheme(), _checkBoxList, _galleryButtonList, _radioButtonArray)
    {
        ThemeName = nameof(PaletteMaterialDeuteranopia);
    }

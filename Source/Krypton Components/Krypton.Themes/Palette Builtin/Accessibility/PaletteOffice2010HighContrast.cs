...
/// <summary>
/// Office 2010 renderer with high-contrast colours (#4168).
/// </summary>
public class PaletteOffice2010HighContrast : PaletteOffice2010Base
{
    private readonly Color _tabRowBackgroundGradientRaftingDarkColor = Color.FromArgb(40, 40, 40);
    private readonly Color _tabRowBackgroundGradientRaftingLightColor = Color.FromArgb(60, 60, 60);
    ...
    static PaletteOffice2010HighContrast()
    {
    ...
    /// <summary>
    /// Initialize a new instance of the <see cref="PaletteOffice2010HighContrast"/> class.
    /// </summary>
    public PaletteOffice2010HighContrast()
        : base(new PaletteHighContrast_BaseScheme(), _checkBoxList, _galleryButtonList, _radioButtonArray)
    {
        ThemeName = nameof(PaletteOffice2010HighContrast);

...
/// <summary>
/// Office 2007 renderer with deuteranopia-friendly colours (#4168).
/// </summary>
public class PaletteOffice2007Deuteranopia : PaletteOffice2007Base
{
    ...
    static PaletteOffice2007Deuteranopia()
    {
    ...
    /// <summary>
    /// Initialize a new instance of the <see cref="PaletteOffice2007Deuteranopia"/> class.
    /// </summary>
    public PaletteOffice2007Deuteranopia()
        : base("Office 2007 - Deuteranopia", new PaletteDeuteranopia_BaseScheme(), _checkBoxList, _galleryButtonList, _radioButtonArray)
    {
        ThemeName = nameof(PaletteOffice2007Deuteranopia);

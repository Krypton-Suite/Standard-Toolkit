...
/// <summary>
/// Fixed high-contrast palette with black/white surfaces and neon accents (#4168).
/// </summary>
public class PaletteHighContrast : PaletteMicrosoft365Base
{
    #region Static Fields

    #region Colors

    private static readonly Color _tabRowBackgroundColor = Color.Black;

    #endregion Colors

    #region Ribbon Specific Colors

    private static readonly Color _ribbonAppButtonDarkColor = Color.FromArgb(0, 255, 0);
    private static readonly Color _ribbonAppButtonLightColor = Color.FromArgb(0, 220, 0);
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PaletteHighContrast"/> class.
    /// </summary>
    public PaletteHighContrast() : base(
        new PaletteHighContrast_BaseScheme(),
        _checkBoxList,
        _galleryButtonList,
        _radioButtonArray)
    {
        ThemeName = nameof(PaletteHighContrast);

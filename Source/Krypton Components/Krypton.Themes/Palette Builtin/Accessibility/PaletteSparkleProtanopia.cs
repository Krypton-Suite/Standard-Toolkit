...
/// </summary>
public class PaletteSparkleProtanopia : PaletteSparkleBase
{
    ...
    static PaletteSparkleProtanopia()
    {
    ...
    /// <summary>
    /// Initialize a new instance of the <see cref="PaletteSparkleProtanopia"/> class.
    /// </summary>
    public PaletteSparkleProtanopia()
        : base(new PaletteProtanopia_BaseScheme(), _sparkleColors, _appButtonNormal, _appButtonTrack, _appButtonPressed,
            _ribbonGroupCollapsedBorderContextTracking, _checkBoxList, _radioButtonArray)
    {
        ThemeName = nameof(PaletteSparkleProtanopia);
        AccessibilitySparkleAccents.ApplyProtanopia(_sparkleColors, _appButtonTrack, _appButtonPressed);
    }

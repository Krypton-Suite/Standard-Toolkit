...
/// <summary>
/// Office 2013 renderer with deuteranopia-friendly colours (#4168).
/// </summary>
public class PaletteOffice2013Deuteranopia : PaletteOffice2013Base
{
    private readonly Color _tabRowBackgroundColor = Color.FromArgb(200, 220, 240);
    ...
    static PaletteOffice2013Deuteranopia()
    {
    ...
    /// <summary>
    /// Initialize a new instance of the <see cref="PaletteOffice2013Deuteranopia"/> class.
    /// </summary>
    public PaletteOffice2013Deuteranopia()
        : base(new PaletteDeuteranopia_BaseScheme(), _checkBoxList, _galleryButtonList, _radioButtonArray)
    {
        ThemeName = nameof(PaletteOffice2013Deuteranopia);

...
public sealed class PaletteDeuteranopia_BaseScheme : KryptonColorSchemeBase
{
    ...
    public override Color ButtonNormalDefaultBorder        { get; set; } = Color.FromArgb(0, 70, 110);
    ...
    public override Color ButtonNormalDefaultBack1         { get; set; } = Color.FromArgb(0, 114, 178);
    public override Color ButtonNormalDefaultBack2         { get; set; } = Color.FromArgb(0, 90, 140);
    ...
    public override Color PanelClient                      { get; set; } = Color.FromArgb(232, 236, 242);
    public override Color PanelAlternative                 { get; set; } = Color.FromArgb(214, 222, 234);
    ...
    public override Color HeaderPrimaryBack1               { get; set; } = Color.FromArgb(0, 114, 178);
    public override Color HeaderPrimaryBack2               { get; set; } = Color.FromArgb(0, 90, 140);
    public override Color HeaderSecondaryBack1             { get; set; } = Color.FromArgb(255, 220, 150);
    public override Color HeaderSecondaryBack2             { get; set; } = Color.FromArgb(255, 200, 100);
    public override Color HeaderText                       { get; set; } = Color.White;
    public override Color StatusStripText                  { get; set; } = Color.White;
    public override Color ButtonBorder                     { get; set; } = Color.FromArgb(230, 159, 0);
    ...
    public override Color StatusStripLight                 { get; set; } = Color.FromArgb(0, 114, 178);
    public override Color StatusStripDark                  { get; set; } = Color.FromArgb(0, 90, 140);
    public override Color ImageMargin                      { get; set; } = Color.White;
    public override Color ToolStripBegin                   { get; set; } = Color.FromArgb(232, 236, 242);
    public override Color ToolStripMiddle                  { get; set; } = Color.FromArgb(214, 222, 234);
    public override Color ToolStripEnd                     { get; set; } = Color.FromArgb(214, 222, 234);
    ...
    public override Color FormBorderHeaderActive1          { get; set; } = Color.FromArgb(0, 114, 178);
    public override Color FormBorderHeaderActive2          { get; set; } = Color.FromArgb(0, 90, 140);
    ...
    public override Color FormButtonBorderTrack            { get; set; } = Color.FromArgb(230, 159, 0);
    public override Color FormButtonBack1Track             { get; set; } = Color.FromArgb(255, 235, 190);
    public override Color FormButtonBack2Track             { get; set; } = Color.FromArgb(255, 200, 80);
    public override Color FormButtonBorderPressed          { get; set; } = Color.FromArgb(150, 90, 0);
    public override Color FormButtonBack1Pressed           { get; set; } = Color.FromArgb(230, 159, 0);
    public override Color FormButtonBack2Pressed           { get; set; } = Color.FromArgb(180, 120, 0);
    ...
    public override Color LinkNotVisitedOverrideControl    { get; set; } = Color.FromArgb(123, 44, 191);
    public override Color LinkVisitedOverrideControl       { get; set; } = Color.FromArgb(0, 114, 178);
    public override Color LinkPressedOverrideControl       { get; set; } = Color.FromArgb(230, 159, 0);
    public override Color LinkNotVisitedOverridePanel      { get; set; } = Color.FromArgb(123, 44, 191);
    public override Color LinkVisitedOverridePanel         { get; set; } = Color.FromArgb(0, 114, 178);
    public override Color LinkPressedOverridePanel         { get; set; } = Color.FromArgb(230, 159, 0);
    ...
    public override Color RibbonTabSelected1               { get; set; } = Color.FromArgb(0, 114, 178);
    public override Color RibbonTabSelected2               { get; set; } = Color.FromArgb(200, 230, 255);
    ...
    public override Color RibbonTabTracking1               { get; set; } = Color.FromArgb(230, 159, 0);
    public override Color RibbonTabTracking2               { get; set; } = Color.FromArgb(255, 190, 60);
    public override Color RibbonTabHighlight1              { get; set; } = Color.FromArgb(123, 44, 191);
    ...
    public override Color FormButtonBack1Checked           { get; set; } = Color.FromArgb(230, 159, 0);
    public override Color FormButtonBack2Checked           { get; set; } = Color.FromArgb(255, 200, 80);
    public override Color FormButtonBorderCheck            { get; set; } = Color.FromArgb(180, 120, 0);
    ...
    public override Color GridListSelected                 { get; set; } = Color.FromArgb(230, 159, 0);
    ...
    public override Color GridSheetColPressed1             { get; set; } = Color.FromArgb(230, 159, 0);
    public override Color GridSheetColPressed2             { get; set; } = Color.FromArgb(255, 220, 150);
    public override Color GridSheetColSelected1            { get; set; } = Color.FromArgb(0, 114, 178);
    public override Color GridSheetColSelected2            { get; set; } = Color.FromArgb(120, 180, 220);
    public override Color GridSheetRowNormal               { get; set; } = Color.FromArgb(218, 231, 245);
    public override Color GridSheetRowPressed              { get; set; } = Color.FromArgb(230, 159, 0);
    public override Color GridSheetRowSelected             { get; set; } = Color.FromArgb(123, 44, 191);
    public override Color GridDataCellBorder               { get; set; } = Color.FromArgb(218, 220, 221);
    public override Color GridDataCellSelected             { get; set; } = Color.FromArgb(255, 235, 190);
    ...
    public override Color ContextMenuHeadingBack           { get; set; } = Color.FromArgb(123, 44, 191);
    ...
    public override Color ButtonNavigatorTrack1            { get; set; } = Color.FromArgb(255, 200, 80);
    public override Color ButtonNavigatorTrack2            { get; set; } = Color.FromArgb(230, 159, 0);
    ...
    public override Color ButtonNavigatorChecked1          { get; set; } = Color.FromArgb(0, 114, 178);
    public override Color ButtonNavigatorChecked2          { get; set; } = Color.FromArgb(0, 90, 140);
    ...
    public override Color TrackBarFillTrack                { get; set; } = Color.FromArgb(0, 114, 178);

...
public sealed class PaletteProtanopia_BaseScheme : KryptonColorSchemeBase
{
    ...
    public override Color TextListItem                     { get; set; } = Color.FromArgb(30, 57, 91);
    ...
    public override Color ButtonNormalDefaultBorder        { get; set; } = Color.FromArgb(0, 55, 110);
    ...
    public override Color ButtonNormalDefaultBack1         { get; set; } = Color.FromArgb(0, 90, 181);
    public override Color ButtonNormalDefaultBack2         { get; set; } = Color.FromArgb(0, 70, 140);
    ...
    public override Color PanelClient                      { get; set; } = Color.FromArgb(236, 234, 230);
    public override Color PanelAlternative                 { get; set; } = Color.FromArgb(222, 216, 208);
    ...
    public override Color HeaderPrimaryBack1               { get; set; } = Color.FromArgb(0, 90, 181);
    public override Color HeaderPrimaryBack2               { get; set; } = Color.FromArgb(0, 70, 140);
    public override Color HeaderSecondaryBack1             { get; set; } = Color.FromArgb(235, 200, 160);
    public override Color HeaderSecondaryBack2             { get; set; } = Color.FromArgb(200, 145, 85);
    public override Color HeaderText                       { get; set; } = Color.White;
    public override Color StatusStripText                  { get; set; } = Color.White;
    public override Color ButtonBorder                     { get; set; } = Color.FromArgb(153, 79, 0);
    ...
    public override Color StatusStripLight                 { get; set; } = Color.FromArgb(0, 90, 181);
    public override Color StatusStripDark                  { get; set; } = Color.FromArgb(0, 70, 140);
    public override Color ImageMargin                      { get; set; } = Color.White;
    public override Color ToolStripBegin                   { get; set; } = Color.FromArgb(236, 234, 230);
    public override Color ToolStripMiddle                  { get; set; } = Color.FromArgb(222, 216, 208);
    public override Color ToolStripEnd                     { get; set; } = Color.FromArgb(222, 216, 208);
    ...
    public override Color FormBorderHeaderActive1          { get; set; } = Color.FromArgb(0, 90, 181);
    public override Color FormBorderHeaderActive2          { get; set; } = Color.FromArgb(0, 70, 140);
    ...
    public override Color FormButtonBorderTrack            { get; set; } = Color.FromArgb(153, 79, 0);
    public override Color FormButtonBack1Track             { get; set; } = Color.FromArgb(235, 205, 170);
    public override Color FormButtonBack2Track             { get; set; } = Color.FromArgb(200, 130, 50);
    public override Color FormButtonBorderPressed          { get; set; } = Color.FromArgb(100, 50, 0);
    public override Color FormButtonBack1Pressed           { get; set; } = Color.FromArgb(153, 79, 0);
    public override Color FormButtonBack2Pressed           { get; set; } = Color.FromArgb(120, 60, 0);
    ...
    // Magenta accent darkened for AA contrast on warm neutrals (stock Okabe–Ito #CC79A7 is ~2.5:1).
    public override Color LinkNotVisitedOverrideControl    { get; set; } = Color.FromArgb(150, 45, 110);
    public override Color LinkVisitedOverrideControl       { get; set; } = Color.FromArgb(0, 90, 181);
    public override Color LinkPressedOverrideControl       { get; set; } = Color.FromArgb(153, 79, 0);
    public override Color LinkNotVisitedOverridePanel      { get; set; } = Color.FromArgb(150, 45, 110);
    public override Color LinkVisitedOverridePanel         { get; set; } = Color.FromArgb(0, 90, 181);
    public override Color LinkPressedOverridePanel         { get; set; } = Color.FromArgb(153, 79, 0);
    ...
    public override Color RibbonTabSelected1               { get; set; } = Color.FromArgb(0, 90, 181);
    public override Color RibbonTabSelected2               { get; set; } = Color.FromArgb(190, 220, 255);
    ...
    public override Color RibbonTabTracking1               { get; set; } = Color.FromArgb(153, 79, 0);
    public override Color RibbonTabTracking2               { get; set; } = Color.FromArgb(200, 130, 50);
    public override Color RibbonTabHighlight1              { get; set; } = Color.FromArgb(150, 45, 110);
    ...
    // TextButtonChecked is white (dark-blue default / brown checked); hover backs are pale brown.
    public override Color ButtonTextTracking               { get; set; } = Color.FromArgb(30, 57, 91);
    ...
    public override Color FormButtonBack1Checked           { get; set; } = Color.FromArgb(153, 79, 0);
    public override Color FormButtonBack2Checked           { get; set; } = Color.FromArgb(200, 130, 50);
    public override Color FormButtonBorderCheck            { get; set; } = Color.FromArgb(120, 60, 0);
    ...
    public override Color GridListSelected                 { get; set; } = Color.FromArgb(153, 79, 0);
    ...
    public override Color GridSheetColPressed1             { get; set; } = Color.FromArgb(153, 79, 0);
    public override Color GridSheetColPressed2             { get; set; } = Color.FromArgb(220, 180, 130);
    public override Color GridSheetColSelected1            { get; set; } = Color.FromArgb(0, 90, 181);
    public override Color GridSheetColSelected2            { get; set; } = Color.FromArgb(110, 160, 220);
    public override Color GridSheetRowNormal               { get; set; } = Color.FromArgb(218, 231, 245);
    public override Color GridSheetRowPressed              { get; set; } = Color.FromArgb(153, 79, 0);
    public override Color GridSheetRowSelected             { get; set; } = Color.FromArgb(150, 45, 110);
    public override Color GridDataCellBorder               { get; set; } = Color.FromArgb(218, 220, 221);
    public override Color GridDataCellSelected             { get; set; } = Color.FromArgb(235, 205, 170);
    ...
    public override Color ContextMenuHeadingBack           { get; set; } = Color.FromArgb(150, 45, 110);
    ...
    public override Color ButtonNavigatorTrack1            { get; set; } = Color.FromArgb(200, 130, 50);
    public override Color ButtonNavigatorTrack2            { get; set; } = Color.FromArgb(153, 79, 0);
    ...
    public override Color ButtonNavigatorChecked1          { get; set; } = Color.FromArgb(0, 90, 181);
    public override Color ButtonNavigatorChecked2          { get; set; } = Color.FromArgb(0, 70, 140);
    ...
    public override Color TrackBarFillTrack                { get; set; } = Color.FromArgb(0, 90, 181);

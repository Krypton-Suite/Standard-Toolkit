...
/// </summary>
public class PaletteProtanopia : PaletteMicrosoft365Base
{
    #region Static Fields

    #region Colors

    private static readonly Color _tabRowBackgroundColor = Color.FromArgb(200, 220, 240);
    ...
    /// <summary>
    /// Initializes a new instance of the PaletteProtanopia class.
    /// </summary>
    public PaletteProtanopia() : base(
        new PaletteProtanopia_BaseScheme(),
        _checkBoxList,
        _galleryButtonList,
        _radioButtonArray)
    {
        ThemeName = nameof(PaletteProtanopia);

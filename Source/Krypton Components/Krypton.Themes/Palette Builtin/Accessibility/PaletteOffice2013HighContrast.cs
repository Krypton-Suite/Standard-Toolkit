...
/// </summary>
public class PaletteOffice2013HighContrast : PaletteOffice2013Base
{
    private readonly Color _tabRowBackgroundColor = Color.Black;
    ...
    static PaletteOffice2013HighContrast()
    {
    ...
    /// <summary>
    /// Initialize a new instance of the <see cref="PaletteOffice2013HighContrast"/> class.
    /// </summary>
    public PaletteOffice2013HighContrast()
        : base(new PaletteHighContrast_BaseScheme(), _checkBoxList, _galleryButtonList, _radioButtonArray)
    {
        ThemeName = nameof(PaletteOffice2013HighContrast);

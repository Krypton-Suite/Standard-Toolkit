...
/// </summary>
public class PaletteMaterialProtanopia : PaletteMaterialBase
{
    ...
    private readonly AccessibilityMaterialAccents.AccentSet _accents = AccessibilityMaterialAccents.Protanopia;

    static PaletteMaterialProtanopia()
    {
        ...
        var scheme = new PaletteProtanopia_BaseScheme();
    ...
    /// <summary>
    /// Initialize a new instance of the <see cref="PaletteMaterialProtanopia"/> class.
    /// </summary>
    public PaletteMaterialProtanopia()
        : base(new PaletteProtanopia_BaseScheme(), _checkBoxList, _galleryButtonList, _radioButtonArray)
    {
        ThemeName = nameof(PaletteMaterialProtanopia);
    }

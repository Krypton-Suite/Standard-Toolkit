...
/// </summary>
public class PaletteDeuteranopia : PaletteMicrosoft365Base
{
    ...
    /// <summary>
    /// Initializes a new instance of the PaletteDeuteranopia class.
    /// </summary>
    public PaletteDeuteranopia() : base(
        new PaletteDeuteranopia_BaseScheme(),
        _checkBoxList,
        _galleryButtonList,
        _radioButtonArray)
    {
        ThemeName = nameof(PaletteDeuteranopia);

...
internal partial class KryptonWorkspaceCollectionEditor : KryptonDesignerCollectionEditor
{
    ...
    public KryptonWorkspace Workspace
    {
        get
        {
            var sequence =Context!.Instance as KryptonWorkspaceSequence ?? ThrowHelper.ThrowNullReferenceException<KryptonWorkspaceSequence>(SharedStaticFunctions.VariableCannotBeNull(nameof(Context.Instance)));

...
public struct KryptonUserInputToastData
{
    #region Public
    ...
    /// <summary>Initializes a new instance of the <see cref="KryptonUserInputToastData" /> struct.</summary>
    public KryptonUserInputToastData()
    {
    ...
    internal readonly void DisplayDebugData(KryptonUserInputToastData data)
    {

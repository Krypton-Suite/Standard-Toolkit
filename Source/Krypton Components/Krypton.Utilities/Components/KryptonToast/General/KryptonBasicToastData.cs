...
public struct KryptonBasicToastData
{
    #region Public
    ...
    /// <summary>Initializes a new instance of the <see cref="KryptonBasicToastData" /> struct.</summary>
    public KryptonBasicToastData()
    {

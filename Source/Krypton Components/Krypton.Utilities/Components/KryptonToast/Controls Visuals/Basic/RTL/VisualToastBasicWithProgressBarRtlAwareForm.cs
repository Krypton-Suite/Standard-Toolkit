...
internal partial class VisualToastBasicWithProgressBarRtlAwareForm : VisualToastBaseForm
{
    ...
    public VisualToastBasicWithProgressBarRtlAwareForm(KryptonBasicToastData data)
    {
        InitializeComponent();
    ...
    */
    ...
    internal static bool InternalShowWithBooleanReturnValue(KryptonBasicToastData toastNotificationData)
    {
    ...
    internal static CheckState InternalShowWithCheckStateReturnValue(KryptonBasicToastData toastNotificationData)
    {
        using var toast = new VisualToastBasicWithProgressBarRtlAwareForm(toastNotificationData);
    ...
    internal static void ShowNotification(KryptonBasicToastData toastNotificationData)
    {
        var kt = new VisualToastBasicWithProgressBarRtlAwareForm(toastNotificationData);

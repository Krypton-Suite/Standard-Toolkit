...
internal partial class VisualToastBasicRtlAwareForm : VisualToastBaseForm
{
    ...
    public VisualToastBasicRtlAwareForm(KryptonBasicToastData toastNotificationData)
    {
    ...
    */
    ...
    internal static void InternalShow(KryptonBasicToastData toastNotificationData)
    {
        using var toast = new VisualToastBasicRtlAwareForm(toastNotificationData);

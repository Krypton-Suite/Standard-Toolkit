...
internal partial class VisualToastTextBoxUserInputWithProgressBarRtlAwareForm : VisualToastBaseForm
{
    ...
    public VisualToastTextBoxUserInputWithProgressBarRtlAwareForm(KryptonUserInputToastData data)
    {
        InitializeComponent();

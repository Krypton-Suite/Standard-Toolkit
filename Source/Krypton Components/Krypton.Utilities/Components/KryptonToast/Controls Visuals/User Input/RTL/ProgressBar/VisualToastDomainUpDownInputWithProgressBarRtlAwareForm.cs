...
internal partial class VisualToastDomainUpDownInputWithProgressBarRtlAwareForm : VisualToastBaseForm
{
    ...
    public VisualToastDomainUpDownInputWithProgressBarRtlAwareForm(KryptonUserInputToastData data)
    {
        InitializeComponent();

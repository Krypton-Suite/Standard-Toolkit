...
internal partial class VisualToastMaskedTextBoxInputWithProgressBarRtlAwareForm : VisualToastBaseForm
{
    ...
    public VisualToastMaskedTextBoxInputWithProgressBarRtlAwareForm(KryptonUserInputToastData data)
    {
        InitializeComponent();
    ...
    internal static string ShowNotification(KryptonUserInputToastData data)
    {
        ...
        using var toast = new VisualToastMaskedTextBoxInputWithProgressBarRtlAwareForm(data);

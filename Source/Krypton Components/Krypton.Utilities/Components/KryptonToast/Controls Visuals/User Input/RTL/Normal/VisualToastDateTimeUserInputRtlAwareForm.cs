...
internal partial class VisualToastDateTimeUserInputRtlAwareForm : VisualToastBaseForm
{
    ...
    /// <summary>Initializes a new instance of the <see cref="VisualToastDateTimeUserInputRtlAwareForm" /> class.</summary>
    /// <param name="data">The data.</param>
    public VisualToastDateTimeUserInputRtlAwareForm(KryptonUserInputToastData data)
    {
        InitializeComponent();
    ...
    internal static DateTime ShowNotification(KryptonUserInputToastData data)
    {
        ...
        using var toast = new VisualToastDateTimeUserInputRtlAwareForm(data);

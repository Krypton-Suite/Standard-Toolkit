...
internal partial class VisualToastNUDUserInputRtlAwareForm : VisualToastBaseForm
{
    ...
    public VisualToastNUDUserInputRtlAwareForm(KryptonUserInputToastData data)
    {
        InitializeComponent();
    ...
    internal static decimal ShowNotification(KryptonUserInputToastData data)
    {
        var owner = data.ToastHost ?? FromHandle(PI.GetActiveWindow());

        using var toast = new VisualToastNUDUserInputRtlAwareForm(data);

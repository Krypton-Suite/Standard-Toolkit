...
internal partial class VisualToastMaskedTextBoxUserInputRtlAwareForm : VisualToastBaseForm
{
    ...
    public VisualToastMaskedTextBoxUserInputRtlAwareForm(KryptonUserInputToastData data)
    {
        InitializeComponent();
    ...
    internal static string ShowNotification(KryptonUserInputToastData data)
    {
        ...
        using var toast = new VisualToastMaskedTextBoxUserInputRtlAwareForm(data);

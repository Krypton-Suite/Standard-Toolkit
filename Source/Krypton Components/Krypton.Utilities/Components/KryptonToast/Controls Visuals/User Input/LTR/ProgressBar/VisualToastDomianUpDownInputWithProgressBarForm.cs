...
internal partial class VisualToastDomianUpDownInputWithProgressBarForm : VisualToastBaseForm
{
    ...
    public VisualToastDomianUpDownInputWithProgressBarForm(KryptonUserInputToastData data)
    {
        InitializeComponent();
    ...
    internal static string ShowNotification(KryptonUserInputToastData data)
    {
        ...
        using var toast = new VisualToastDomianUpDownInputWithProgressBarForm(data);

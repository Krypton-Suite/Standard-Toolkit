...
internal partial class VisualToastMaskedTextBoxInputWithProgressBarForm : VisualToastBaseForm
{
    ...
    public VisualToastMaskedTextBoxInputWithProgressBarForm(KryptonUserInputToastData data)
    {
        InitializeComponent();
    ...
    internal static string ShowNotification(KryptonUserInputToastData data)
    {
        ...
        using var toast = new VisualToastMaskedTextBoxInputWithProgressBarForm(data);

...
internal partial class VisualToastDateTimeUserInputForm : VisualToastBaseForm
{
    ...
    public VisualToastDateTimeUserInputForm(KryptonUserInputToastData data)
    {
        InitializeComponent();
    ...
    internal static DateTime ShowNotification(KryptonUserInputToastData data)
    {
        ...
        using var toast = new VisualToastDateTimeUserInputForm(data);

...
internal partial class VisualToastComboBoxUserInputWithProgressBarForm : VisualToastBaseForm
{
    ...
    public VisualToastComboBoxUserInputWithProgressBarForm(KryptonUserInputToastData data)
    {
        InitializeComponent();
    ...
    internal static string ShowNotification(KryptonUserInputToastData data)
    {
        ...
        using var toast = new VisualToastComboBoxUserInputWithProgressBarForm(data);

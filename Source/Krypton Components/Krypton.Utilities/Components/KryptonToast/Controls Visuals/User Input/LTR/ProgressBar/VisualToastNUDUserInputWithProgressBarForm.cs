...
internal partial class VisualToastNUDUserInputWithProgressBarForm : VisualToastBaseForm
{
    ...
    public VisualToastNUDUserInputWithProgressBarForm(KryptonUserInputToastData data)
    {
        InitializeComponent();

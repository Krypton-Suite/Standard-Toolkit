...
public static class KryptonRibbonExtensions
{
    ...
    /// </para>
    /// </remarks>
    public static void Merge(this Krypton.Ribbon.KryptonRibbon targetRibbon, Krypton.Ribbon.KryptonRibbon? sourceRibbon)
    {
    ...
    /// </para>
    /// </remarks>
    public static void Unmerge(this Krypton.Ribbon.KryptonRibbon targetRibbon, Krypton.Ribbon.KryptonRibbon? sourceRibbon)
    {
        if (targetRibbon == null)
        {
            throw new ArgumentNullException(nameof(targetRibbon));
    ...
    /// </para>
    /// </remarks>
    public static KryptonRibbonMerger CreateMerger(this Krypton.Ribbon.KryptonRibbon targetRibbon)
    {
        if (targetRibbon == null)
        {
            throw new ArgumentNullException(nameof(targetRibbon));

...
public class KryptonRibbonMerger
{
    ...
    /// </summary>
    public Krypton.Ribbon.KryptonRibbon TargetRibbon { get; }
    ...
    public KryptonRibbonMerger(Krypton.Ribbon.KryptonRibbon targetRibbon)
    {
    ...
    private void UnmergeGroupItems(Krypton.Ribbon.KryptonRibbonGroupContainerCollection sourceItems, Krypton.Ribbon.KryptonRibbonGroupContainerCollection targetItems)
    {
        IEnumerable<Krypton.Ribbon.KryptonRibbonGroupContainer> items = targetItems.ToArray();

        foreach (Krypton.Ribbon.KryptonRibbonGroupContainer item in items)
        {
    ...
    private void MergeGroupItems(Krypton.Ribbon.KryptonRibbonGroupContainerCollection sourceItems, Krypton.Ribbon.KryptonRibbonGroupContainerCollection targetItems)
    {
        IEnumerable<Krypton.Ribbon.KryptonRibbonGroupContainer> items = sourceItems.ToArray();

        foreach (Krypton.Ribbon.KryptonRibbonGroupContainer sourceItem in items)
        {
    ...
    private void UnmergeGroups(Krypton.Ribbon.KryptonRibbonGroupCollection sourceGroups, Krypton.Ribbon.KryptonRibbonGroupCollection targetGroups)
    {
        IEnumerable<Krypton.Ribbon.KryptonRibbonGroup> groups = targetGroups.ToArray();

        foreach (Krypton.Ribbon.KryptonRibbonGroup grp in groups)
        {
            if (!_mergedItems.Contains(grp))
            {
                Krypton.Ribbon.KryptonRibbonGroup? existingGroup = sourceGroups.FirstOrDefault(item => (string.Equals(item.TextLine1, grp.TextLine1, StringComparison.CurrentCulture))
    ...
    private void MergeGroups(Krypton.Ribbon.KryptonRibbonGroupCollection sourceGroups, Krypton.Ribbon.KryptonRibbonGroupCollection targetGroups)
    {
        IEnumerable<Krypton.Ribbon.KryptonRibbonGroup> groups = sourceGroups.ToArray();

        foreach (Krypton.Ribbon.KryptonRibbonGroup sourceGroup in groups)
        {
            Krypton.Ribbon.KryptonRibbonGroup? existingGroup = targetGroups.FirstOrDefault(item => (string.Equals(item.TextLine1, sourceGroup.TextLine1, StringComparison.CurrentCulture))
    ...
    private void MergeTabs(Krypton.Ribbon.KryptonRibbon sourceRibbon, Krypton.Ribbon.KryptonRibbon targetRibbon)
    {
        IEnumerable<Krypton.Ribbon.KryptonRibbonTab> sourceTabs = sourceRibbon.RibbonTabs.ToArray();

        foreach (Krypton.Ribbon.KryptonRibbonTab tab in sourceTabs)
        {
            Krypton.Ribbon.KryptonRibbonTab? existingTab = targetRibbon.RibbonTabs.FirstOrDefault(item => string.Equals(item.Text, tab.Text, StringComparison.CurrentCulture));
    ...
    private void UnmergeContexts(Krypton.Ribbon.KryptonRibbon sourceRibbon, Krypton.Ribbon.KryptonRibbon targetRibbon)
    {
        IEnumerable<Krypton.Ribbon.KryptonRibbonContext> contexts = targetRibbon.RibbonContexts.ToArray();

        foreach (Krypton.Ribbon.KryptonRibbonContext context in contexts)
        {
            ...
            Krypton.Ribbon.KryptonRibbonContext? existing = sourceRibbon.RibbonContexts.FirstOrDefault(item => string.Equals(item.ContextTitle, context.ContextTitle, StringComparison.CurrentCulture));
    ...
    /// <param name="sourceRibbon">The ribbon to merge.</param>
    /// <param name="targetRibbon">The ribbon to be merged into.</param>
    private void MergeContexts(Krypton.Ribbon.KryptonRibbon sourceRibbon, Krypton.Ribbon.KryptonRibbon targetRibbon)
    {
        IEnumerable<Krypton.Ribbon.KryptonRibbonContext> contexts = sourceRibbon.RibbonContexts.ToArray();

        foreach (Krypton.Ribbon.KryptonRibbonContext context in contexts)
        {
            Krypton.Ribbon.KryptonRibbonContext? existing = targetRibbon.RibbonContexts.FirstOrDefault(item => string.Equals(item.ContextTitle, context.ContextTitle, StringComparison.CurrentCulture));
    ...
    /// <param name="targetRibbon">The ribbon to be unmerged from.</param>
    private void UnmergeTabs(Krypton.Ribbon.KryptonRibbon sourceRibbon, Krypton.Ribbon.KryptonRibbon targetRibbon)
    {
        IEnumerable<Krypton.Ribbon.KryptonRibbonTab> tabs = targetRibbon.RibbonTabs.ToArray();

        foreach (Krypton.Ribbon.KryptonRibbonTab tab in tabs)
        {
            if (!_mergedItems.Contains(tab))
            {
                Krypton.Ribbon.KryptonRibbonTab? existingTab = sourceRibbon.RibbonTabs.FirstOrDefault(item => string.Equals(item.Text, tab.Text, StringComparison.CurrentCulture));
    ...
    public void Merge(Krypton.Ribbon.KryptonRibbon? ribbon)
    {
        if (ribbon == null)
        {
            return;
        ...
        Krypton.Ribbon.KryptonRibbonTab? selectedTab = TargetRibbon.SelectedTab;
    ...
    public void Unmerge(Krypton.Ribbon.KryptonRibbon? ribbon)
    {
        if (ribbon == null)
        {
            return;
        ...
        Krypton.Ribbon.KryptonRibbonTab? selected = TargetRibbon.SelectedTab;
    ...
    public void FixGroupWidths()
    {
        ...
        foreach (Krypton.Ribbon.KryptonRibbonTab tab in TargetRibbon.RibbonTabs)
        {
            foreach (Krypton.Ribbon.KryptonRibbonGroup grp in tab.Groups)
            {

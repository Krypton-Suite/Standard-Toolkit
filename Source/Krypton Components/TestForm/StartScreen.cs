...
public partial class StartScreen : KryptonForm
{
    ...
    private void AddButtons()
    {
        ...
        CreateButton<MessageBoxExtendedLifetimeDemo>("4188 MessageBox Extended Fade / Timeout", "Issue #4188: fade in/out, caption countdown, optional countdown on an action button, and auto-close on KryptonMessageBoxExtended. Presets cover fade-only, display-only timeout, auto-close with DialogResult, auto-close via button two, countdown on OK, fade+timeout together, RTL Show() path, the existing Show() timeout overload, and ShowAsync(data).");

...
public partial class StartScreen : KryptonForm
{
    ...
    private void AddButtons()
    {
        ...
        CreateButton<WorkspaceRtlDemo>("Workspace RTL (#2383)", "Issue #2383: logical RTL for KryptonWorkspace. Toggle RightToLeft + RightToLeftLayout; horizontal cells pack from the right, nested vertical stacks stay top-to-bottom, XML order is unchanged, and left/right page drops follow the physical edge.");

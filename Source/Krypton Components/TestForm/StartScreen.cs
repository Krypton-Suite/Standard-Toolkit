...
public partial class StartScreen : KryptonForm
{
    ...
    private void AddButtons()
    {
        ...
        CreateButton<PaletteBinaryDemo>("2117 Palette .kpalx save/load", "Issue #2117: export/import custom palettes as .kpalx (KryptonPalette XML). Populate from a Krypton.Themes extra palette, re-import, and apply via KryptonManager. Convert XML to .kpalx rewrites a legacy .xml. Export .kpal pack stores several named themes. Pack folder to .kpal stores a directory tree. KryptonPaletteFileListBox / ComboBox / TreeView (Utilities) list those files from the last export folder. File dialogs default to *.kpalx; optional native *.kpal is listed; *.xml remains available. For a dedicated editor use Demos Krypton Palette Author (Krypton Explorer).");

...
public partial class StartScreen : KryptonForm
{
    ...
    private void AddButtons()
    {
        ...
        CreateButton<ToolkitRtlGalleryDemo>("Toolkit RTL Gallery (#2379)", "Issue #2379: every visual Krypton.Toolkit control under Dual RTL (RightToLeft + RightToLeftLayout). Tabs for buttons, inputs, lists, chrome, calendar, strips, dialogs, and CommandLink. Uncheck Dual RTL to compare LTR.");

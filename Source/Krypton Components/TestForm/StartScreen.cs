...
public partial class StartScreen : KryptonForm
{
    ...
    private void AddButtons()
    {
        ...
        CreateButton<RadialMenuDemo>("Radial Menu (#4172)", "Issue #4172: KryptonRadialMenu in Krypton.Toolkit.Utilities — OneNote-style radial popup with nested submenus, KryptonCommand binding, slider/colour/font editors, and ImportFrom(KryptonContextMenu). Right-click the surface or use Show at cursor; compare native items vs context-menu bridge.");

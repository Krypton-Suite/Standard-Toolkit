...
public partial class StartScreen : KryptonForm
{
    ...
    private void AddButtons()
    {
        ...
        CreateButton<LoadingCircleDemo>("LoadingCircle Palette", "KryptonLoadingCircle in Krypton.Toolkit.Utilities: Empty Color inherits the global palette short-text colour; explicit Color overrides the theme. Switch themes, toggle Active, change StylePreset, and Reset override.");

...
public partial class StartScreen : KryptonForm
{
    ...
    private void AddButtons()
    {
        ...
        CreateButton<NavigatorFormIntegrationDemo>("Navigator Form Integration (#925)", "Issue #925/#927: KryptonNavigatorFormIntegrator — CaptionIntegrated (tabs in title bar), ClientChrome (navigator hosts min/max/close), CaptionAdjacent. Add pages and switch modes.");

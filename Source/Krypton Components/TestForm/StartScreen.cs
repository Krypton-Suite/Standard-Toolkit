...
public partial class StartScreen : KryptonForm
{
    ...
    private void AddButtons()
    {
        ...
        CreateButton<CustomThemeGeneratorDemo>("4234 Custom Theme Generator", "Issue #4234: generate a custom theme from a few colours (hex, RGB, or a PowerToys-style screen dropper). Apply, register it in the theme combo, export XML, and open the Utilities builder dialog. Covers Office 2010 and Microsoft 365 light/dark donors.");

...
public partial class StartScreen : KryptonForm
{
    ...
    private void AddButtons()
    {
        ...
        CreateButton<Feature3784GlowingTextBoxBorderDemo>("Feature 3784 Glowing Input Borders", "Demo for issue #3784: optional animated or static glowing bottom border on KryptonTextBox, KryptonComboBox, and KryptonRichTextBox via GlowingBorderValues.");

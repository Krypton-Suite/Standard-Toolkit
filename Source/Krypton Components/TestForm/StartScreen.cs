...
public partial class StartScreen : KryptonForm
{
    ...
    private void AddButtons()
    {
        ...
        CreateButton<ToolStripProgressLoadingDemo>("ToolStrip Progress && Loading", "EnhancedToolStripProgressBar, ProgressBarWithValueText, LoadingCircle presets, LoadingCircleToolStripMenuItem, and ProgressStatusStrip with animate-to-100.");

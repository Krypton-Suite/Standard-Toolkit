...
public partial class StartScreen : KryptonForm
{
    ...
    private void AddButtons()
    {
        ...
        CreateButton<Office2013GrayThemesDemo>("942 Grey Themes", "Issue #942: Light Grey and Dark Grey chrome for Office 2007, 2010, 2013, Microsoft 365, and Material. Switch themes and check title bar, ribbon tab row, headers, status strip, and light client area.");

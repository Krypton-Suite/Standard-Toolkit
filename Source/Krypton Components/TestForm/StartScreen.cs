...
public partial class StartScreen : KryptonForm
{
    ...
    private void AddButtons()
    {
        ...
        CreateButton<Bug4252LightGrayContextMenuDemo>("Bug 4252 Light Gray submenu image", "Issue #4252: Office 2007 / 2010 / Microsoft 365 Light Gray palettes must return a context-menu submenu chevron from GetContextMenuSubMenuImage instead of throwing NotImplementedException.");

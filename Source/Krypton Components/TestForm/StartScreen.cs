...
public partial class StartScreen : KryptonForm
{
    ...
    private void AddButtons()
    {
        ...
        CreateButton<ButtonSpecHighDpiDemo>("ButtonSpec High DPI (#978)", "Issue #978: @2x/@3x resolution, early PaletteImageScaler.ScalePalette on a custom palette, and KryptonCommand-backed InputControl Close. Optional: dotnet run --project TestForm -- --button-spec-early-scale");

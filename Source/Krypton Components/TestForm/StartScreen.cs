...
public partial class StartScreen : KryptonForm
{
    ...
    private void AddButtons()
    {
        ...
        CreateButton<CustomThemeGeneratorDemo>("4234 Custom Theme Generator", "Issue #4234: generate a custom theme from a few colours (hex, RGB, or a screen dropper). Switch the picker flyout between Classic (PowerToys) and Krypton chrome. Apply, register, export XML, and open the Utilities builder.");

...
public partial class ButtonTextTrackingExample : KryptonForm
{
    ...
    private void ApplyTrackingColor(Color color)
    {
        ...
        {
            palette.SetSchemeColor(SchemeBaseColors.ButtonTextTracking, SharedStaticVariables.EMPTY_COLOR);
            palette.SetSchemeExtraColor(SchemeExtraColors.ButtonTextTracking, SharedStaticVariables.EMPTY_COLOR);

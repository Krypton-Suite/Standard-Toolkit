...
namespace TestForm
{
    partial class LimeGreenButtonThemeDemo
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            kbtnApplyLime = new KryptonButton();
            ...
            kwlblInfo.Text =
                @"Builtin Lime Green themes on Office 2007 / 2010 / Microsoft 365 — light and dark bases. " +
            ...
            flpActions.Controls.Add(kbtnApplyLime);
            ...
            // kbtnApplyLime
            //
            kbtnApplyLime.Location = new Point(203, 11);
            kbtnApplyLime.Name = @"kbtnApplyLime";
            kbtnApplyLime.Size = new Size(140, 28);
            kbtnApplyLime.TabIndex = 2;
            kbtnApplyLime.Values.Text = @"Apply lime theme";
            kbtnApplyLime.Click += kbtnApplyLime_Click;
            //
            // kbtnResetTheme
            //
            ...
            Name = @"LimeGreenButtonThemeDemo";
            StartPosition = FormStartPosition.CenterScreen;
            Text = @"Lime Green Theme";
            FormClosed += LimeGreenButtonThemeDemo_FormClosed;
            Load += LimeGreenButtonThemeDemo_Load;
        ...
        private KryptonButton kbtnApplyLime;

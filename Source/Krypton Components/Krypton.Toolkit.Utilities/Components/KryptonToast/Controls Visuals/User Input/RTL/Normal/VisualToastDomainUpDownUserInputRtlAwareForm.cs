...
internal partial class VisualToastDomainUpDownUserInputRtlAwareForm : VisualToastBaseForm
{
    ...
    public VisualToastDomainUpDownUserInputRtlAwareForm(KryptonUserInputToastData data)
    {
        InitializeComponent();

...
/// <summary>
/// Smart-tag action list for <see cref="KryptonTreeComboBox"/>.
/// </summary>
internal class KryptonTreeComboBoxActionList : DesignerActionList
{
    #region Instance Fields

    private readonly KryptonTreeComboBox _control;
    ...
    /// <summary>
    /// Initialize a new instance of the <see cref="KryptonTreeComboBoxActionList"/> class.
    /// </summary>
    /// <param name="owner">Designer that owns this action list instance.</param>
    public KryptonTreeComboBoxActionList(KryptonTreeComboBoxDesigner owner)
        : base(owner.Component)
    {
        _control = (owner.Component as KryptonTreeComboBox)!;
    ...
    {
        get => _control.DisplayMode;
        set
        {
            if (_control.DisplayMode != value)
            {
                _service?.OnComponentChanged(_control, null, _control.DisplayMode, value);
                _control.DisplayMode = value;
            }
        }
    }
    ...
    {
        get => _control.SelectMode;
        set
        {
            if (_control.SelectMode != value)
            {
                _service?.OnComponentChanged(_control, null, _control.SelectMode, value);
                _control.SelectMode = value;
            }
        }
    }
    ...
    public override DesignerActionItemCollection GetSortedActionItems()
    {
        ...
        actions.Add(new DesignerActionHeaderItem("Tree"));
        actions.Add(new DesignerActionPropertyItem(nameof(DisplayMode), "Display mode", "Tree",
            "How the committed node is formatted in the editor."));
        actions.Add(new DesignerActionPropertyItem(nameof(SelectMode), "Select mode", "Tree",
            "Whether only leaf nodes or any node may be selected."));

...
/// <summary>
/// Contains industrial-style backplate settings for a <see cref="KryptonKnob"/>.
/// </summary>
[TypeConverter(typeof(ExpandableObjectConverter))]
public class KnobBackplateValues : Storage
{
    ...
    #region Identity
    /// <summary>
    /// Initialize a new instance of the <see cref="KnobBackplateValues"/> class.
    /// </summary>
    /// <param name="owner">Reference to owning control.</param>
    public KnobBackplateValues(KryptonKnob owner)
    {
        _owner = owner;
    ...
    {
        var view = _owner.ViewDrawKnob;
        view.BackplateShape = _shape;
        view.BackplateColor1 = _color1;
        view.BackplateColor2 = _color2;
        view.BackplateBorderColor = _borderColor;
        view.ShowBackplateInsetWell = _showInsetWell;
        view.ShowBackplateDropShadow = _showDropShadow;

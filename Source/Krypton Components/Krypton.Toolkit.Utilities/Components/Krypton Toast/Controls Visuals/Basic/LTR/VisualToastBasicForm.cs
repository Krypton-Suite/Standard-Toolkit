...
internal partial class VisualToastBasicForm : KryptonForm
{
    ...
    /// <summary>Initializes a new instance of the <see cref="VisualToastBasicForm" /> class.</summary>
    /// <param name="data">The data.</param>
    public VisualToastBasicForm(KryptonBasicToastData data)
    {
    ...
    */
    ...
    {
        var toast = new VisualToastBasicForm(toastNotificationData);

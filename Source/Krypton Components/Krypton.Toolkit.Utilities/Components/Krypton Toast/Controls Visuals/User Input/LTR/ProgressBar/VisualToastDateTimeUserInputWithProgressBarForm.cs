...
internal partial class VisualToastDateTimeUserInputWithProgressBarForm : VisualToastBaseForm
{
    ...
    public VisualToastDateTimeUserInputWithProgressBarForm(KryptonUserInputToastData data)
    {
        InitializeComponent();

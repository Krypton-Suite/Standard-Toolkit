...
internal partial class VisualToastDomainUpDownUserInputForm : VisualToastBaseForm
{
    ...
    public VisualToastDomainUpDownUserInputForm(KryptonUserInputToastData data)
    {
        InitializeComponent();
    ...
    internal static string ShowNotification(KryptonUserInputToastData data)
    {
        ...
        using var toast = new VisualToastDomainUpDownUserInputForm(data);

...
internal partial class VisualToastMaskedTextBoxUserInputForm : VisualToastBaseForm
{
    ...
    public VisualToastMaskedTextBoxUserInputForm(KryptonUserInputToastData data)
    {
        InitializeComponent();
    ...
    internal static string ShowNotification(KryptonUserInputToastData data)
    {
        ...
        using var toast = new VisualToastMaskedTextBoxUserInputForm(data);

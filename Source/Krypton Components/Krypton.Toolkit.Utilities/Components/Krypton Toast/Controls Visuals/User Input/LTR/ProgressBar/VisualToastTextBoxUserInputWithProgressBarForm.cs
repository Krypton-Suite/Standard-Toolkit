...
internal partial class VisualToastTextBoxUserInputWithProgressBarForm : VisualToastBaseForm
{
    ...
    public VisualToastTextBoxUserInputWithProgressBarForm(KryptonUserInputToastData data)
    {
        InitializeComponent();
    ...
    internal static string ShowNotification(KryptonUserInputToastData data)
    {
        ...
        using var toast = new VisualToastTextBoxUserInputWithProgressBarForm(data);

...
internal partial class VisualToastNUDUserInputWithProgressBarRtlAwareForm : VisualToastBaseForm
{
    ...
    public VisualToastNUDUserInputWithProgressBarRtlAwareForm(KryptonUserInputToastData data)
    {
        InitializeComponent();
    ...
    public static decimal ShowToastNotification(KryptonUserInputToastData data)
    {
        var owner = data.ToastHost ?? FromHandle(PI.GetActiveWindow());

        using var toast = new VisualToastNUDUserInputWithProgressBarRtlAwareForm(data);

...
internal partial class VisualToastComboBoxUserInputRtlAwareForm : VisualToastBaseForm
{
    ...
    public VisualToastComboBoxUserInputRtlAwareForm(KryptonUserInputToastData data)
    {
        InitializeComponent();
    ...
    internal static string ShowNotification(KryptonUserInputToastData data)
    {
        ...
        using var toast = new VisualToastComboBoxUserInputRtlAwareForm(data);

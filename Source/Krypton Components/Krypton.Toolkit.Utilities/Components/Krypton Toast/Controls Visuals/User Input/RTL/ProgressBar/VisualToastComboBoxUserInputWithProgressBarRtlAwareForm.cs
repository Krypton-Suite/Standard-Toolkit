...
internal partial class VisualToastComboBoxUserInputWithProgressBarRtlAwareForm : VisualToastBaseForm
{
    ...
    public VisualToastComboBoxUserInputWithProgressBarRtlAwareForm(KryptonUserInputToastData data)
    {
        InitializeComponent();
    ...
    internal static string ShowNotification(KryptonUserInputToastData data)
    {
        ...
        using var toast = new VisualToastComboBoxUserInputWithProgressBarRtlAwareForm(data);

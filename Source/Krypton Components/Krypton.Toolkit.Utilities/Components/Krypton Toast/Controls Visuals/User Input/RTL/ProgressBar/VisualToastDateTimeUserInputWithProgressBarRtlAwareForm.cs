...
internal partial class VisualToastDateTimeUserInputWithProgressBarRtlAwareForm : VisualToastBaseForm
{
    ...
    public VisualToastDateTimeUserInputWithProgressBarRtlAwareForm(KryptonUserInputToastData data)
    {
        InitializeComponent();
    ...
    internal static DateTime ShowNotification(KryptonUserInputToastData data)
    {
        var owner = data.ToastHost ?? FromHandle(PI.GetActiveWindow());

        using var toast = new VisualToastDateTimeUserInputWithProgressBarRtlAwareForm(data);

...
public struct KryptonCommonToastData
{
    #region Public
    ...
    /// <summary>Initializes a new instance of the <see cref="KryptonCommonToastData" /> struct.</summary>
    public KryptonCommonToastData()
    {
        UseFade = false;

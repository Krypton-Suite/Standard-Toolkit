    ...
    IContentValues
{
    ...
    public ViewDrawRibbonGroupButtonText([DisallowNull] KryptonRibbon ribbon,
        ...
        bool firstText)
    {
        ...
        _ribbonButton = ribbonButton ?? ThrowHelper.ThrowArgumentNullException<KryptonRibbonGroupButton>(nameof(ribbonButton));
    ...
    public override string ToString() =>
        ...
        $@"ViewDrawRibbonGroupButtonText:{Id}";

...
internal class KryptonRibbonGroupRichTextBoxDesigner : ComponentDesigner, IKryptonDesignObject
{
    ...
    private void OnEnabled(object? sender, EventArgs e)
    {
        ...
        {
            PropertyDescriptor? propertyEnabled = TypeDescriptor.GetProperties(_ribbonRichTextBox)[nameof(Enabled)] ?? throw new NullReferenceException(GlobalStaticFunctions.VariableCannotBeNull("propertyEnabled"));
    ...
    private void OnVisible(object? sender, EventArgs e)
    {
        if (_ribbonRichTextBox.Ribbon is not null)
        {
            PropertyDescriptor? propertyVisible = TypeDescriptor.GetProperties(_ribbonRichTextBox)[nameof(Visible)] ?? throw new NullReferenceException(GlobalStaticFunctions.VariableCannotBeNull("propertyVisible"));

...
internal class KryptonRibbonGroupDateTimePickerDesigner : ComponentDesigner, IKryptonDesignObject
{
    ...
    private void OnEnabled(object? sender, EventArgs e)
    {
        if (_ribbonDateTimePicker.Ribbon != null)
        {
            PropertyDescriptor propertyEnabled = TypeDescriptor.GetProperties(_ribbonDateTimePicker)[nameof(Enabled)] ?? throw new NullReferenceException(GlobalStaticFunctions.VariableCannotBeNull("propertyEnabled"));
    ...
    private void OnVisible(object? sender, EventArgs e)
    {
        if (_ribbonDateTimePicker.Ribbon != null)
        {
            PropertyDescriptor propertyVisible = TypeDescriptor.GetProperties(_ribbonDateTimePicker)[nameof(Visible)] ?? throw new NullReferenceException(GlobalStaticFunctions.VariableCannotBeNull("propertyVisible"));

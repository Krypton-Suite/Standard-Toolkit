...
internal class KryptonRibbonGroupRadioButtonDesigner : ComponentDesigner
{
    ...
    private void UpdateVerbStatus()
    {
        ...
        {
            var items = ParentItems ?? throw new NullReferenceException(SharedStaticFunctions.VariableCannotBeNull(nameof(ParentItems)));
    ...
    private void OnMoveFirst(object? sender, EventArgs e)
    {
        if (_ribbonRadioButton.Ribbon != null)
        {
            ...
            try
            {
                ...
                MemberDescriptor propertyItems = TypeDescriptor.GetProperties(_ribbonRadioButton.RibbonContainer!)[@"Items"] ?? throw new NullReferenceException(SharedStaticFunctions.VariableCannotBeNull("propertyItems"));

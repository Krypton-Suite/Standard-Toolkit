...
* **[Breaking Change]:** Renamed build output directory from `Bin` to `Artefacts` for consistency across all project files, build scripts, GitHub Actions workflows, and documentation

...
* Resolved [#1692](https://github.com/Krypton-Suite/Standard-Toolkit/issues/1692), `KryptonMessageBox` text should not be using `TextLabelControl` colours whilst using standard black themes

...
* Implemented [#2117](https://github.com/Krypton-Suite/Standard-Toolkit/issues/2117), To save & load palettes to/from 'palette' binary
  ...
  * `KryptonPaletteCollectionEditor` is a toolbox component that opens a dialog to add files and remove named themes. Dialog captions, buttons, filters, and status text are on `KryptonPaletteCollectionEditor.Strings` (`[Localizable(true)]`).

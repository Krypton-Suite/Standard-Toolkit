...
* Resolved [#4373](https://github.com/Krypton-Suite/Standard-Toolkit/issues/4373), Toolstrip controls are unreadable with certain themes
  ...
  * `KryptonWrapLabel` / `KryptonLinkWrapLabel` clone palette fonts before assigning `Control.Font`, so theme changes no longer dispose a live GDI+ font.
...
* All NuGet packages now use 'LTS' versioning scheme (e.g. `105.10.xx.LTS`) to indicate long-term support and stability, with patch releases for bug fixes and minor improvements. 
...
* Implemented [#290](https://github.com/Krypton-Suite/Standard-Toolkit/issues/290), Should V6 only support "MS Supported" Net Frameworks?
  ...
  * For more information, see the [Microsoft .NET Framework support policy](https://dotnet.microsoft.com/platform/support/policy/dotnet-framework)

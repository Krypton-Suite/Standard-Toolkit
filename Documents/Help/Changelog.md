...
* New optional `UseWindows11RoundingValue`, if you have Windows 11 installed, the corner rounding radius will now match the default UI, if you have this turned on
